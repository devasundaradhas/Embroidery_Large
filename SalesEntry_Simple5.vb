Public Class SalesEntry_Simple5
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Trim(dgv_Details.Rows(i).Cells(1).Value) <> "" Or Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        'If nr = 0 Then
                        cmd.CommandText = "Insert into Sales_Details ( Sales_Code,            Company_IdNo          ,              Sales_No             ,                                              for_OrderBy                   , Sales_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo      , ItemGroup_IdNo         ,      Item_Description                    ,          Unit_IdNo      ,                     Noof_Items                 ,                 Rate                     ,                 Amount                   ,                    Total_Amount    ,     Dc_No                                    ,                Entry_Type       ,                  Sales_Delivery_Code ,                            Sales_dELIVERY_Detail_SlNo ) " & _
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(lbl_GrossAmount.Text) - Val(txt_CashDiscAmount.Text) + Val(lbl_VatAmount.Text) + Val(txt_Freight.Text) + Val(txt_AddLess.Text)
...
LOOP1:
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetDt.Rows(prn_DetIndx).Item("Dc_No").ToString), LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Trim(ItmDescAr(0)), LMargin + ClArr(1) + ClArr(2) + 10, CurY, 0, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Noof_Items").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 35, CurY, 1, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Common_Procedures.Unit_IdNoToName(con, Val(prn_DetDt.Rows(prn_DetIndx).Item("Unit_IdNO").ToString)), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 5, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        If Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString) <> "" Then
            Common_Procedures.Print_To_PrintDocument(e, "PAN NO : " & Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString), LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        End If
        ...
        Try
            ...
            CurY = CurY + TxtHgt
            If prn_HdDt.Rows(0).Item("Ledger_PanNo").ToString <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "PAN NO: " & prn_HdDt.Rows(0).Item("Ledger_PanNo").ToString, LMargin + S1 + 10, CurY, 0, 0, pFont)
            End If
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            CurY = CurY + TxtHgt - 10
            Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 30, CurY, 1, 0, pFont)
            ...
            If Val(prn_HdDt.Rows(0).Item("Form_H_Status").ToString) <> 0 Then
                CurY = CurY + TxtHgt + 3
...
LOOP1:
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, IIf(Trim(prn_DetDt.Rows(prn_DetIndx).Item("Dc_No").ToString) = "0", "", Trim(prn_DetDt.Rows(prn_DetIndx).Item("Dc_No").ToString)), LMargin + 65, CurY, 0, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Trim(ItmDescAr(0)), LMargin + 145, CurY, 0, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Noof_Items").ToString), LMargin + 540, CurY, 1, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Common_Procedures.Unit_IdNoToName(con, Val(prn_DetDt.Rows(prn_DetIndx).Item("Unit_IdNO").ToString)), LMargin + 580, CurY, 1, 0, pFont)
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(prn_DetIndx).Item("Amount").ToString), "#########0.00"), LMargin + 755, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Led_PanNo = Trim(prn_HdDt.Rows(0).Item("Ledger_PanNo").ToString)
        ...
        End If
            ...
            CurY = 180
            If Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "PAN NO : " & Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString), LMargin + 590, CurY, 0, 0, pFont)
            End If
    ...
    Private Sub Printing_Format2_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If is_LastPage = True Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString), LMargin + 530, CurY, 1, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, " " & (prn_HdDt.Rows(0).Item("Gross_Amount").ToString), LMargin + 755, CurY, 1, 0, pFont)

                If Val(prn_HdDt.Rows(0).Item("Tax_Amount").ToString) <> 0 Then
                    CurY = TMargin + 940 '945
                    ' Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Tax_Perc").ToString), LMargin + 550, CurY, 1, 0, pFont)

                    Common_Procedures.Print_To_PrintDocument(e, Val(prn_HdDt.Rows(0).Item("Tax_Amount").ToString), LMargin + 755, CurY, 1, 0, pFont)

                End If

                If Val(prn_HdDt.Rows(0).Item("CashDiscount_Perc").ToString) <> 0 Then

                    CurY = TMargin + 965 '970
                    Common_Procedures.Print_To_PrintDocument(e, "Cash Dis @ " & Trim(Val(prn_HdDt.Rows(0).Item("CashDiscount_Perc").ToString)) & "%", LMargin + 470, CurY, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString), "########0.00"), LMargin + 755, CurY, 1, 0, pFont)
                ...
                If Val(prn_HdDt.Rows(0).Item("Round_Off").ToString) <> 0 Then
                    ...
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Round_Off").ToString), "########0.00"), LMargin + 755, CurY, 1, 0, pFont)
                ...
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Common_Procedures.Currency_Format(Val(prn_HdDt.Rows(0).Item("Net_Amount").ToString)), LMargin + 750, CurY, 1, 0, p1Font)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If (prn_DetDt.Rows(prn_DetIndx).Item("Dc_No").ToString) <> "" Then
                            ItmNmDesc = Trim(ItmNmDesc) & "  -  " & prn_DetDt.Rows(prn_DetIndx).Item("Dc_No").ToString
                        End If
...
LOOP1:
                        ...
                        CurY = CurY + TxtHgt
                        NoofDets = NoofDets + 1
                        Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetDt.Rows(prn_DetIndx).Item("Item_Description").ToString), LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format3_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If prn_HdDt.Rows(0).Item("Vehicle_No").ToString <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "Through : " & prn_HdDt.Rows(0).Item("Vehicle_No").ToString, LMargin + 10, CurY, 0, 0, pFont)
            End If
