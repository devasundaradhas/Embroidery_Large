Public Class Sales_Quotation
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Quotation_Head", "Sales_Quotation_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Quotation_Head", "Sales_Quotation_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Sales_Quotation_Head (  Sales_Quotation_Code  ,              Company_IdNo        ,       Sales_Quotation_No           ,           for_OrderBy    , Sales_Quotation_Date,      Ledger_IdNo    ,                 Total_Qty      ,            Gross_Amount             ,                 CashDiscount_Perc      ,              CashDiscount_Amount         ,             Assessable_Value         ,              Tax_Perc             ,                Tax_Amount           ,              Freight_Amount       ,              Labour_Charge       ,              Round_Off             ,             Net_Amount                               ,  Delivery_Terms          ,              Payment_Terms           ) " & _
