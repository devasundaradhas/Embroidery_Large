Public Class Sales_Delivery_Free
    ...
    Private Pk_Condition As String = "OTDEL-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName from Sales_Delivery_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Sales_Delivery_Code = '" & NewCode & "'", con)
            da1.Fill(dt1)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Sales_Delivery_No from Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Delivery_Code like '" & Pk_Condition & "%'  and Sales_Delivery_Code like '%" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Sales_Delivery_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select Sales_Delivery_No from Sales_Delivery_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Delivery_Code like '" & Pk_Condition & "%'   and Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Sales_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Sales_Delivery_No from Sales_Delivery_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Delivery_Code like '" & Pk_Condition & "%'   and Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Sales_Delivery_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select Sales_Delivery_No from Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Delivery_Code like '" & Pk_Condition & "%'   and Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Sales_Delivery_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Delivery_Head", "Sales_Delivery_Code", "For_OrderBy", "Sales_Delivery_Code like '" & Trim(Pk_Condition) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Delivery_Head", "Sales_Delivery_Code", "For_OrderBy", "Sales_Delivery_Code like '" & Trim(Pk_Condition) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Sales_Delivery_Head(Sales_Delivery_Code ,             Company_IdNo         ,              Sales_Delivery_No             ,                               for_OrderBy      , Sales_Delivery_Date,           Ledger_IdNo   ,                 Order_No             ,                Order_Date         ,    Transport_IdNo         ,            Vehicle_No            ,              Remarks           ,              Total_Qty           ) " & _
                                    " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @DcDate             , " & Str(Val(led_id)) & ",    '" & Trim(txt_OrderNo.Text) & "', '" & Trim(txt_OrderDate.Text) & "'," & Str(Val(trans_id)) & ", '" & Trim(txt_VehicleNo.Text) & "', '" & Trim(txt_Narration.Text) & "',  " & Str(Val(vTot_Qty)) & ")"
                cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Trim(dgv_Details.Rows(i).Cells(1).Value) <> "" Or Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        If NR = 0 Then
                            cmd.CommandText = "Insert into Sales_Delivery_Details ( Sales_Delivery_Code,    Company_IdNo          ,      Sales_Delivery_No  ,                                              for_OrderBy                   , Sales_Delivery_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo           ,      Item_Description                    ,          Unit_IdNo         ,                         Quantity          ,   Receipt_Quantity ) " & _
                                                    " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @DcDate            ,      " & Str(Val(led_id)) & ", " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ",  '" & Trim(.Rows(i).Cells(2).Value) & "' ,    " & Str(Val(unt_id)) & ",  " & Str(Val(.Rows(i).Cells(4).Value)) & ",          0         ) "
                            cmd.ExecuteNonQuery()
                        End If
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.*,b.* from Sales_Delivery_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo   where " & _
                                              " a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & _
                                               " and a.Sales_Delivery_Code LIKE '" & Pk_Condition & "%' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Sales_Delivery_No", con)
            da.Fill(dt2)
    ...
    Private Sub cbo_Filter_ItemName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Item_Head", "Item_Name", "", "(Item_IdNo = 0)")
    End Sub
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from Sales_Delivery_head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo   where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Delivery_Code = '" & Trim(NewCode) & "' ", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(1) = Val(35) : ClArr(2) = 500 : ClArr(3) = 85
...
LOOP1:
                        If Len(ItmNmDesc) > 65 Then
                            For k = 65 To 1 Step -1
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Dim Cmp_PhNo As String, Cmp_GSTinNo As String, Cmp_CstNo As String
        ...
        Cmp_PhNo = "" : Cmp_GSTinNo = "" : Cmp_CstNo = ""
        Cmp_Desc = "" : Cmp_Email = ""
        ...
        If Trim(prn_HdDt.Rows(0).Item("Company_GSTinNo").ToString) <> "" Then
            Cmp_GSTinNo = "GSTIN NO.: " & prn_HdDt.Rows(0).Item("Company_GSTinNo").ToString
        End If
        ...
        CurY = CurY + TxtHgt - 10
        p1Font = New Font("President", 17, FontStyle.Bold)
        ...
        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, Cmp_GSTinNo, LMargin + 10, CurY, 2, PageWidth - 20, pFont)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "M-" & prn_HdDt.Rows(0).Item("Sales_dELIVERY_No").ToString, LMargin + C1 + W1 - 20, CurY, 0, 0, p1Font)
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If Trim(prn_HdDt.Rows(0).Item("Remarks").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "Remarks : " & prn_HdDt.Rows(0).Item("Remarks").ToString, LMargin + 5, CurY, 0, 0, pFont)
            End If
