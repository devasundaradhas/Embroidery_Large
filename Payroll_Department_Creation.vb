Public Class Department_Creation
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        If dt.Rows.Count > 0 Then
            ...
            txt_Code.Text = dt.Rows(0).Item("Department_Code").ToString
        End If
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Department_Head(Department_IdNo, Department_Name, sur_name,Department_Code) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(Sur) & "','" & Trim(txt_Code.Text) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Department_Head set Department_Name = '" & Trim(txt_Name.Text) & "', sur_name = '" & Trim(Sur) & "',Department_Code ='" & Trim(txt_Code.Text) & "' where Department_IdNo = " & Str(Val(lbl_IdNo.Text)) & ""
                cmd.ExecuteNonQuery()
