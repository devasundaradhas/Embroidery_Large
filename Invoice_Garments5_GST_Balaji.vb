Public Class Invoice_Garments5_GST_Balaji
    ...
    Private Sub Invoice_Garments_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1137" Or Trim(Common_Procedures.settings.CustomerCode) = "1149" Or Trim(Common_Procedures.settings.CustomerCode) = "1501" Then 'Natraj Knit wear
                    ...
                    If prn_DetMxIndx > 0 Then
                        ...
                        Do While DetIndx <= prn_DetMxIndx
                            ...
                            Else
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 10), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 10, CurY, 0, 0, pFont)
