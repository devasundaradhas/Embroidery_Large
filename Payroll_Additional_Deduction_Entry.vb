Public Class Payroll_Additional_Deduction_Entry
    ...
    Private Pk_Condition As String = "EADDE-"
    ...
    Private Sub clear()
        ...
        txt_Mess.Text = ""
        txt_Store.Text = ""
        txt_OtherAddition.Text = ""
        txt_OtherDeduction.Text = ""
    End Sub
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_Mess.Text = Val(dt1.Rows(0).Item("Mess").ToString)
                txt_Medical.Text = Val(dt1.Rows(0).Item("Medical").ToString)
                txt_Store.Text = Val(dt1.Rows(0).Item("Store").ToString)
                txt_OtherAddition.Text = Val(dt1.Rows(0).Item("Other_Addition").ToString)
                txt_OtherDeduction.Text = Val(dt1.Rows(0).Item("Other_Deduction").ToString)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Employee_Addition_and_Deduction_Entry, "~L~") = 0 And InStr(Common_Procedures.UR.Employee_Addition_and_Deduction_Entry, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        ...
        Try
            ...
            NewCode = Pk_Condition + Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_Refno.Text) & "/" & Trim(Common_Procedures.FnYearCode)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            NewCode = Pk_Condition + Trim(Val(lbl_Company.Tag)) & "-" & Trim(inpno) & "/" & Trim(Common_Procedures.FnYearCode)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Employee_Deduction_No from PayRoll_Employee_Deduction_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Employee_Deduction_No", con)
            dt = New DataTable
            da.Fill(dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_Check(Common_Procedures.UR.Employee_Addition_and_Deduction_Entry, New_Entry) = False Then Exit Sub
        ...
        Try
            ...
            Try
                ...
                Cnt = Common_Procedures.get_FieldValue(con, "PayRoll_Employee_Deduction_Head", "Count(Employee_Deduction_Code)", "Employee_IdNo = " & Common_Procedures.Employee_NameToIdNo(con, cbo_EmployeeName.Text) & " And Employee_Deduction_Date = '" & Format(dtp_Date.Value, "dd-MMM-yyyy") & "' and Not Employee_Deduction_Code = '" & NewCode & "'", Val(lbl_Company.Tag))

                If Cnt > 0 Then

                    If MessageBox.Show("An Entry pertaining to this Employee for this Date is already Saved. Do You Want to Continue with Saving ?", "DUPLICATE ENTRY ALERT ...", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
                        Exit Sub
                    Else
                        GoTo A
                    End If
                ...
                Cnt = Common_Procedures.get_FieldValue(con, "PayRoll_Employee_Deduction_Head", "Count(Employee_Deduction_Code)", "Employee_IdNo = " & Common_Procedures.Employee_NameToIdNo(con, cbo_EmployeeName.Text) & " And DatePart(Month,Employee_Deduction_Date) = " & Format(dtp_Date.Value, "MM") & " And DatePart(Year,Employee_Deduction_Date) = " & Format(dtp_Date.Value, "yyyy") & " and Not Employee_Deduction_Code = '" & NewCode & "'", Val(lbl_Company.Tag))

                If Cnt > 0 Then
                    If MessageBox.Show("An Entry pertaining to this Employee for this Month is already Saved. Do You Want to Continue with Saving ?", "DUPLICATE ENTRY ALERT ...", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.No Then
                        Exit Sub
                    End If
                End If
...
A:
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into PayRoll_Employee_Deduction_Head( Employee_Deduction_Code, Company_IdNo, Employee_Deduction_No, for_OrderBy, Employee_Deduction_Date, Employee_IdNo,    Advance_Deduction_Amount   ,  Mess   ,   Medical  ,  Store   ,Other_Addition   ,  Other_Deduction, Remarks) Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_Refno.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_Refno.Text))) & ", @EmpDate, " & Val(Emp_id) & "," & Val(txt_Amount.Text) & "," & Val(txt_Mess.Text) & "," & Val(txt_Medical.Text) & "," & Val(txt_Store.Text) & "," & Val(txt_OtherAddition.Text) & "," & Val(txt_OtherDeduction.Text) & ",'" & Trim(txt_remarks.Text) & "' )"

                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update  PayRoll_Employee_Deduction_Head set Employee_Deduction_Date = @EmpDate, Employee_IdNo = " & Val(Emp_id) & ", Advance_Deduction_Amount = " & Val(txt_Amount.Text) & ",  Mess = " & Val(txt_Mess.Text) & "  ,   Medical  = " & Val(txt_Medical.Text) & " ,  Store = " & Val(txt_Store.Text) & "  ,Other_Addition  = " & Val(txt_OtherAddition.Text) & " ,  Other_Deduction = " & Val(txt_OtherDeduction.Text) & " , Remarks = '" & Trim(txt_remarks.Text) & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and  Employee_Deduction_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()

            End If

            vLed_IdNos = "1|" & Emp_id
            vVou_Amts = Val(txt_Mess.Text) & "|" & -1 * (Val(txt_Mess.Text))
            If Common_Procedures.Voucher_Updation(con, "Emp.Mess.Ded", Val(lbl_Company.Tag), Trim(NewCode), Trim(lbl_Refno.Text), dtp_Date.Value.Date, "Vou.No : " & Trim(lbl_Refno.Text), vLed_IdNos, vVou_Amts, ErrMsg, tr) = False Then
    ...
    Private Sub Employee_Deduction_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_Medical.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Mess.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Store.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_OtherAddition.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_OtherDeduction.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_Medical.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Mess.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Store.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_OtherAddition.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_OtherDeduction.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_Medical.KeyDown, AddressOf TextBoxControlKeyDown
        AddHandler txt_Mess.KeyDown, AddressOf TextBoxControlKeyDown
        AddHandler txt_Store.KeyDown, AddressOf TextBoxControlKeyDown
        AddHandler txt_OtherAddition.KeyDown, AddressOf TextBoxControlKeyDown
        AddHandler txt_OtherDeduction.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_Medical.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_Mess.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_Store.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_OtherAddition.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_OtherDeduction.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Private Sub txt_Medical_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Medical.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Mess_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Mess.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_OtherAddition_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_OtherAddition.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_OtherDeduction_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_OtherDeduction.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Store_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Store.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                If IsDBNull(dt.Rows(0)(0).ToString) = False Then
                    ...
                    lbl_Medical_Caption.Text = Trim(dt.Rows(0).Item("Ded_Caption1").ToString)
                    lbl_Store_Caption.Text = Trim(dt.Rows(0).Item("Ded_Caption2").ToString)
