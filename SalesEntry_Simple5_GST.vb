Public Class SalesEntry_Simple5_GST
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                lbl_MultiDC_No.Text = dt1.Rows(0).Item("Multi_Dc_No").ToString
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(7).Value = dt2.Rows(i).Item("Dc_No").ToString

                        dgv_Details.Rows(n).Cells(8).Value = dt2.Rows(i).Item("Sales_Detail_SlNo").ToString
    ...
    Private Sub SalesEntry_Simple1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler btn_Print_LASER.GotFocus, AddressOf ControlGotFocus
        AddHandler btn_Print_DOTMATRIX.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler btn_Print_LASER.LostFocus, AddressOf ControlLostFocus
        AddHandler btn_Print_DOTMATRIX.LostFocus, AddressOf ControlLostFocus
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1123" Then
            lbl_dc_no.Text = "Items"
            txt_DcNo_ItemWise.Width = 310
            lbl_description_caption.Left = 370
            txt_Description.Left = cbo_Unit.Left
            txt_Description.Width = 330
            dgv_Details.Columns(7).HeaderText = "ITEMS"
        End If
        lbl_Company.Text = ""
        lbl_Company.Tag = 0
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(7).Value = Trim(txt_DcNo_ItemWise.Text)
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(7).Value = Trim(txt_DcNo_ItemWise.Text)
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        txt_DcNo_ItemWise.Text = Trim(dgv_Details.CurrentRow.Cells(7).Value)
...
LOOP1:
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1503" Then ' LEO GEM KNIT (TIRUPUR)
            Printing_GST_Format4(e)
        ElseIf Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1109" Then ' auro(TIRUPUR)
            Printing_Format_GSt5(e)
        Else
            Printing_Format_GST(e)
        End If
        ...
        With dgv_Selection
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                For i = 0 To Dt1.Rows.Count - 1
                    ...
                    .Rows(n).Cells(19).Value = Trim(Dt1.Rows(i).Item("Item_HSN_Code").ToString)
                    .Rows(n).Cells(20).Value = Val(Dt1.Rows(i).Item("Item_GST_Percentage").ToString)



                    lbl_MultiDC_No.Text = IIf(Trim(lbl_MultiDC_No.Text) <> "", Trim(lbl_MultiDC_No.Text) & ",", "") & Trim(Dt1.Rows(i).Item("Sales_Delivery_No").ToString)
                Next
...
LOOP1:
    ...
    Private Sub Printing_Format_GST(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(0) = 0
        ClArr(1) = 45 : ClArr(2) = 250 : ClArr(3) = 75 : ClArr(4) = 45 : ClArr(5) = 70 : ClArr(6) = 50 : ClArr(7) = 60
                ...
                Try
                    ...
                    If prn_DetMxIndx > 0 Then
                        ...
                        Do While DetIndx <= prn_DetMxIndx
                            ...
                            ITEM_DETAILS = prn_DetAr(DetIndx, 2)
                            If Trim(prn_DetAr(DetIndx, 10)) <> "" Then
                                ITEM_DETAILS = Trim(ITEM_DETAILS) & "  -  " & Trim(prn_DetAr(DetIndx, 10))
                            End If
                            ...
                            Else
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, ITEM_DETAILS, LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                            ...
                            NoofDets = NoofDets + 1
                            If Trim(prn_DetAr(DetIndx, 11)) <> "" Then
                                CurY = CurY + TxtHgt
                                NoofDets = NoofDets + 1
                                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetAr(DetIndx, 11)), LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                            End If
    ...
    Private Sub Printing_GST_Format4(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(0) = 0
        ClArr(1) = Val(35)
        ClArr(2) = 270 : ClArr(3) = 70 : ClArr(4) = 50 : ClArr(5) = 0 : ClArr(6) = 70 : ClArr(7) = 50 : ClArr(8) = 75
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            If Val(prn_DetDt.Rows(DetIndx).Item("Weight").ToString) <> 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Weight").ToString), "############0.000"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) - 10, CurY, 1, 0, pFont)
                            Else
    ...
    Private Sub Printing_GST_Format4_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY1, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Multi_Dc_No").ToString, LMargin + W1 + 30, CurY1 - 3, 0, 0, pFont)
    ...
    Private Sub Printing_GST_Format4_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "E. & O.E", LMargin + C1 - 40, CurY, 1, 0, pFont)
    ...
    End Sub
    Private Sub Printing_Format_GST5(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim EntryCode As String
        Dim I As Integer, NoofDets As Integer, NoofItems_PerPage As Integer
        Dim pFont As Font, p1Font As Font
        Dim LMargin As Single, RMargin As Single, TMargin As Single, BMargin As Single
        ...
        ClArr(0) = 0
        ClArr(1) = 35 : ClArr(2) = 70 : ClArr(3) = 240 : ClArr(4) = 70 : ClArr(5) = 45 : ClArr(6) = 65 : ClArr(7) = 40 : ClArr(8) = 55
        ClArr(9) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8))

        'ClArr(1) = 45 : ClArr(2) = 250 : ClArr(3) = 75 : ClArr(4) = 45 : ClArr(5) = 70 : ClArr(6) = 50 : ClArr(7) = 60 : ClArr(8) = 60
        'ClArr(9) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8))
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_Format_GST5_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                ...
                Try
                    ...
                    If prn_DetMxIndx > 0 Then
                        ...
                        Do While DetIndx <= prn_DetMxIndx
                            ...
                            If NoofDets > NoofItems_PerPage Then
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, "Continued....", LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) - 10, CurY, 1, 0, pFont)
                                NoofDets = NoofDets + 1
                                Printing_Format_GST5_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, Cmp_Name, NoofDets, False)
                                e.HasMorePages = True
                            ...
                            ItmNm1 = Trim(prn_DetAr(DetIndx, 10))
                            ItmNm2 = ""
                            If Len(ItmNm1) > 8 Then
                                For K = 8 To 1 Step -1
                                    If Mid$(Trim(ItmNm1), K, 1) = " " Or Mid$(Trim(ItmNm1), K, 1) = "," Or Mid$(Trim(ItmNm1), K, 1) = "." Or Mid$(Trim(ItmNm1), K, 1) = "-" Or Mid$(Trim(ItmNm1), K, 1) = "/" Or Mid$(Trim(ItmNm1), K, 1) = "_" Or Mid$(Trim(ItmNm1), K, 1) = "(" Or Mid$(Trim(ItmNm1), K, 1) = ")" Or Mid$(Trim(ItmNm1), K, 1) = "\" Or Mid$(Trim(ItmNm1), K, 1) = "[" Or Mid$(Trim(ItmNm1), K, 1) = "]" Or Mid$(Trim(ItmNm1), K, 1) = "{" Or Mid$(Trim(ItmNm1), K, 1) = "}" Then Exit For
                                Next K
                                If K = 0 Then K = 8
                            ...
                            Else
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 1), LMargin + 15, CurY, 0, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1), LMargin + ClArr(1) + 3, CurY, 0, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, ITEM_DETAILS, LMargin + ClArr(1) + ClArr(2) + 5, CurY, 0, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 3), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + 5, CurY, 0, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 4), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 5, CurY, 1, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 5), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) - 5, CurY, 1, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 6), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) - 5, CurY, 1, 0, pFont)
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 8), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9) - 5, CurY, 1, 0, pFont)

                            End If

                            NoofDets = NoofDets + 1
                            If Trim(prn_DetAr(DetIndx, 11)) <> "" Or Trim(ItmNm2) <> "" Then
                                CurY = CurY + TxtHgt
                                NoofDets = NoofDets + 1
                                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetAr(DetIndx, 11)), LMargin + ClArr(1) + ClArr(2) + 5, CurY, 0, 0, pFont)
                    ...
                    Printing_Format_GST5_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, Cmp_Name, NoofDets, True)
    ...
    Private Sub Printing_Format_GST5_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        Dim Cmp_Name As String, Cmp_Add1 As String, Cmp_Add2 As String
    ...
    Private Sub Printing_Format_GST5_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        Dim p1Font As Font
        Dim Rup1 As String, Rup2 As String
        Dim I As Integer
        Dim BInc As Integer
