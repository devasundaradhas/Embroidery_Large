Public Class Sales_Receipt1
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_ChallanNo.Text = dt1.Rows(0).Item("Challan_No").ToString
                txt_ChallanDate.Text = dt1.Rows(0).Item("Challan_Date").ToString
                txt_Weight1.Text = Format(Val(dt1.Rows(0).Item("Weight").ToString), "########0.000")
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name from Sales_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo where a.Sales_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(12).Value = dt2.Rows(i).Item("Delivery_No_Of_Rolls").ToString
                        dgv_Details.Rows(n).Cells(13).Value = dt2.Rows(i).Item("Delivery_Quantity").ToString
                ...
                With dgv_Details_Total
                    ...
                    .Rows(0).Cells(6).Value = Val(dt1.Rows(0).Item("Total_Weight").ToString)
                    .Rows(0).Cells(8).Value = Format(Val(dt1.Rows(0).Item("SubTotal_Amount").ToString), "########0.00")
                End With
    ...
    Private Sub Sales_Receipt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
       ...
       AddHandler txt_Quantity.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_Weight1.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_ChallanNo.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_ChallanDate.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_Weight1.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_ChallanNo.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_ChallanDate.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_Weight1.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_ChallanNo.KeyDown, AddressOf TextBoxControlKeyDown
        AddHandler txt_ChallanDate.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_Weight1.KeyPress, AddressOf TextBoxControlKeyPress
        ...
        AddHandler txt_ChallanNo.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_ChallanDate.KeyPress, AddressOf TextBoxControlKeyPress
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Trim(dgv_Details.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        cmd.CommandText = "Insert into Sales_Receipt_Details ( Sales_Receipt_Code      ,            Company_IdNo          ,              Sales_Receipt_No     ,                                              for_OrderBy                   , Sales_Receipt_Date     ,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo      ,  ItemGroup_IdNo           ,       Item_Description                  ,      Unit_IdNo         ,                 Quantity                ,        Weight                            ,                   Rate                    ,                 Amount                   ,               Assessable_Value      ,            HSN_Code                    , Tax_Perc                                  ,   Rate_For  ) " & _
                                                                    " Values ('" & Trim(NewCode) & "'  , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @RecDate               , " & Str(Val(led_id)) & ", " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(itm_GrpId)) & ", '" & Trim(.Rows(i).Cells(2).Value) & "'," & Str(Val(unt_id)) & "," & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & ", " & Str(Val(.Rows(i).Cells(7).Value)) & " , " & Str(Val(.Rows(i).Cells(8).Value)) & "," & Val(.Rows(i).Cells(11).Value) & ", '" & Trim(.Rows(i).Cells(9).Value) & "', " & Str(Val(.Rows(i).Cells(10).Value)) & ",'" & Trim(.Rows(i).Cells(4).Value) & "')"
                        cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_ItemName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ItemName.KeyPress
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            If Trim(cbo_ItemName.Text) <> "" Then
                If cbo_Unit.Visible And cbo_Unit.Enabled Then
                    cbo_Unit.Focus()
                Else
                    cbo_RateFor.Focus()
                End If
    ...
    Private Sub cbo_BookedBy_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_BookedBy.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_BookedBy, txt_DateTime_Of_Supply, txt_Freight_ToPay, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_BookedBy_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_BookedBy.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_BookedBy, txt_Freight_ToPay, "", "", "", "")
    End Sub
    ...
    Private Sub txt_Weight_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Weight1.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub
