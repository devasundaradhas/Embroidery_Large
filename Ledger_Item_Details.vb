Public Class Ledger_Item_Details
    ...
    Private Pk_Condition As String = "LEDIM-"
    ...
    Private Sub Ledger_Item_Details_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Ledger_Item_Details_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Ledger_Item_Details_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        Try
    ...
    Private Sub Ledger_Item_Details_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim da As New SqlClient.SqlDataAdapter
        Dim dt1 As New DataTable
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Ledger_Item_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Ledger_Item_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_DcNo.Text = dt1.Rows(0).Item("Ledger_Item_No").ToString
                cbo_PartyName.Text = Common_Procedures.Ledger_IdNoToName(con, Val(dt1.Rows(0).Item("Ledger_IdNo").ToString))


                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Item_Name from Ledger_Item_Details a LEFT OUTER JOIN Item_Head b ON a.Item_IdNo = b.Item_IdNo  Where a.Ledger_Item_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Ledger_Item_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Ledger_Item_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Ledger_Item_No from Ledger_Item_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Ledger_Item_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Ledger_Item_No from Ledger_Item_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Ledger_Item_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Ledger_Item_No from Ledger_Item_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Ledger_Item_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Ledger_Item_No from Ledger_Item_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Ledger_Item_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Ledger_Item_Head", "Ledger_Item_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Ledger_Item_No from Ledger_Item_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(2).Value) <> 0 Then
                ...
                Itm_ID = Common_Procedures.Item_NameToIdNo(con, dgv_Details.Rows(i).Cells(1).Value)
                If Itm_ID = 0 Then
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Ledger_Item_Head", "Ledger_Item_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Ledger_Item_Head ( Ledger_Item_Code ,               Company_IdNo       ,     Ledger_Item_No  ,                                               for_OrderBy                                                   ,             Ledger_IdNo     ,              Total_Quantity      ) " & _
                                    "     Values                              (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",      " & Str(Val(Led_ID)) & "," & Str(Val(vTotQty)) & ") "
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update Ledger_Item_Head set  Ledger_IdNo =  " & Str(Val(Led_ID)) & " ,  Total_Quantity = " & Str(Val(vTotQty)) & "   Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            With dgv_Details
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(.Rows(i).Cells(2).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Ledger_Item_Details ( Ledger_Item_Code               ,               Company_IdNo                 ,   Ledger_Item_No    ,                     for_OrderBy                                            ,       Sl_No       ,        Ledger_IdNo         ,       Item_IdNo       ,                   Quantity            ) " & _
                                            "     Values                        (   '" & Trim(NewCode) & "'      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))) & ",  " & Str(Val(Sno)) & ", " & Str(Val(Led_ID)) & "   , " & Str(Val(Itm_ID)) & ", " & Str(Val(.Rows(i).Cells(2).Value)) & ") "
                        cmd.ExecuteNonQuery()
    ...
    Private Sub btn_Filter_Close_Click(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Ledger_Item_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Ledger_Item_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, d.Ledger_Name as TransportName from Ledger_Item_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo Left outer JOIN Ledger_Head d ON a.Transport_IdNo = d.Ledger_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Ledger_Item_Code = '" & Trim(NewCode) & "'", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_name, d.ClothType_name from Ledger_Item_Details a INNER JOIN Cloth_Head b ON a.Cloth_idno = b.Cloth_idno LEFT OUTER JOIN ClothType_Head d ON a.ClothType_idno = d.ClothType_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Ledger_Item_Code = '" & Trim(NewCode) & "' Order by a.Sl_No", con)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Cloth_name, d.ClothType_name from Ledger_Item_Details a INNER JOIN Cloth_Head b ON a.Cloth_idno = b.Cloth_idno LEFT OUTER JOIN ClothType_Head d ON a.ClothType_idno = d.ClothType_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Ledger_Item_Code = '" & Trim(EntryCode) & "' Order by a.Sl_No", con)
        da2.Fill(dt2)
        ...
        Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Ledger_Item_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
        ...
        Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
        Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Ledger_Item_Details_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
        CurY = CurY + TxtHgt + 10
