Public Class PayRoll_Employee_PermissionLeaveTime_Entry
    ...
    Private Pk_Condition As String = "TIPET-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Payroll_Employee_PermissionLeaveTime_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Timing_PermissionLeaveTime_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Timing_PermissionLeaveTime_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Timing_PermissionLeaveTime_Date").ToString

                dtp_Date.Tag = dtp_Date.Text

                lbl_Day.Text = dt1.Rows(0).Item("Day_Name").ToString

                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Employee_Name from Payroll_Employee_PermissionLeaveTime_Details a INNER JOIN PayRoll_Employee_Head b ON a.Employee_IdNo <> 0 and a.Employee_IdNo = b.Employee_IdNo  Where a.Timing_PermissionLeaveTime_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            If Val(dt2.Rows(i).Item("PermissionLeaveTime_Hours").ToString) <> 0 Then
                                .Rows(n).Cells(2).Value = Format(Val(dt2.Rows(i).Item("PermissionLeaveTime_Hours").ToString), "########0.00")
                            End If
    ...
    Private Sub PayRoll_Employee_PermissionLeaveTime_Entry_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            If FrmLdSTS = True Then
                ...
                Me.Text = Common_Procedures.CompGroupName
    ...
    Private Sub PayRoll_Employee_PermissionLeaveTime_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub PayRoll_Employee_PermissionLeaveTime_Entry_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        On Error Resume Next
        con.Close()
        con.Dispose()
    ...
    Private Sub PayRoll_Employee_PermissionLeaveTime_Entry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Payroll_Employee_PermissionLeaveTime_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Payroll_Employee_PermissionLeaveTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Timing_PermissionLeaveTime_No from Payroll_Employee_PermissionLeaveTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Timing_PermissionLeaveTime_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Timing_PermissionLeaveTime_No from Payroll_Employee_PermissionLeaveTime_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Timing_PermissionLeaveTime_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Timing_PermissionLeaveTime_No from Payroll_Employee_PermissionLeaveTime_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Timing_PermissionLeaveTime_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Timing_PermissionLeaveTime_No from Payroll_Employee_PermissionLeaveTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Timing_PermissionLeaveTime_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Payroll_Employee_PermissionLeaveTime_Head", "Timing_PermissionLeaveTime_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Timing_PermissionLeaveTime_No from Payroll_Employee_PermissionLeaveTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim PermissionLeaveTime_Mins As Integer = 0
        Dim Sno As Integer = 0
        Dim EntID As String = ""
        Dim PermissionLeaveTime_Dbl As Double = 0
        Dim PermissionLeaveTime_Int As Integer = 0
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(2).Value) <> 0 Then
                    ...
                    If InStr(1, Trim(UCase(vDup_EmpIDS)), "~" & Val(Empe_ID) & "~") > 0 Then
                        MessageBox.Show("Duplicate Employee - " & .Rows(i).Cells(1).Value, "DOES NOT SAVE...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
                        If .Enabled And .Visible Then
                            .Focus()
                            .CurrentCell = .Rows(i).Cells(1)
                        End If
                    ...
                    vDup_EmpIDS = Trim(vDup_EmpIDS) & "~" & Val(Empe_ID) & "~"
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Payroll_Employee_PermissionLeaveTime_Head", "Timing_PermissionLeaveTime_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Payroll_Employee_PermissionLeaveTime_Head (   Timing_PermissionLeaveTime_Code   ,               Company_IdNo       ,           Timing_PermissionLeaveTime_No  ,         for_OrderBy    , Timing_PermissionLeaveTime_Date ,       Day_Name               ) " &
                                  "            Values                       (   '" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(OrdBy)) & ",      @EntryDate         , '" & Trim(lbl_Day.Text) & "' ) "
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Payroll_Employee_PermissionLeaveTime_Head set Timing_PermissionLeaveTime_Date = @EntryDate,  Day_Name = '" & Trim(lbl_Day.Text) & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(Empe_ID) <> 0 Then
                        ...
                        If Trim(.Rows(i).Cells(2).Value) <> "" Then
                            ...
                            PermissionLeaveTime_Int = Int(Val(.Rows(i).Cells(2).Value))

                            PermissionLeaveTime_Dbl = Val(.Rows(i).Cells(2).Value) - Val(PermissionLeaveTime_Int)

                            PermissionLeaveTime_Mins = Val((PermissionLeaveTime_Int) * 60) + Val(PermissionLeaveTime_Dbl * 100)

                            cmd.CommandText = "Insert into Payroll_Employee_PermissionLeaveTime_Details (         Timing_PermissionLeaveTime_Code                ,               Company_IdNo       ,       Timing_PermissionLeaveTime_No      , Timing_PermissionLeaveTime_Date,    for_OrderBy        ,                Sl_No     ,      Employee_IdNo       , PermissionLeaveTime_Hours                                 ,       PermissionLeaveTime_Minutes   ) " &
                                              "            Values                          ( '" & Trim(Pk_Condition) & Trim(NewCode) & "'  , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "',  @EntryDate         ," & Str(Val(OrdBy)) & ",     " & Str(Val(Sno)) & ", " & Str(Val(Empe_ID)) & ", " & Str(Val(.Rows(i).Cells(2).Value)) & ",  " & Str(Val(PermissionLeaveTime_Mins)) & " ) "
                            cmd.ExecuteNonQuery()
    ...
    '                If (e.ColumnIndex = 1 Or e.ColumnIndex = 2) And Trim(.Rows(e.RowIndex).Cells(e.ColumnIndex).Value) <> "" Then
    '                    .Rows.Add()
    '                End If
    '            End If
    '        End With
    ...
    Public Sub get_DateDetails()
        ...
        Try
            ...
            Cmd.CommandText = "select Timing_PermissionLeaveTime_No from Payroll_Employee_PermissionLeaveTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_PermissionLeaveTime_Date = @EntryDate"
    ...
    Private Sub dtp_Grid_Time_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub dtp_Grid_Time_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
