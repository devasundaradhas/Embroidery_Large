...
Public Class Invoice_Embroidery_Pcs_Direct
            ...
            If dt1.Rows.Count > 0 Then
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(2).Value = dt2.Rows(i).Item("Ordercode_forSelection").ToString
    ...
    Private Sub Invoice_Embroidery_Pcs_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            If Common_Procedures.settings.CustomerCode = "5001" Then
                btn_Export_Inv_To_Excel.Visible = True
            End If
    ...
    Private Sub Invoice_Embroidery_Pcs_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Common_Procedures.settings.CustomerCode = "1086" Then
            rdo_DoNotPrintOrderNo.Checked = True
        End If
        ...
        AddHandler txt_OrdNo.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_OrdNo.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_OrdNo.LostFocus, AddressOf ControlLostFocus
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' AND ISDIRECT = 1 Order by for_Orderby, Sales_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select Sales_No from Sales_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Code LIKE '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "'  AND ISDIRECT = 1  Order by for_Orderby, Sales_No", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Dim da As New SqlClient.SqlDataAdapter("select Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "'  AND ISDIRECT = 1  Order by for_Orderby desc, Sales_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If CloseOrderAfterAutoBill And Len(Trim(AutoBillOrdNo)) > 0 Then
                cmd.CommandText = "Update Order_Program_Head Set Close_Status =1 Where OrderCode_forSelection = '" & AutoBillOrdNo & "'"
                cmd.ExecuteNonQuery()
            End If
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(2).Value = txt_OrdNo.Text
                    .Rows(i).Cells(3).Value = (txt_DcNo_ItemWise.Text)
                    ...
                    .Rows(i).Cells(17).Value = txt_DetailsDesign.Text
                    .Rows(i).Cells(19).Value = cbo_colour.Text
                    .Rows(i).Cells(20).Value = cbo_Size.Text
                    PIC = Nothing
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(2).Value = txt_OrdNo.Text
                .Rows(n).Cells(3).Value = (txt_DcNo_ItemWise.Text)
                ...
                .Rows(n).Cells(17).Value = txt_DetailsDesign.Text
                .Rows(n).Cells(19).Value = cbo_colour.Text
                .Rows(n).Cells(20).Value = cbo_Size.Text
                PIC = Nothing
                PIC = Picture_Box.BackgroundImage
    ...
    Private Sub cbo_ItemName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_ItemName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_ItemName, txt_VechileNo, txt_OrdNo, "Item_Head", "Item_Name", "", "(Item_IdNo = 0)")
    ...
    Private Sub cbo_ItemName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ItemName.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ItemName, txt_OrdNo, "Item_Head", "Item_Name", "", "(Item_IdNo = 0)")
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If pnl_InputDetails.Enabled = True And txt_SlNo.Enabled = True Then
            ...
            If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
                ...
                txt_SlNo.Text = Val(dgv_Details.CurrentRow.Cells(0).Value)
                cbo_ItemName.Text = Trim(dgv_Details.CurrentRow.Cells(1).Value)
                txt_OrdNo.Text = Trim(dgv_Details.CurrentRow.Cells(2).Value)
                cbo_colour.Text = Trim(dgv_Details.CurrentRow.Cells(19).Value)
                cbo_Size.Text = Trim(dgv_Details.CurrentRow.Cells(20).Value)
                ...
                txt_DetailsDesign.Text = Trim(dgv_Details.CurrentRow.Cells(17).Value)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            Try
                ...
                da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code," & _
                                                   "Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code from Sales_Head a LEFT OUTER JOIN " & _
                                                   " Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  LEFT OUTER JOIN State_Head Lsh ON b.State_Idno = Lsh.State_IdNo " & _
                                                   " INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo  LEFT OUTER JOIN State_Head Csh " & _
                                                   " ON c.Company_State_IdNo = csh.State_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & _
                ...
                If prn_HdDt.Rows.Count > 0 Then
                    ...
                    da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, b.Item_Name_tamil, c.Unit_Name,OP.Order_No as OrdNo from Sales_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on a.unit_idno = c.unit_idno  LEFT OUTER JOIN Order_Program_Head OP on " & _
                                                   " a.OrderCode_forSelection = OP.OrderCode_forSelection  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        For I = 0 To prn_DetDt.Rows.Count - 1
                            ...
                            ItmNm1 = "JOB No : " & Trim(prn_DetDt.Rows(I).Item("Details_Design").ToString)
                            ...
                            If rdo_OrderNoOnDetails.Checked Then
                                If Not IsDBNull(prn_DetDt.Rows(I).Item("OrdNo")) Then
                                    If Len(Trim(prn_DetDt.Rows(I).Item("OrdNo"))) > 0 Then
                                        ItmNm1 = ItmNm1 & "(Order No : " & Trim(prn_DetDt.Rows(I).Item("OrdNo")) & ")"
                                    End If
                                End If
                            End If
                            ...
                            prn_DetAr(prn_DetMxIndx, 4) = prn_DetDt.Rows(I).Item("DC_No")
        ...
        With dgv_Selection
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                For i = 0 To Dt1.Rows.Count - 1
                    ...
                    .Rows(n).Cells(20).Value = (Dt1.Rows(i).Item("Order_Date").ToString)
    ...
    Private Sub btn_Close_Selection_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Close_Selection.Click
        ...
        For i = 0 To dgv_Selection.RowCount - 1
            ...
            If Val(dgv_Selection.Rows(i).Cells(12).Value) = 1 Then
                ...
                txt_OrderDate.Text = dgv_Selection.Rows(i).Cells(20).Value
            End If
...
LOOP1:
    ...
    Private Sub Printing_Format_GST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Else
                Common_Procedures.Print_To_PrintDocument(e, "SAC CODE", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY + 5, 2, ClAr(4), pFont)
            End If
    ...
    Private Sub Printing_Format2_GST(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Dim EntryCode As String
            ...
            ClArr(0) = 0
        ClArr(1) = 25 : ClArr(2) = 280 : ClArr(3) = 85 : ClArr(4) = 70 : ClArr(5) = 0 : ClArr(6) = 0 : ClArr(7) = 75 : ClArr(8) = 80
        ClArr(9) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8))
                            ...
                            If Not imageData Is Nothing Then
                                Using ms As New MemoryStream(imageData, 0, imageData.Length)
                                    ...
                                    If imageData.Length > 0 Then
                                        ...
                                        e.Graphics.DrawImage(DirectCast(PIC, Drawing.Image), LMargin + ClArr(1) + ClArr(2) + 5, CurY, 130, 65)
...
SKIPIMAGE1:
    ...
    Private Sub Printing_Format2_GST_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1117" Then
            ...
            Else
                p1Font = New Font("President", 22, FontStyle.Bold)
            End If
        Else
            If Trim(Common_Procedures.settings.CustomerCode) = "5002" Then
                e.Graphics.DrawImage(DirectCast(Global.Billing.My.Resources.Resources.ABILOGO, Drawing.Image), LMargin + 12, CurY + 5, 195, 130)
            End If
            p1Font = New Font("Calibri", 28, FontStyle.Bold)
        End If
        ...
        If Common_Procedures.settings.CustomerCode = "5002" Then
            Common_Procedures.Print_To_PrintDocument(e, Cmp_Name, LMargin, CurY, 2, PrintWidth - 20, p1Font, cM_br)
        Else
        ...
        LnAr(2) = CurY
            ...
            If Len(Trim(Led_GSTTinNo)) > 0 Then
                CurY = CurY + TxtHgt
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, BlockInvNoY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + 25, BlockInvNoY, 0, 0, pFont)
            ...
            If rdo_OrderNoInHeader.Checked Then
                ...
                If Trim(prn_HdDt.Rows(0).Item("Order_No").ToString) <> "" Then
                    Common_Procedures.Print_To_PrintDocument(e, "Order No(s) ", LMargin + Cen1 + 10, BlockInvNoY, 0, 0, p1Font)
                    Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, BlockInvNoY, 0, 0, pFont)
                    For I = 0 To Split(Trim(prn_HdDt.Rows(0).Item("Order_No").ToString), "$$$").GetUpperBound(0)

                        If I <> 0 And (Common_Procedures.settings.CustomerCode = "1117" Or Common_Procedures.settings.CustomerCode = "5002") Then
                            BlockInvNoY = BlockInvNoY + TxtHgt
                            BlockInvNoY = BlockInvNoY + TxtHgt - 20
                        ElseIf Not (Common_Procedures.settings.CustomerCode = "1117" Or Common_Procedures.settings.CustomerCode = "5002") Then
                            BlockInvNoY = BlockInvNoY + TxtHgt
                            BlockInvNoY = BlockInvNoY + TxtHgt - 20
                        End If

                        If (Common_Procedures.settings.CustomerCode = "1117" Or Common_Procedures.settings.CustomerCode = "5002") Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, "NO", LMargin, CurY + 5, 2, ClAr(1), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "PARTICULARS", LMargin + ClAr(1), CurY + 5, 2, ClAr(2), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "DC.NO/DATE", LMargin + ClAr(1) + ClAr(2), CurY + 5, 2, ClAr(3), pFont)
    ...
    Private Sub Printing_Format2_GST_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        If Common_Procedures.settings.CustomerCode = "1086" Then
            ...
            Try
                ...
                CurY = CurY + TxtHgt - 10
                Common_Procedures.Print_To_PrintDocument(e, "TOTAL", LMargin + ClAr(1) + ClAr(2) + ClAr(3) - 5, CurY, 1, 0, pFont)
                If is_LastPage = True Then
                ...
                If Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString) <> 0 Then
                    ...
                    If is_LastPage = True Then
                        If Common_Procedures.settings.CustomerCode = "5008" Then
                            If Val(prn_HdDt.Rows(0).Item("CashDiscount_Perc")) > 0 Then
                                Common_Procedures.Print_To_PrintDocument(e, "Matrial Value Debit @ " & Trim(Val(prn_HdDt.Rows(0).Item("CashDiscount_Perc").ToString)) & "%", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) - 10, CurY, 1, 0, pFont)
                            Else
                                Common_Procedures.Print_To_PrintDocument(e, "Matrial Value Debit : ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) - 10, CurY, 1, 0, pFont)
                            End If
                        Else
                            Common_Procedures.Print_To_PrintDocument(e, "Cash Discount @ " & Trim(Val(prn_HdDt.Rows(0).Item("CashDiscount_Perc").ToString)) & "%", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) - 10, CurY, 1, 0, pFont)
                        End If
                    ...
                    If Trim(Common_Procedures.settings.CustomerCode) = "1117" Then
                        cM_br = New SolidBrush(Color.Green)
                    ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1086" Then
                        cM_br = New SolidBrush(Color.Black)
                    Else
                    ...
                    If Common_Procedures.settings.CustomerCode = "1086" Then
                        p1Font = New Font("Comic Sans MS", 11, FontStyle.Bold)
                    Else
                        p1Font = New Font("Calibri", 12, FontStyle.Bold)
                    End If

                    If Common_Procedures.settings.CustomerCode = "1086" Then
                        p1Font = New Font("Comic Sans MS", 8, FontStyle.Bold)
                    End If
                    ...
                    Trim(prn_HdDt.Rows(0).Item("Company_Name").ToString)

                    CurY = CurY + TxtHgt


                    Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Company_Description").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) - 10, CurY, 1, 0, p1Font, cM_br)


                    Common_Procedures.Print_To_PrintDocument(e, "Remarks :", LMargin + 10, CurY, 0, 0, pFont)
                    CurY = CurY + TxtHgt
                    Common_Procedures.Print_To_PrintDocument(e, "Please make the payment by Cheque/DD ", LMargin + 10, CurY, 0, 0, pFont)
                    CurY = CurY + TxtHgt
                    Common_Procedures.Print_To_PrintDocument(e, "in favour of ARANIEXPORT (Embroidery Division)", LMargin + 10, CurY, 0, 0, pFont)
        ...
        Else
            ...
            Try
                ...
                If Trim(Common_Procedures.settings.CustomerCode) = "1117" Then
                    cM_br = New SolidBrush(Color.Green)
                ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1086" Or Trim(Common_Procedures.settings.CustomerCode) = "5001" Then
                    cM_br = New SolidBrush(Color.Black)
                ElseIf Trim(Common_Procedures.settings.CustomerCode) = "5002" Then
                    cM_br = New SolidBrush(Color.Navy)
                Else
                ...
                End If
                    ...
                    e.Graphics.DrawLine(Pens.Black, LMargin, CurY, PageWidth, CurY)
                e.Graphics.DrawLine(Pens.Black, LMargin, TMargin, LMargin, CurY)
                e.Graphics.DrawLine(Pens.Black, PageWidth, TMargin, PageWidth, CurY)
    ...
    Private Sub cbo_Size_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_colour.LostFocus
    ...
    Private Sub cbo_OrderNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Order_Program_head", "Ordercode_forSelection", "Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text), "")
    End Sub
    ...
    Private Sub cbo_OrderNo_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Trim(UCase(txt_OrdNo.Text)) <> "" Then

            da = New SqlClient.SqlDataAdapter("select a.* from Order_Program_Head a where a.Ordercode_forSelection = '" & Trim(txt_OrdNo.Text) & "'", con)
            dt = New DataTable
            da.Fill(dt)

            If dt.Rows.Count > 0 Then
                If IsDBNull(dt.Rows(0)("Design").ToString) = False Then
                    txt_DetailsDesign.Text = dt.Rows(0)("Design").ToString
                End If
    ...
    Private Sub cbo_OrderNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub QuantityDetails()
        t1.Text = Common_Procedures.get_FieldValue(con, "Sales_Delivery_Details", "sum(Quantity)", "OrderCode_forSelection = '" & txt_OrdNo.Text & "' and Sales_Delivery_Code Like 'EMDEL%' " _
                                                          , Common_Procedures.CompIdNo)

        t2.Text = Common_Procedures.get_FieldValue(con, "Sales_Delivery_Details", "sum(Quantity)", "OrderCode_forSelection = '" & txt_OrdNo.Text & "' and Sales_Delivery_Code Like 'EMDEL%' " & _
                                                           " AND Colour_IdNo = '" & Common_Procedures.Colour_NameToIdNo(con, cbo_colour.Text) & "' and Size_IdNo = '" & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text) & "' " _
                                                           , Common_Procedures.CompIdNo)


        s1.Text = Common_Procedures.get_FieldValue(con, "Sales_Details", "sum(Quantity)", "OrderCode_forSelection = '" & txt_OrdNo.Text & "' and Sales_Code Like 'GINVE%' " & _
        ...
        s2.Text = Common_Procedures.get_FieldValue(con, "Sales_Details", "sum(Quantity)", "OrderCode_forSelection = '" & txt_OrdNo.Text & "' and Sales_Code Like 'GINVE%' " & _
                                                           " AND Colour_IdNo = '" & Common_Procedures.Colour_NameToIdNo(con, cbo_colour.Text) & "' and Size_IdNo = '" & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text) & "' " & _
                                                           " AND NOT SALES_CODE = '" & Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_InvoiceNo.Text) & "/" & Trim(Common_Procedures.FnYearCode) & "'" _
                                                           , Common_Procedures.CompIdNo)
    ...
    'Private Sub btn_AutoBill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    '    pnl_InputDetails.Enabled = False
    '    dgv_Details.Enabled = False
    ...
    '            MsgStr = MsgStr + "Image Will Be Displaye On Bill. "
    '        Else
    ...
    '    txt_OrdNo.Text = dgv_OrderList.Item(1, AutoBillRow).Value
    ...
    Private Sub txt_OrdNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_OrdNo.KeyPress
        If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub btn_Export_Inv_To_Excel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Export_Inv_To_Excel.Click
        ...
        'Dim NewCode1 As String = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_InvoiceNo.Text) & "-" & Trim(Common_Procedures.FnYearCode)

        'For Each workbook In excel_app.Workbooks
        '    If workbook.Name = "\INVOICE" & NewCode & ".xlsm" Then
        '        MsgBox("Close the Workbook Named " & "\INVOICE" & NewCode1 & ".xlsm. It needs to be closed to proceed further ")
        '        Exit Sub
        '    End If
        'Next

        'If File.Exists(Application.StartupPath & "\INVOICE" & NewCode1 & ".xlsm") Then
        '    File.Delete(Application.StartupPath & "\INVOICE" & NewCode1 & ".xlsm")
        'End If

        'File.Copy(Application.StartupPath & "\INVOICE.xlsm", Application.StartupPath & "\INVOICE" & NewCode1 & ".xlsm", True)

        'workbook = excel_app.Workbooks.Open(Application.StartupPath & "\INVOICE" & NewCode1 & ".xlsm")
        ...
        '    sheet.Cells(13, 2) = Trim(prn_HdDt.Rows(0).Item("Ledger_Name").ToString)

        '    sheet.Cells(14, 2) = Trim(prn_HdDt.Rows(0).Item("Ledger_Address1").ToString)
        '    sheet.Cells(15, 2) = Trim(prn_HdDt.Rows(0).Item("Ledger_Address2").ToString)
        '    sheet.Cells(16, 2) = Trim(prn_HdDt.Rows(0).Item("Ledger_Address3").ToString)
        '    sheet.Cells(18, 2) = Trim(prn_HdDt.Rows(0).Item("Ledger_Address4").ToString)


        '    If Trim(prn_HdDt.Rows(0).Item("Ledger_GSTinNo").ToString) <> "" Then
        '        sheet.Cells(19, 2) = "GSTIN : " & prn_HdDt.Rows(0).Item("Ledger_GSTinNo").ToString
        '    End If

        '    sheet.Cells(2, 8) = Trim(prn_HdDt.Rows(0).Item("Sales_No").ToString)
        '    sheet.Cells(2, 10) = "DATE : " & Format(prn_HdDt.Rows(0).Item("Sales_Date"), "dd-MM-yyyy")
        '    sheet.Cells(18, 7) = "PARTY D.C No. : " & Trim(prn_HdDt.Rows(0).Item("Electronic_Reference_No").ToString)
        '    sheet.Cells(15, 7) = "ORDER No/STYLE.:" & Join(Split(Trim(prn_HdDt.Rows(0).Item("Order_No").ToString), "$$$"), ",")
        ...
        '        Do While RL < prn_DetDt.Rows.Count
        '            sheet.Cells(RL + 22, 2) = CStr(RL + 1)
        '            sheet.Cells(RL + 22, 3) = prn_DetDt.Rows(RL).Item("Details_Design")
        '            sheet.Cells(RL + 22, 7) = "998821"
        '            sheet.Cells(RL + 22, 8) = "5%"
        '            sheet.Cells(RL + 22, 9) = prn_DetDt.Rows(RL).Item("Quantity")
        '            sheet.Cells(RL + 22, 10) = FormatNumber(prn_DetDt.Rows(RL).Item("Rate"), 2, TriState.False, TriState.False, TriState.False)
        '            sheet.Cells(RL + 22, 11) = FormatNumber(prn_DetDt.Rows(RL).Item("Amount"), 2, TriState.False, TriState.False, TriState.False)
        '            RL = RL + 1
        '        Loop
