Public Class Salesman_Creation
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        da = New SqlClient.SqlDataAdapter("select a.* from Salesman_Head a where a.Salesman_Idno = " & Str(Val(idno)), con)
        da.Fill(dt)

        If dt.Rows.Count > 0 Then
            lbl_IdNo.Text = dt.Rows(0).Item("Salesman_Idno").ToString
            txt_Name.Text = dt.Rows(0).Item("Salesman_Name").ToString
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from Salesman_Head where Salesman_Idno = " & Str(Val(lbl_IdNo.Text))
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select Salesman_Idno, Salesman_Name from Salesman_Head where Salesman_Idno <> 0 order by Salesman_Idno", con)
        Dim dt As New DataTable
        ...
        With dgv_Filter
            ...
            .Columns(1).HeaderText = "SALESMAN NAME"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Salesman_Idno) from Salesman_Head Where Salesman_Idno <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Salesman_Idno) from Salesman_Head Where Salesman_Idno <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Salesman_Idno) from Salesman_Head Where Salesman_Idno > " & Str(Val(lbl_IdNo.Text)) & " and Salesman_Idno <> 0", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Salesman_Idno) from Salesman_Head Where Salesman_Idno < " & Str(Val(lbl_IdNo.Text)) & " and Salesman_Idno <> 0", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Salesman_Head", "Salesman_Idno", "")
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        Dim da As New SqlClient.SqlDataAdapter("select Salesman_Name from Salesman_Head order by Salesman_Name", con)
        Dim dt As New DataTable

        da.Fill(dt)

        cbo_Open.DataSource = dt
        cbo_Open.DisplayMember = "Salesman_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Salesman_Head", "Salesman_Idno", "", trans)

                cmd.CommandText = "Insert into Salesman_Head(Salesman_Idno, Salesman_Name, sur_name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "' ,'" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Salesman_Head set Salesman_Name = '" & Trim(txt_Name.Text) & "',  sur_name = '" & Trim(Sur) & "' where Salesman_Idno = " & Str(Val(lbl_IdNo.Text)) & ""
                cmd.ExecuteNonQuery()
            ...
            Common_Procedures.Master_Return.Master_Type = "SALESMAN"
        ...
        Catch ex As Exception
            trans.Rollback()
            If InStr(1, Trim(LCase(ex.Message)), "ix_Salesman_Head") > 0 Then
    ...
    Private Sub btn_Open_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Open.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Salesman_Idno from Salesman_Head where Salesman_Name = '" & Trim(cbo_Open.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub cbo_Open_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Open.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Open, Nothing, Nothing, "Salesman_Head", "Salesman_Name", "", "(Salesman_Idno = 0)")
    End Sub
    ...
    Private Sub cbo_Open_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Open.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Open, Nothing, "Salesman_Head", "Salesman_Name", "", "(Salesman_Idno = 0)")
