Public Class Invoice_Saara_GST
    ...
    Private Pk_Condition As String = "GINVS-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                cbo_GST_NoTax_Type.Text = dt1.Rows(0).Item("Entry_GST_Tax_Type").ToString
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            dgv_Details.Rows(n).Cells(11).Value = dt2.Rows(i).Item("HSN_Code").ToString
    ...
    Private Sub Invoice_Saara_GST_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub Invoice_Saara_GST_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cbo_GST_NoTax_Type.Items.Clear()
        cbo_GST_NoTax_Type.Items.Add("NO TAX")
        cbo_GST_NoTax_Type.Items.Add("GST")
        ...
        AddHandler cbo_GST_NoTax_Type.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_GST_NoTax_Type.LostFocus, AddressOf ControlLostFocus
    ...
    Private Sub Invoice_Saara_GST_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Invoice_Saara_GST_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            If dt2.Rows.Count > 0 Then
                ...
                If dt2.Rows(0).Item("Entry_GST_Tax_Type").ToString <> "" Then cbo_GST_NoTax_Type.Text = dt2.Rows(0).Item("Entry_GST_Tax_Type").ToString
            End If
            dt2.Clear()
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and  Sales_Code like '" & Trim(Pk_Condition) & "%' and Sales_Code = '" & Trim(Pk_Condition) & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and  Sales_Code like '" & Trim(Pk_Condition) & "%' and Sales_Code = '" & Trim(Pk_Condition) & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        If itm_id <> 0 Then
                            ...
                            cmd.CommandText = "Insert into Sales_Details (                    Sales_Code              ,             Company_IdNo         ,               Sales_No            ,           for_OrderBy      , Sales_Date,          Ledger_IdNo    ,        Sl_No         ,         Item_IdNo       ,           Colour_IdNo    ,              Rolls                       ,                 Weight_Roll             ,                      Meters              ,           Unit_IdNo     ,                      Weight              ,                      Rate                 ,                      Amount              ,                      Total_Amount        ,                    Serial_No             ,                      HSN_Code           ,                      Tax_Perc              ,       Cash_Discount_Perc_For_All_Item     ,       Cash_Discount_Amount_For_All_Item   ,              Assessable_Value            ) " & _
                            ...
                            If Trim(UCase(cbo_Type.Text)) <> "DELIVERY" Then
                                cmd.CommandText = "Insert into Item_Processing_Details (    Reference_Code    ,             Company_IdNo         ,            Reference_No           ,          for_OrderBy       , Reference_Date,          Ledger_IdNo    ,           Party_Bill_No           ,            SL_No     ,          Item_IdNo      ,     Unit_IdNo           ,                     Quantity               ) " & _
                                                  " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ",    @SalesDate , " & Str(Val(led_id)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(Unt_ID)) & ", " & Str(-1 * Val(.Rows(i).Cells(6).Value)) & " )"
                                cmd.ExecuteNonQuery()
                            End If
            ...
            'Amt = Val(CSng(lbl_NetAmount.Text)) - Val(txt_Freight.Text) - Val(txt_AddLess.Text) - Val(lbl_RoundOff.Text)
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                ...
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(11).Value = lbl_Grid_HsnCode.Text
                    .Rows(i).Cells(12).Value = Format(Val(lbl_Grid_GstPerc.Text), "########0.00")
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(11).Value = lbl_Grid_HsnCode.Text
                .Rows(n).Cells(12).Value = Format(Val(lbl_Grid_GstPerc.Text), "########0.00")
    ...
    Private Sub cbo_PaymentMethod_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PaymentMethod.KeyDown
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PaymentMethod, txt_DcDate, txt_Electronic_RefNo, "", "", "", "")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        Try
            vcbo_KeyDwnVal = e.KeyValue
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, cbo_Type, cbo_OnAccount, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10)", "(Ledger_IdNo = 0)")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub Amount_Calculation()
        ...
        If Trim(UCase(cbo_UnitName.Text)) = "ROLL" Then
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        If ItmIdNo <> 0 Then
                            ...
                            If Trim(UCase(cbo_GST_NoTax_Type.Text)) = "GST" Then
                                ...
                                If dt.Rows.Count > 0 Then
                                    ...
                                    If IsDBNull(dt.Rows(0)("Item_HSN_Code").ToString) = False Then
                                        .Rows(i).Cells(11).Value = dt.Rows(0)("Item_HSN_Code").ToString
                                    End If
                                    If IsDBNull(dt.Rows(0)("Item_GST_Percentage").ToString) = False Then
                                        .Rows(i).Cells(12).Value = Format(Val(dt.Rows(0)("Item_GST_Percentage").ToString), "#########0.00")
                                    End If
                            ...
                            If Trim(UCase(.Rows(i).Cells(6).Value)) = "ROLL" Then
                                .Rows(i).Cells(9).Value = Format(Val(.Rows(i).Cells(3).Value) * Val(.Rows(i).Cells(8).Value), "#########0.00")

                            ElseIf Trim(UCase(.Rows(i).Cells(6).Value)) = "METER" Then
                                .Rows(i).Cells(9).Value = Format(Val(.Rows(i).Cells(5).Value) * Val(.Rows(i).Cells(8).Value), "#########0.00")

                            Else
                                .Rows(i).Cells(9).Value = Format(Val(.Rows(i).Cells(7).Value) * Val(.Rows(i).Cells(8).Value), "#########0.00")

                            End If

                            .Rows(i).Cells(13).Value = Format(Val(txt_CashDiscPerc.Text), "#########0.00")
                            .Rows(i).Cells(14).Value = Format(Val(.Rows(i).Cells(9).Value) * Val(.Rows(i).Cells(13).Value) / 100, "#########0.00")
                            .Rows(i).Cells(15).Value = Format(Val(.Rows(i).Cells(9).Value) - Val(.Rows(i).Cells(14).Value), "#########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(14).Value = Format(Val(TotDiscAmt), "########0.00")
            .Rows(0).Cells(15).Value = Format(Val(TotAssval), "########0.00")
        End With
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(lbl_GrossAmount.Text) - Val(lbl_CashDiscAmount.Text) + Val(txt_Freight.Text) + Val(txt_AddLess.Text) + Val(lbl_IGstAmount.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Unit_Name from Sales_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on A.unit_idno = c.unit_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        TxtHgt = 19.5 ' 21 ' e.Graphics.MeasureString("A", pFont).Height  ' 20

        NoofItems_PerPage = 8 ' 14 ' 10
        ...
        ClArr(0) = 0
        ClArr(1) = 40
        ClArr(2) = 270 : ClArr(3) = 75 : ClArr(4) = 50 : ClArr(5) = 90 : ClArr(6) = 60 : ClArr(7) = 55
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetDt.Rows(DetIndx).Item("HSN_Code").ToString), LMargin + ClArr(1) + ClArr(2) + 10, CurY, 0, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Trim(Val(prn_DetDt.Rows(DetIndx).Item("Tax_Perc").ToString) & " %"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 10, CurY, 1, 0, pFont)

                            If Trim(UCase(prn_DetDt.Rows(0).Item("Unit_Name").ToString)) = "METER" Then

                                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Meters").ToString), "########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 10, CurY, 1, 0, pFont)

                            ElseIf Trim(UCase(prn_DetDt.Rows(0).Item("Unit_Name").ToString)) = "ROLL" Then

                                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Rolls").ToString), "########0"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 10, CurY, 1, 0, pFont)

                            Else
                                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Weight").ToString), "########0.000"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 10, CurY, 1, 0, pFont)
                                ...
                                If Trim(UCase(prn_DetDt.Rows(0).Item("Unit_Name").ToString)) <> "ROLL" Then
                                    If Trim(ItmNm2) <> "" Then
                                        ...
                                        If Val(prn_DetDt.Rows(DetIndx).Item("Rolls").ToString) <> 0 Then
                                            Common_Procedures.Print_To_PrintDocument(e, "(" & Val(prn_DetDt.Rows(DetIndx).Item("Rolls").ToString) & " Rolls)", LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 10, CurY, 1, 0, pFont)
                                        End If
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Dim Cmp_StateCap As String, Cmp_StateNm As String, Cmp_StateCode As String, Cmp_GSTIN_Cap As String, Cmp_GSTIN_No As String, Cmp_Pan_No As String, Cmp_Pan_Cap As String
        Dim strHeight As Single
        Dim Led_Name As String, Led_Add1 As String, Led_Add2 As String, Led_Add3 As String, Led_Add4 As String, Led_TinNo As String, Led_cstNo As String, Led_Pan_No As String
        ...
        Cmp_Desc = "" : Cmp_Email = ""
        Cmp_StateCap = "" : Cmp_StateNm = "" : Cmp_StateCode = "" : Cmp_GSTIN_Cap = "" : Cmp_GSTIN_No = "" : Cmp_Pan_Cap = "" : Cmp_Pan_No = ""
        ...
        If Trim(prn_HdDt.Rows(0).Item("Company_State_Name").ToString) <> "" Then
            Cmp_StateCap = "STATE : "
            Cmp_StateNm = prn_HdDt.Rows(0).Item("Company_State_Name").ToString & "  " & Cmp_StateCode
        End If
        ...
        If Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString) <> "" Then
            Cmp_Pan_Cap = "PAN NO : "
            Cmp_Pan_No = prn_HdDt.Rows(0).Item("Company_PanNo").ToString
        End If
        ...
        e.Graphics.DrawImage(DirectCast(Global.Billing.My.Resources.Resources.Saara_Creations_logo, Drawing.Image), LMargin + 12, CurY + 1, 150, 75)
        ...
        strWidth = e.Graphics.MeasureString(Trim(Cmp_StateCap & Cmp_GSTIN_Cap & Cmp_Pan_Cap), p1Font).Width
        strWidth = e.Graphics.MeasureString(Trim(Cmp_StateCap & Cmp_StateNm & "   " & Cmp_GSTIN_Cap & Cmp_GSTIN_No & "    " & Cmp_Pan_Cap & Cmp_Pan_No), pFont).Width
        ...
        Try
            ...
            Led_Name = "" : Led_Add1 = "" : Led_Add2 = "" : Led_Add3 = "" : Led_Add4 = "" : Led_TinNo = "" : Led_PhNo = "" : Led_cstNo = "" : Led_GSTTinNo = "" : Led_State = "" : Led_StateCode = "" : Led_Pan_No = ""
            ...
            If Trim(prn_HdDt.Rows(0).Item("Cash_PartyName").ToString) <> "" Then
                ...
                If UBound(PnAr) >= 8 Then Led_StateCode = Trim(PnAr(8))
            ...
            Else
                ...
                If Trim(prn_HdDt.Rows(0).Item("Ledger_TinNo").ToString) <> "" Then Led_TinNo = "Tin No : " & Trim(prn_HdDt.Rows(0).Item("Ledger_TinNo").ToString)
                If Trim(prn_HdDt.Rows(0).Item("Ledger_CstNo").ToString) <> "" Then Led_cstNo = "Cst No : " & Trim(prn_HdDt.Rows(0).Item("Ledger_CstNo").ToString)
                ...
                If Trim(prn_HdDt.Rows(0).Item("Ledger_State_Code").ToString) <> "" Then Led_StateCode = " CODE : " & Trim(prn_HdDt.Rows(0).Item("Ledger_State_Code").ToString)
            ...
            If Trim(Led_State) <> "" Then
                LInc = LInc + 1
                LedNmAr(LInc) = Led_State & "  " & Led_StateCode
            End If
            ...
            W3 = e.Graphics.MeasureString("DC   DATE:", pFont).Width
            W4 = e.Graphics.MeasureString("DC   DATE  :  01- 01 -2017", pFont).Width
            ...
            '    Common_Procedures.Print_To_PrintDocument(e, "PO No.", LMargin + Cen1 + W4 + 10, BlockInvNoY, 0, 0, pFont)
            '    Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W4 + W3 + 10, BlockInvNoY, 0, 0, pFont)
            '    Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Order_No").ToString, LMargin + Cen1 + W4 + W3 + 30, BlockInvNoY, 0, 0, pFont)
            'End If
            ...
            If Trim(prn_HdDt.Rows(0).Item("Dc_Date").ToString) <> "" Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W3 + 10, BlockInvNoY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Dc_Date").ToString, LMargin + Cen1 + W3 + 30, BlockInvNoY, 0, 0, pFont)
            End If

            BlockInvNoY = BlockInvNoY + TxtHgt
            If Trim(prn_HdDt.Rows(0).Item("Order_No").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "PO No.", LMargin + Cen1 + 10, BlockInvNoY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W3 + 10, BlockInvNoY, 0, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Order_Date").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "PO Date", LMargin + Cen1 + 10, BlockInvNoY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W3 + 10, BlockInvNoY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Order_Date").ToString, LMargin + Cen1 + W3 + 30, BlockInvNoY, 0, 0, pFont)
            End If

            'If Trim(prn_HdDt.Rows(0).Item("Order_Date").ToString) <> "" Then
            '    Common_Procedures.Print_To_PrintDocument(e, "PO Date", LMargin + Cen1 + W4 + 10, BlockInvNoY, 0, 0, pFont)
            '    Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W4 + W3 + 10, BlockInvNoY, 0, 0, pFont)
            '    Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Order_Date").ToString, LMargin + Cen1 + W4 + W3 + 30, BlockInvNoY, 0, 0, pFont)
            'End If

            CurY = CurY + TxtHgt
            If Trim(prn_HdDt.Rows(0).Item("Date_Time_Of_Supply").ToString) <> "" Then
                p1Font = New Font("Calibri", 10, FontStyle.Regular)
                Common_Procedures.Print_To_PrintDocument(e, "Date & Time of Issue", LMargin + Cen1 + 10, CurY, 0, 0, p1Font)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 40, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Date_Time_Of_Supply").ToString, LMargin + Cen1 + W1 + 50, CurY, 0, 0, p1Font)
            End If
            ...
            Common_Procedures.Print_To_PrintDocument(e, "CODE", LMargin + ClAr(1) + ClAr(2), CurY + 10, 2, ClAr(3), pFont)
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) > 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "Add Amount", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "Less Amount", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
                    End If
            ...
            If Trim(UCase(prn_DetDt.Rows(0).Item("Unit_Name").ToString)) <> "ROLL" Then
                If Val(prn_HdDt.Rows(0).Item("Total_Rolls").ToString) <> 0 Then
                    If is_LastPage = True Then
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, Val(prn_HdDt.Rows(0).Item("Total_Rolls").ToString) & " Rolls", LMargin + ClAr(1) + ClAr(2) + 10, CurY, 0, 0, pFont)
                    End If
                End If
            End If
            ...
            If Trim(UCase(prn_DetDt.Rows(0).Item("Unit_Name").ToString)) = "METER" Then
                If Val(prn_HdDt.Rows(0).Item("Total_Meters").ToString) <> 0 Then
                    If is_LastPage = True Then
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Total_Meters").ToString), "########0.00") & " " & prn_DetDt.Rows(0).Item("Unit_Name").ToString, LMargin + ClAr(1) + ClAr(2) + 10, CurY, 0, 0, pFont)
                    End If
                End If
            ...
            ElseIf Trim(UCase(prn_DetDt.Rows(0).Item("Unit_Name").ToString)) = "ROLL" Then
                If Val(prn_HdDt.Rows(0).Item("Total_Rolls").ToString) <> 0 Then
                    If is_LastPage = True Then
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, "Total Rolls", LMargin + ClAr(1) + ClAr(2) - 10, CurY, 1, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Total_Rolls").ToString), "########0") & " " & prn_DetDt.Rows(0).Item("Unit_Name").ToString, LMargin + ClAr(1) + ClAr(2) + 10, CurY, 0, 0, pFont)
                    End If
                End If
                ...
                If Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString) <> 0 Then
                    If is_LastPage = True Then
                        If prn_HdDt.Rows(0).Item("NoOf_Bundle").ToString <> "" Then
                            Common_Procedures.Print_To_PrintDocument(e, "No.Of Bundle : " & prn_HdDt.Rows(0).Item("NoOf_Bundle").ToString, LMargin + ClAr(1) + 10, CurY, 0, 0, pFont)
                        End If
                        Common_Procedures.Print_To_PrintDocument(e, "Total Qty", LMargin + ClAr(1) + ClAr(2) - 10, CurY, 1, 0, pFont)
                        Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString), "########0.000") & " " & prn_DetDt.Rows(0).Item("Unit_Name").ToString, LMargin + ClAr(1) + ClAr(2) + 10, CurY, 0, 0, pFont)
                    End If
                End If
            ...
            If is_LastPage = True Then
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, "Rs. " & Common_Procedures.Currency_Format(Val(prn_HdDt.Rows(0).Item("Net_Amount").ToString)), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) - 10, CurY, 1, 0, p1Font)
            End If
            ...
            CurY = CurY + TxtHgt
            p1Font = New Font("Calibri", 10, FontStyle.Regular)
            Common_Procedures.Print_To_PrintDocument(e, "We declare that this invoice shows the actual price of", LMargin + 30, CurY, 0, 0, p1Font)

            CurY = CurY + TxtHgt
            p1Font = New Font("Calibri", 10, FontStyle.Regular)
            Common_Procedures.Print_To_PrintDocument(e, "the goods described and that all particulars are true and correct.", LMargin + 30, CurY, 0, 0, p1Font)

            CurY = CurY + TxtHgt + 5
            p1Font = New Font("Calibri", 9, FontStyle.Regular)
            Common_Procedures.Print_To_PrintDocument(e, "Authorised Signatory", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) - 10, CurY, 1, 0, p1Font)
    ...
    Private Sub txt_OrderDate_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_OrderDate.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        If e.KeyValue = 38 Then e.Handled = True : e.SuppressKeyPress = True : txt_OrderNo.Focus()
        If e.KeyValue = 40 Then e.Handled = True : e.SuppressKeyPress = True : txt_DcNo.Focus()
    End Sub

    Private Sub txt_OrderDate_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_OrderDate.KeyPress
        If Asc(e.KeyChar) = 13 Then e.Handled = True : txt_DcNo.Focus()
    End Sub
    ...
    Private Sub cbo_GST_NoTax_Type_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_GST_NoTax_Type.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "", "", "", "")
        cbo_GST_NoTax_Type.Tag = cbo_GST_NoTax_Type.Text
    End Sub

    Private Sub cbo_GST_NoTax_Type_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_GST_NoTax_Type.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_GST_NoTax_Type, txt_DateTime_Of_Supply, txt_SlNo, "", "", "", "")
    End Sub

    Private Sub cbo_GST_NoTax_Type_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_GST_NoTax_Type.KeyPress

        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_GST_NoTax_Type, txt_SlNo, "", "", "", "")
            If Asc(e.KeyChar) = 13 Then
                If Trim(UCase(cbo_GST_NoTax_Type.Tag)) <> Trim(UCase(cbo_GST_NoTax_Type.Text)) Then
                    cbo_GST_NoTax_Type.Tag = cbo_GST_NoTax_Type.Text
                    Amount_Calculation(True)
                End If
            End If
    ...
    Private Sub cbo_OnAcc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_OnAccount.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_OnAccount, cbo_Ledger, txt_OrderNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo = 0 or AccountsGroup_IdNo = 14 or AccountsGroup_IdNo = 6 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_OnAcc_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_OnAccount.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_OnAccount, txt_OrderNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_IdNo = 0 or AccountsGroup_IdNo = 14 or AccountsGroup_IdNo = 6 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub Get_HSN_CodeWise_GSTTax_Details()
        ...
        Dim Sno As Integer = 0
        Dim n As Integer = 0
        Dim AssVal_Frgt_AdLs_Charges As Double = 0
        Dim LedIdNo As Integer = 0
        Dim ItmIdNo As Integer = 0
        Dim InterStateStatus As Boolean = False
        ...
        Try
            ...
            AssVal_Frgt_AdLs_Charges = Val(txt_Freight.Text) + Val(txt_AddLess.Text)
                ...
                With dgv_Details
                    ...
                    If .Rows.Count > 0 Then
                        For i = 0 To .Rows.Count - 1
                            ...
                            If Trim(.Rows(i).Cells(1).Value) <> "" And Trim(.Rows(i).Cells(11).Value) <> "" And Val(.Rows(i).Cells(12).Value) <> 0 And Val(.Rows(i).Cells(15).Value) <> 0 Then

                                cmd.CommandText = "Insert into EntryTemp (                    Name1                ,                   Currency1            ,                       Currency2                                      ) " & _
                                                  "            Values    ( '" & Trim(.Rows(i).Cells(11).Value) & "', " & (Val(.Rows(i).Cells(12).Value)) & ", " & Str(Val(.Rows(i).Cells(15).Value) + AssVal_Frgt_AdLs_Charges) & " ) "
                                cmd.ExecuteNonQuery()

                                AssVal_Frgt_AdLs_Charges = 0
    ...
    Private Sub cbo_GST_NoTax_Type_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_GST_NoTax_Type.SelectedIndexChanged
        If Trim(UCase(cbo_GST_NoTax_Type.Tag)) <> Trim(UCase(cbo_GST_NoTax_Type.Text)) Then
            cbo_GST_NoTax_Type.Tag = cbo_GST_NoTax_Type.Text
            Amount_Calculation(True)
        End If
    ...
    Private Sub cbo_GST_NoTax_Type_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_GST_NoTax_Type.LostFocus
        Try
    ...
    Private Sub get_Item_Unit_Rate_TaxPerc()
        ...
        If Trim(UCase(cbo_ItemName.Tag)) <> Trim(UCase(cbo_ItemName.Text)) And Trim(UCase(cbo_ItemName.Text)) <> Trim(UCase("System.Data.DataRowView")) Then
            cbo_ItemName.Tag = cbo_ItemName.Text
