Public Class Variety_Creation
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Variety_IdNo, Variety_Name from Variety_Head where Variety_IdNo = " & Str(Val(idno))

            dr = cmd.ExecuteReader

            If dr.HasRows Then
                If dr.Read() Then
                    txt_IdNo.Text = dr("Variety_IdNo").ToString()
                    txt_Name.Text = dr("Variety_Name").ToString()
                End If
            End If
    ...
    Private Sub Variety_Creation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Height = 284 ' 197
    ...
    Private Sub Variety_Creation_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub Variety_Creation_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select count(*) from item_head where Variety_IdNo = " & Str(Val(txt_IdNo.Text)), con)
            dt = New DataTable
            da.Fill(dt)
            ...
            da = New SqlClient.SqlDataAdapter("select count(*) from Sales_Details where Variety_IdNo = " & Str(Val(txt_IdNo.Text)), con)
            dt = New DataTable
            da.Fill(dt)
            If dt.Rows.Count > 0 Then
                If IsDBNull(dt.Rows(0)(0).ToString) = False Then
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from Variety_Head where Variety_IdNo = " & Str(Val(txt_IdNo.Text))
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select Variety_IdNo, Variety_Name from Variety_Head where Variety_IdNo <> 0 order by Variety_IdNo", con)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Variety_IdNo) from Variety_Head Where Variety_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select max(Variety_IdNo) from Variety_Head WHERE Variety_IdNo <> 0"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select min(Variety_IdNo) from Variety_Head where Variety_IdNo > " & Str(Val(txt_IdNo.Text))
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Variety_IdNo) from Variety_Head where Variety_IdNo < " & Str(Val(txt_IdNo.Text)) & " and Variety_IdNo <> 0 ", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        txt_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Variety_Head", "Variety_IdNo", "")

        'cmd.Connection = con
        'cmd.CommandText = "select max(Variety_IdNo) from Variety_Head"
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        Dim da As New SqlClient.SqlDataAdapter("select Variety_Name from Variety_Head order by Variety_Name", con)
        Dim dt As New DataTable

        da.Fill(dt)

        cbo_Find.DataSource = dt
        cbo_Find.DisplayMember = "Variety_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                txt_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Variety_Head", "Variety_IdNo", "", trans)

                cmd.CommandText = "Insert into Variety_Head(Variety_IdNo, Variety_Name, sur_name) values (" & Str(Val(txt_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Variety_Head set Variety_Name = '" & Trim(txt_Name.Text) & "', sur_name = '" & Trim(Sur) & "' where Variety_IdNo = " & Str(Val(txt_IdNo.Text))
                cmd.ExecuteNonQuery()
            ...
            Common_Procedures.Master_Return.Master_Type = "VARIETY"
    ...
    Private Sub btn_Find_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Find.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Variety_IdNo from Variety_Head where Variety_Name = '" & Trim(cbo_Find.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub cbo_Find_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_Find.SelectedIndexChanged
