Public Class Invoice_Garments4
    ...
    Private Pk_Condition As String = "INGM4-"
    ...
    Private Sub Invoice_Garments_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lbl_NoofBundles_Caption.Text = "No.of Cartons"
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        If nr = 0 Then
                            cmd.CommandText = "Insert into Sales_Details ( Sales_Code,            Company_IdNo          ,              Sales_No             ,                                              for_OrderBy                   , Sales_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo      , ItemGroup_IdNo         ,         Unit_IdNo      ,            Size_IdNo   ,   Bags  ,             Noof_Items                 ,                 Rate                     ,                 Amount                   ,                    Total_Amount    ,                    Entry_Type ,                           Sales_Order_Code ,                            Sales_Order_Detail_SlNo ) " & _
    ...
    Private Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            W1 = e.Graphics.MeasureString("NO.OF CARTONS :", pFont).Width
            Yinc = 5
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_No").ToString, LMargin + Cen1 + W1 + 80, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "DATE", LMargin + Cen1 + 10, CurY + Yinc, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 70, CurY + Yinc, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + 80, CurY + Yinc, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 70, CurY + Yinc, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Order_No").ToString, LMargin + Cen1 + W1 + 80, CurY + Yinc, 0, 0, pFont)

            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, LedAr(3), LMargin + H1 + 10, CurY, 0, 0, pFont)


            Common_Procedures.Print_To_PrintDocument(e, "ORDER DATE", LMargin + Cen1 + 10, CurY + Yinc, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 70, CurY + Yinc, 0, 0, pFont)
            If IsDate(prn_HdDt.Rows(0).Item("Order_Date").ToString) Then
                Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Order_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + 80, CurY + Yinc, 0, 0, pFont)
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Total_Bags").ToString) <> 0 Then
                Common_Procedures.Print_To_PrintDocument(e, "NO.OF CARTONS", LMargin + Cen1 + 10, CurY + Yinc, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 70, CurY + Yinc, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Total_Bags").ToString, LMargin + Cen1 + W1 + 80, CurY + Yinc, 0, 0, pFont)
            End If
    ...
    Private Sub Printing_Format2_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            CurY1 = CurY1 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "1) Goods once sold cannot be tacken back.", LMargin + 10, CurY1, 0, 0, p1Font)
            CurY1 = CurY1 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "2) Interest @ 24% will be charged if the bill is not paid on or before due date.", LMargin + 10, CurY1, 0, 0, p1Font)
            'CurY1 = CurY1 + TxtHgt
            'Common_Procedures.Print_To_PrintDocument(e, "3) Our responsibility ceases once the invoiced goods leaves our factory/godown.", LMargin + 10, CurY1, 0, 0, p1Font)

            Juris = Trim(Common_Procedures.settings.Jurisdiction)
            If Trim(Juris) = "" Then Juris = "TIRUPUR"

            CurY1 = CurY1 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "3) All Payments should be sends to " & Juris & " Head Office Only", LMargin + 10, CurY1, 0, 0, p1Font)

            CurY1 = CurY1 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "4) Any Disputes subject to " & Juris & " Jurisdiction.", LMargin + 10, CurY1, 0, 0, p1Font)


            If Val(prn_HdDt.Rows(0).Item("Against_CForm_Status").ToString) = 1 Then
                CurY1 = CurY1 + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, "5) Against 'C' Form Sales.", LMargin + 10, CurY1, 0, 0, p1Font)
            End If
