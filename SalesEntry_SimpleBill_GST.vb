Public Class SalesEntry_SimpleBill_GST
    ...
    Private Pk_Condition As String = "GSLBL-"
    ...
    Private Sub clear()
        ...
        txt_Freight_Name.Text = "Freight And Forwarding"

        chk_RoDivision.Checked = False
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                If IsDBNull(dt1.Rows(0).Item("Ro_Division_Status").ToString) = False Then
                    If Val(dt1.Rows(0).Item("Ro_Division_Status").ToString) = 1 Then
                        chk_RoDivision.Checked = True
                    End If
                End If
                ...
                txt_Note.Text = dt1.Rows(0).Item("Narration").ToString
                ...
                txt_Charging_Qty.Text = Val(dt1.Rows(0).Item("Charging_Quantity").ToString)
                txt_Charging_Rate.Text = Format(Val(dt1.Rows(0).Item("Charging_Rate").ToString), "########0.00")
                ...
                txt_FrieghtCharges.Text = Format(Val(dt1.Rows(0).Item("Freight_Charge").ToString), "########0.00")
                txt_Freight_Name.Text = dt1.Rows(0).Item("Freight_Charge_Name").ToString
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            dgv_Details.Rows(n).Cells(4).Value = dt2.Rows(i).Item("HSN_Code").ToString
                            dgv_Details.Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("Tax_Perc").ToString), "########0.00")
                            dgv_Details.Rows(n).Cells(6).Value = Val(dt2.Rows(i).Item("Noof_Items").ToString)
                            ...
                            dgv_Details.Rows(n).Cells(12).Value = dt2.Rows(i).Item("Item_Description").ToString
                        Next i
    ...
    Private Sub SalesEntry_Simple_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub SalesEntry_Simple_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_Charging_Qty.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Charging_Rate.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_FrieghtCharges.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_Charging_Qty.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Charging_Rate.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_FrieghtCharges.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_Charging_Qty.KeyDown, AddressOf TextBoxControlKeyDown
        AddHandler txt_Charging_Rate.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_Charging_Qty.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler txt_Charging_Rate.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Private Sub SalesEntry_Simple_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub SalesEntry_Simple_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Bill_Entry_Saara, "~L~") = 0 And InStr(Common_Procedures.UR.Bill_Entry_Saara, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and  Sales_Code like '" & Trim(Pk_Condition) & "%' and Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Sales_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Sales_No from Sales_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Code like '" & Trim(Pk_Condition) & "%'   and Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Sales_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Sales_No from Sales_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Code like '" & Trim(Pk_Condition) & "%' and   Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Sales_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and  Sales_Code like '" & Trim(Pk_Condition) & "%' and Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Sales_No desc", con)
            da.Fill(dt)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Code = '" & Trim(RefCode) & "' and Entry_VAT_GST_Type = 'GST' ", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.Bill_Entry_Saara, "~L~") = 0 And InStr(Common_Procedures.UR.Bill_Entry_Saara, "~I~") = 0 Then MessageBox.Show("You have No Rights to Insert", "DOES NOT INSERT...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Code = '" & Trim(InvCode) & "' AND Entry_VAT_GST_Type = 'GST'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Common_Procedures.UserRight_Check(Common_Procedures.UR.Bill_Entry_Saara, New_Entry) = False Then Exit Sub
        ...
        RoDiv_STS = 0
        If chk_RoDivision.Checked = True Then RoDiv_STS = 1
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Sales_Head (Entry_Status ,Entry_VAT_GST_Type    ,  Sales_Code  ,              Company_IdNo        ,                Sales_No           ,             for_OrderBy    , Sales_Date,               Payment_Method          ,          Ledger_IdNo    ,        Cash_PartyName  ,             Dc_No            ,              Dc_Date           ,      Ro_Division_Status    ,          SalesAc_IdNo      ,  Tax_Type,           TaxAc_IdNo     ,               Narration           ,           Total_Qty      ,              SubTotal_Amount          , Total_DiscountAmount, Total_TaxAmount,              Gross_Amount             ,                 CashDiscount_Perc      ,              CashDiscount_Amount         ,             Assessable_Value         ,              Tax_Perc             ,                Tax_Amount           ,              Charging_Quantity         ,               Charging_Rate             ,              Freight_Amount       ,              AddLess_Amount       ,              Round_Off             ,             Net_Amount        ,  Freight_Charge  ,     Freight_Charge_Name                                                   ,                Electronic_Reference_No   ,               Transportation_Mode     ,               Date_Time_Of_Supply          ,              Entry_GST_Tax_Type ,                 CGst_Amount          ,                 SGst_Amount          ,               IGst_Amount                         ) " & _
                                        " Values (           'BILL'    ,     'GST'             ,'" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(vforOrdby)) & ", @SalesDate, '" & Trim(cbo_PaymentMethod.Text) & "', " & Str(Val(led_id)) & ", '" & Trim(CsParNm) & "', '" & Trim(txt_DcNo.Text) & "', '" & Trim(txt_DcDate.Text) & "', " & Str(Val(RoDiv_STS)) & ", " & Str(Val(saleac_id)) & ",    'VAT' , " & Str(Val(txac_id)) & ", '" & Trim(txt_Note.Text) & "', " & Str(Val(vTotQty)) & ", " & Str(Val(lbl_GrossAmount.Text)) & ",           0         ,       0        , " & Str(Val(lbl_GrossAmount.Text)) & ", " & Str(Val(txt_CashDiscPerc.Text)) & ", " & Str(Val(lbl_CashDiscAmount.Text)) & ", " & Str(Val(lbl_Assessable.Text)) & ", " & Str(Val(txt_TaxPerc.Text)) & ", " & Str(Val(lbl_TaxAmount.Text)) & ", " & Str(Val(txt_Charging_Qty.Text)) & ", " & Str(Val(txt_Charging_Rate.Text)) & ", " & Str(Val(txt_Freight.Text)) & ", " & Str(Val(txt_AddLess.Text)) & ", " & Str(Val(lbl_RoundOff.Text)) & ", " & Str(Val(CSng(lbl_NetAmount.Text))) & " , " & Str(Val(txt_FrieghtCharges.Text)) & "  , '" & Trim(txt_Freight_Name.Text) & "', '" & Trim(txt_Electronic_RefNo.Text) & "', '" & Trim(cbo_TransportMode.Text) & "', '" & Trim(txt_DateTime_Of_Supply.Text) & "', '" & Trim(cbo_TaxType.Text) & "', " & Str(Val(lbl_CGstAmount.Text)) & ", " & Str(Val(lbl_SGstAmount.Text)) & ", " & Str(Val(lbl_IGstAmount.Text)) & "  )"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Sales_Head set Entry_Status = 'BILL' , Entry_VAT_GST_Type ='GST' , Sales_Date = @SalesDate, Payment_Method = '" & Trim(cbo_PaymentMethod.Text) & "', Ledger_IdNo = " & Str(Val(led_id)) & ", Cash_PartyName = '" & Trim(CsParNm) & "', Dc_No = '" & Trim(txt_DcNo.Text) & "', Dc_Date = '" & Trim(txt_DcDate.Text) & "', Ro_Division_Status = " & Str(Val(RoDiv_STS)) & ", SalesAc_IdNo = " & Str(Val(saleac_id)) & ", Tax_Type = 'VAT', TaxAc_IdNo = " & Str(Val(txac_id)) & ", Total_Qty = " & Str(Val(vTotQty)) & ", SubTotal_Amount = " & Str(Val(lbl_GrossAmount.Text)) & ", Total_DiscountAmount = 0, Total_TaxAmount = 0, Gross_Amount = " & Str(Val(lbl_GrossAmount.Text)) & ", CashDiscount_Perc = " & Str(Val(txt_CashDiscPerc.Text)) & ", CashDiscount_Amount = " & Str(Val(lbl_CashDiscAmount.Text)) & ", Assessable_Value = " & Str(Val(lbl_Assessable.Text)) & ", Tax_Perc = " & Str(Val(txt_TaxPerc.Text)) & ", Tax_Amount = " & Str(Val(lbl_TaxAmount.Text)) & ", Charging_Quantity = " & Str(Val(txt_Charging_Qty.Text)) & ", Freight_Charge = " & Str(Val(txt_FrieghtCharges.Text)) & "   , Freight_Charge_Name =  '" & Trim(txt_Freight_Name.Text) & "'  , Charging_Rate = " & Str(Val(txt_Charging_Rate.Text)) & ", Freight_Amount = " & Str(Val(txt_Freight.Text)) & ", AddLess_Amount = " & Str(Val(txt_AddLess.Text)) & ", Round_Off = " & Str(Val(lbl_RoundOff.Text)) & ",Narration='" & Trim(txt_Note.Text) & "', Net_Amount = " & Str(Val(CSng(lbl_NetAmount.Text))) & ", Electronic_Reference_No = '" & Trim(txt_Electronic_RefNo.Text) & "' ,  Transportation_Mode = '" & Trim(cbo_TransportMode.Text) & "'  ,  Date_Time_Of_Supply = '" & Trim(txt_DateTime_Of_Supply.Text) & "'  , Entry_GST_Tax_Type = '" & Trim(cbo_TaxType.Text) & "',  CGst_Amount = " & Str(Val(lbl_CGstAmount.Text)) & " , SGst_Amount = " & Str(Val(lbl_SGstAmount.Text)) & " , IGst_Amount = " & Str(Val(lbl_IGstAmount.Text)) & "  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Sales_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
            ...
            If Common_Procedures.Voucher_Updation(con, "GST-Bills", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_InvoiceNo.Text), dtp_Date.Value.Date, "Bill No . : " & Trim(lbl_InvoiceNo.Text), vVouPos_IdNos, vVouPos_Amts, vVouPos_ErrMsg, tr) = False Then
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                ...
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(4).Value = Trim(lbl_Grid_HsnCode.Text)
                    .Rows(i).Cells(5).Value = Format(Val(lbl_Grid_GstPerc.Text), "########0.00")
                    .Rows(i).Cells(6).Value = Val(txt_NoofItems.Text)
                    .Rows(i).Cells(7).Value = Format(Val(txt_Rate.Text), "########0.00")
                    .Rows(i).Cells(8).Value = Format(Val(lbl_Amount.Text), "########0.00")
                    .Rows(i).Cells(9).Value = Format(Val(lbl_Grid_DiscPerc.Text), "########0.00")
                    .Rows(i).Cells(10).Value = Format(Val(lbl_Grid_DiscAmount.Text), "########0.00")
                    .Rows(i).Cells(11).Value = Format(Val(lbl_Grid_AssessableValue.Text), "########0.00")
                    .Rows(i).Cells(12).Value = Trim(txt_Description.Text)
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(4).Value = lbl_Grid_HsnCode.Text
                .Rows(n).Cells(5).Value = Format(Val(lbl_Grid_GstPerc.Text), "########0.00")
                .Rows(n).Cells(6).Value = Val(txt_NoofItems.Text)
                .Rows(n).Cells(7).Value = Format(Val(txt_Rate.Text), "########0.00")
                .Rows(n).Cells(8).Value = Format(Val(lbl_Amount.Text), "########0.00")
                .Rows(n).Cells(9).Value = Format(Val(lbl_Grid_DiscPerc.Text), "########0.00")
                .Rows(n).Cells(10).Value = Format(Val(lbl_Grid_DiscAmount.Text), "########0.00")
                .Rows(n).Cells(11).Value = Format(Val(lbl_Grid_AssessableValue.Text), "########0.00")

                .Rows(n).Cells(12).Value = Trim(txt_Description.Text)
    ...
    Private Sub get_Item_Unit_Rate_TaxPerc()
        ...
        If Trim(UCase(cbo_ItemName.Tag)) <> Trim(UCase(cbo_ItemName.Text)) Then
            ...
            PrcLstID = Val(Common_Procedures.get_FieldValue(con, "Ledger_Head", "Price_List_IdNo", "(Ledger_IdNo = " & Str(Val(Led_ID)) & ")"))
            ...
            If PrcLstID <> 0 And Itm_ID <> 0 Then

                da = New SqlClient.SqlDataAdapter("select a.* from Price_List_Details a Where a.Price_list_idno = " & Str(Val(PrcLstID)) & " and a.Item_IdNo = " & Str(Val(Itm_ID)), con)
                dt = New DataTable
                da.Fill(dt)
                If dt.Rows.Count > 0 Then
                    If IsDBNull(dt.Rows(0)("Rate").ToString) = False Then
                        If Val(dt.Rows(0)("Rate").ToString) <> 0 Then
            ...
            da = New SqlClient.SqlDataAdapter("select a.*, b.unit_name from item_head a LEFT OUTER JOIN unit_head b ON a.unit_idno = b.unit_idno where a.item_idno = " & Str(Val(Itm_ID)), con)
            dt = New DataTable
            da.Fill(dt)
            If dt.Rows.Count > 0 Then
                ...
                If Val(txt_Rate.Text) = 0 Then
                    If IsDBNull(dt.Rows(0)("sales_rate").ToString) = False Then
                        If Val(dt.Rows(0)("Sales_rate").ToString) <> 0 Then
    ...
    Private Sub dtp_Date_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dtp_Date.KeyDown
        If e.KeyCode = 40 Then e.Handled = True : e.SuppressKeyPress = True : cbo_Ledger.Focus() 'SendKeys.Send("{TAB}")
    ...
    Private Sub cbo_PaymentMethod_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PaymentMethod.KeyDown
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PaymentMethod, cbo_Ledger, cbo_TaxType, "", "", "", "")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        Try
            vcbo_KeyDwnVal = e.KeyValue
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, dtp_Date, cbo_PaymentMethod, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10)", "(Ledger_IdNo = 0)")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub txt_Charging_Qty_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Charging_Qty.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Charging_Qty_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_Charging_Qty.TextChanged
        txt_Freight.Text = Format(Val(txt_Charging_Qty.Text) * Val(txt_Charging_Rate.Text), "#########0.00")
        NetAmount_Calculation()
    End Sub

    Private Sub txt_Charging_Rate_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Charging_Rate.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
    End Sub

    Private Sub txt_Charging_Rate_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_Charging_Rate.TextChanged
        txt_Freight.Text = Format(Val(txt_Charging_Qty.Text) * Val(txt_Charging_Rate.Text), "#########0.00")
        NetAmount_Calculation()
    End Sub
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
            ...
            lbl_Grid_HsnCode.Text = Trim(dgv_Details.CurrentRow.Cells(4).Value)
            lbl_Grid_GstPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(5).Value), "########0.00")
            txt_NoofItems.Text = Val(dgv_Details.CurrentRow.Cells(6).Value)
            ...
            lbl_Grid_DiscPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(9).Value), "########0.00")
            lbl_Grid_DiscAmount.Text = Format(Val(dgv_Details.CurrentRow.Cells(10).Value), "########0.00")
            lbl_Grid_AssessableValue.Text = Format(Val(dgv_Details.CurrentRow.Cells(11).Value), "########0.00")
            txt_Description.Text = dgv_Details.CurrentRow.Cells(12).Value
...
LOOP1:
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(0) = 0
        ClArr(1) = 45 : ClArr(2) = 375 : ClArr(3) = 70 : ClArr(4) = 40 : ClArr(5) = 0 : ClArr(6) = 0 : ClArr(7) = 75
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1), LMargin + ClArr(1) + 5, CurY, 0, 0, p1Font)
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(prn_DetMxIndx, 3), LMargin + ClArr(1) + ClArr(2) + 5, CurY, 0, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(prn_DetMxIndx, 4), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 3, CurY, 1, 0, pFont)
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Trim(Format(Val(prn_DetDt.Rows(DetIndx).Item("Rate").ToString), "########0.00")), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) - 5, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Trim(Format(Val(prn_DetDt.Rows(DetIndx).Item("Amount").ToString), "########0.00")), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) - 5, CurY, 1, 0, pFont)
                            ...
                            If Trim(prn_DetDt.Rows(DetIndx).Item("Item_Description").ToString) <> "" Then
                                CurY = CurY + TxtHgt
                                NoofDets = NoofDets + 1
                                Common_Procedures.Print_To_PrintDocument(e, "(" & Trim(prn_DetDt.Rows(DetIndx).Item("Item_Description").ToString) & ")", LMargin + ClArr(1) + 10, CurY, 0, 0, p1Font)
                            End If
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Dim Cmp_StateCap As String, Cmp_StateNm As String, Cmp_StateCode_Cap As String, Cmp_StateCode As String, Cmp_GSTIN_Cap As String, Cmp_GSTIN_No As String, Cmp_Pan_No As String, Cmp_Pan_No_Cap As String
        Dim strHeight As Single
        Dim Led_Name As String, Led_Add1 As String, Led_Add2 As String, Led_Add3 As String, Led_Add4 As String, Led_TinNo As String, Led_Pan_No As String, Led_state As String
        Dim Led_GSTTinNo As String
        Dim PnAr() As String
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Unit_Name from Sales_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on b.unit_idno = c.unit_idno where a.Sales_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        dt2 = New DataTable
        da2.Fill(dt2)
        ...
        If Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString) <> "" Then
            Cmp_Pan_No_Cap = "PAN : "
            Cmp_Pan_No = Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString)
        End If
        If Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString) <> "" Then
            Cmp_Pan_No_Cap = "PAN : "
            Cmp_Pan_No = Trim(prn_HdDt.Rows(0).Item("Company_PanNo").ToString)
        ...
        strWidth = e.Graphics.MeasureString(Trim(Cmp_StateCap & Cmp_StateNm & "    " & Cmp_StateCode_Cap & Cmp_StateCode & "   " & Cmp_GSTIN_Cap & Cmp_GSTIN_No & "   " & Cmp_Pan_No_Cap & Cmp_Pan_No), pFont).Width
        ...
        CurX = CurX + strWidth
        Common_Procedures.Print_To_PrintDocument(e, Cmp_StateCode_Cap, CurX, CurY, 0, 0, p1Font)


        strWidth = e.Graphics.MeasureString(Cmp_StateCode_Cap, p1Font).Width
        CurX = CurX + strWidth
        ...
        CurX = CurX + strWidth
        Common_Procedures.Print_To_PrintDocument(e, "                 " & Cmp_Pan_No_Cap, CurX, CurY, 0, PrintWidth, p1Font)
        strWidth = e.Graphics.MeasureString("                   " & Cmp_Pan_No_Cap, p1Font).Width
        CurX = CurX + strWidth
        Common_Procedures.Print_To_PrintDocument(e, Cmp_Pan_No, CurX, CurY, 0, 0, pFont)
        ...
        Try
            ...
            Else
                ...
                If Trim(prn_HdDt.Rows(0).Item("Ledger_PanNo").ToString) <> "" Then Led_Pan_No = " PAN : " & Trim(prn_HdDt.Rows(0).Item("Ledger_PanNo").ToString)
                If Trim(prn_HdDt.Rows(0).Item("Ledger_State_Name").ToString) <> "" Then Led_state = " STATE : " & Trim(prn_HdDt.Rows(0).Item("Ledger_State_Name").ToString) & "  CODE : " & Trim(prn_HdDt.Rows(0).Item("Ledger_State_code").ToString)
            ...
            End If
            If Trim(Led_Pan_No) <> "" Then
                LInc = LInc + 1
                LedNmAr(LInc) = Led_Pan_No
            End If
            ...
            End If
            If Trim(LedNmAr(9)) <> "" Then
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, Trim(LedNmAr(9)), LMargin + W2 + 10, CurY, 0, 0, pFont)
            End If
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_No").ToString, LMargin + Cen1 + W1 + 20, BlockInvNoY, 0, 0, p1Font)

            BlockInvNoY = BlockInvNoY + TxtHgt

            Common_Procedures.Print_To_PrintDocument(e, "Bill Date", LMargin + Cen1 + 10, BlockInvNoY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, BlockInvNoY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + 20, BlockInvNoY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "HSN/SAC", LMargin + ClAr(1) + ClAr(2), CurY - 5, 2, ClAr(3), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "CODE", LMargin + ClAr(1) + ClAr(2), CurY + TxtHgt - 5, 2, ClAr(3), pFont)


            Common_Procedures.Print_To_PrintDocument(e, "GST %", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY, 2, ClAr(4), pFont)
            ' Common_Procedures.Print_To_PrintDocument(e, "NO OF ROOM", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY, 2, ClAr(5), pFont)
            'Common_Procedures.Print_To_PrintDocument(e, "UNIT", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 2, ClAr(6), pFont)

            Common_Procedures.Print_To_PrintDocument(e, "SUB", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY - 5, 2, ClAr(7), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "AMOUNT", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY + TxtHgt - 5, 2, ClAr(7), pFont)
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            w1 = 100
            CurY = CurY + TxtHgt
            'Common_Procedures.Print_To_PrintDocument(e, "HSN/SAC CODE ", LMargin + ClAr(1) + 10, CurY, 0, 0, pFont)
            'Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + w1 + 10, CurY, 0, 0, pFont)
            'Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(0).Item("HSN_CODE").ToString, LMargin + ClAr(1) + w1 + 15, CurY, 0, 0, pFont)
            CurY = CurY + TxtHgt
            'Common_Procedures.Print_To_PrintDocument(e, "GST %", LMargin + ClAr(1) + 10, CurY, 0, 0, pFont)
            'Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + w1 + 10, CurY, 0, 0, pFont)
            'Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(0).Item("Tax_Perc").ToString, LMargin + ClAr(1) + w1 + 15, CurY, 0, 0, pFont)
            ...
            If Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString) <> 0 Then
                ...
                End If
            End If
            Common_Procedures.Print_To_PrintDocument(e, "NOTE : " & Trim(prn_HdDt.Rows(0).Item("Narration").ToString), LMargin + 10, CurY, 0, 0, pFont)
            ...
            If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    ...
                    If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) > 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "Add", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "Less", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
                    End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Freight_Charge").ToString) <> 0 Then
                CurY = CurY + TxtHgt + 5
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Freight_Charge_Name").ToString, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
            ...
            If Val(prn_HdDt.Rows(0).Item("CGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    If vTaxPerc <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "CGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "CGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
                    End If
            ...
            If Val(prn_HdDt.Rows(0).Item("SGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    If vTaxPerc <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "SGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "SGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
                    End If
            ...
            If Val(prn_HdDt.Rows(0).Item("IGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    If vTaxPerc <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "IGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "IGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
                    End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Round_Off").ToString) <> 0 Then
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "Round Off", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 5, CurY, 1, 0, pFont)
    ...
    Private Sub txt_FrieghtCharges_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_FrieghtCharges.KeyDown
        If e.KeyCode = 40 Then btn_save.Focus() ' SendKeys.Send("{TAB}")
        If e.KeyCode = 38 Then SendKeys.Send("+{TAB}")
    End Sub

    Private Sub txt_FrieghtCharges_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_FrieghtCharges.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
        If Asc(e.KeyChar) = 13 Then
            If MessageBox.Show("Do you want to save ?", "FOR SAVING...", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) = DialogResult.Yes Then
                save_record()
    ...
    Private Sub txt_FrieghtCharges_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_FrieghtCharges.TextChanged
        NetAmount_Calculation()
    End Sub
    ...
    Private Sub cbo_TaxType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TaxType.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TaxType, cbo_TransportMode, cbo_ItemName, "", "", "", "")
    End Sub
    ...
    Private Sub Amount_Calculation(ByVal GridAll_Row_STS As Boolean)
                        ...
                        If ItmIdNo <> 0 Then
                            ...
                            If Trim(UCase(cbo_TaxType.Text)) = "GST" Then
                                ...
                                If dt.Rows.Count > 0 Then
                                    ...
                                    If IsDBNull(dt.Rows(0)("Item_HSN_Code").ToString) = False Then
                                        .Rows(i).Cells(4).Value = dt.Rows(0)("Item_HSN_Code").ToString
                                    End If
                                    If IsDBNull(dt.Rows(0)("Item_GST_Percentage").ToString) = False Then
                                        .Rows(i).Cells(5).Value = Format(Val(dt.Rows(0)("Item_GST_Percentage").ToString), "#########0.00")
                                    End If
                            ...
                            .Rows(i).Cells(10).Value = Format(Val(.Rows(i).Cells(8).Value) * Val(.Rows(i).Cells(9).Value) / 100, "#########0.00")
        ...
        Else
            ...
            lbl_Amount.Text = Format(Val(txt_Rate.Text), "#########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                ...
                TotDiscAmt = TotDiscAmt + Val(dgv_Details.Rows(i).Cells(10).Value)
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(lbl_GrossAmount.Text) - Val(lbl_CashDiscAmount.Text) + Val(lbl_TaxAmount.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text) + Val(txt_Freight.Text) + Val(txt_AddLess.Text) + Val(txt_FrieghtCharges.Text)
                    ...
                    For i = 0 To .Rows.Count - 1
                        ...
                        If Trim(.Rows(i).Cells(1).Value) <> "" And Trim(.Rows(i).Cells(10).Value) <> "" And Val(.Rows(i).Cells(11).Value) <> 0 Then
                            ...
                            cmd.CommandText = "Insert into EntryTemp (                    Name1                ,                   Currency1            ,                       Currency2                                      ) " & _
                                              "            Values    ( '" & Trim(.Rows(i).Cells(4).Value) & "', " & (Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(11).Value) + AssVal_Frgt_Othr_Charges) & " ) "
                            cmd.ExecuteNonQuery()
    ...
    Private Sub lbl_Amount_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles lbl_Amount.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
        If Asc(e.KeyChar) = 13 Then
            txt_Description.Focus()
        End If
