Public Class Sales_Receipt
    ...
    Private Pk_Condition As String = "GTREC-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName from Sales_Receipt_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Sales_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_InvoiceNo.Text = dt1.Rows(0).Item("Sales_Receipt_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Sales_Receipt_Date").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Size_Name from Sales_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Size_Head c on a.Size_idno = c.Size_idno where a.Sales_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(2).Value = Common_Procedures.Style_IdNoToName(con, Val(dt2.Rows(i).Item("Style_IdNo").ToString))
                        ...
                        '***** GST END *****
                        dgv_Details.Rows(n).Cells(10).Value = dt2.Rows(i).Item("Item_Description").ToString
                        dgv_Details.Rows(n).Cells(11).Value = dt2.Rows(i).Item("No_Of_Rolls").ToString
                        dgv_Details.Rows(n).Cells(12).Value = Val(dt2.Rows(i).Item("Delivery_No_Of_Rolls").ToString)
                        dgv_Details.Rows(n).Cells(13).Value = Format(Val(dt2.Rows(i).Item("Delivery_Quantity").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(14).Value = Val(dt2.Rows(i).Item("Sales_Receipt_Detail_Slno").ToString)
    ...
    Private Sub Sales_Receipt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        da = New SqlClient.SqlDataAdapter("select distinct(Booked_By) from Sales_Receipt_Head order by Booked_By", con)
        da.Fill(dt6)
    ...
    Private Sub Sales_Receipt_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Sales_Receipt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Delivery_Quantity) from Sales_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Sales_Receipt_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
            If IsDBNull(Dt1.Rows(0)(0).ToString) = False Then
                If Val(Dt1.Rows(0)(0).ToString) > 0 Then
                    MessageBox.Show("Already  Delivered for this Receipt", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    Exit Sub
                End If
            End If
        End If
        ...
        Try
            ...
            cmd.CommandText = "delete from Sales_Receipt_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Sales_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "Delete from Sales_Receipt_GST_Tax_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Sales_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            new_record()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        'Try
        cmd.Connection = con
        cmd.CommandText = "select Sales_Receipt_No from Sales_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "  and Sales_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Sales_Receipt_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        da = New SqlClient.SqlDataAdapter("select Sales_Receipt_No from Sales_Receipt_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & "   and Sales_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Sales_Receipt_No", con)
        da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        cmd.Connection = con
        cmd.CommandText = "select Sales_Receipt_No from Sales_Receipt_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & "  and Sales_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Sales_Receipt_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select Sales_Receipt_No from Sales_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & "  and Sales_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Sales_Receipt_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Receipt_Head", "Sales_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Sales_Receipt_No from Sales_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Receipt_Code = '" & Trim(NewCode) & "'"
            dr = cmd.ExecuteReader
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            inpno = InputBox("Enter New Rec No.", "FOR INSERTION...")
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
            ...
            For i = 0 To dgv_Details.RowCount - 1
                ...
                If Trim(.Rows(i).Cells(1).Value) <> "" Or Val(.Rows(i).Cells(4).Value) <> 0 Then
                    ...
                    If Trim(.Rows(i).Cells(3).Value) <> "" Then
                        Sz_id = Common_Procedures.Size_NameToIdNo(con, .Rows(i).Cells(3).Value)
                        If Sz_id = 0 Then
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Receipt_Head", "Sales_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        Sty_id = Common_Procedures.Style_NameToIdNo(con, .Rows(i).Cells(2).Value, tr)
                        Sno = Sno + 1

                        nr = 0
                        cmd.CommandText = "Update Sales_Receipt_Details set Sales_Receipt_No = @RecDate , Sl_No = " & Str(Val(Sno)) & " ,  Ledger_Idno = " & Val(led_id) & ", Item_IdNo = " & Str(Val(itm_id)) & ", Unit_Idno = " & Val(unt_id) & ", Style_Idno =  " & Val(Sty_id) & ",Size_IdNo = " & Val(Sz_id) & " , Quantity =  " & Val(.Rows(i).Cells(4).Value) & ",Rate = " & Val(.Rows(i).Cells(5).Value) & " , Amount =" & Str(Val(.Rows(i).Cells(6).Value)) & " , Assessable_Value =" & Str(Val(.Rows(i).Cells(7).Value)) & "   ,HSN_Code ='" & Trim(.Rows(i).Cells(8).Value) & "',Tax_Perc = " & Str(Val(.Rows(i).Cells(9).Value)) & ", Item_Description = '" & Trim(.Rows(i).Cells(10).Value) & "' ,No_Of_Rolls = " & Val(.Rows(i).Cells(11).Value) & "   where Company_IdNo =  " & Str(Val(lbl_Company.Tag)) & " and Sales_Receipt_Code = '" & Trim(NewCode) & "' and Sales_Receipt_Detail_SlNo = " & Str(Val(.Rows(i).Cells(14).Value)) & ""
                        cmd.ExecuteNonQuery()

                        If nr = 0 Then

                            cmd.CommandText = "Insert into Sales_Receipt_Details ( Sales_Receipt_Code,            Company_IdNo          ,              Sales_Receipt_No             ,                                              for_OrderBy                   , Sales_Receipt_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo      ,         Unit_IdNo      ,     Style_IdNo    ,           Size_IdNo       ,                        Quantity                 ,                 Rate                     ,                 Amount                   ,                     Assessable_Value                 ,            HSN_Code                    , Tax_Perc                             ,    Item_Description    ,No_Of_Rolls     ) " & _
                                                    " Values ('" & Trim(NewCode) & "'                      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @RecDate               , " & Str(Val(led_id)) & ", " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & "," & Val(Sty_id) & " , " & Str(Val(Sz_id)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & " , " & Str(Val(.Rows(i).Cells(7).Value)) & ",'" & Trim(.Rows(i).Cells(8).Value) & "', " & Str(Val(.Rows(i).Cells(9).Value)) & ", '" & Trim(.Rows(i).Cells(10).Value) & "' ," & Val(.Rows(i).Cells(11).Value) & ")"
                            cmd.ExecuteNonQuery()
                        End If
                        ...
                        cmd.CommandText = "Insert into Item_Processing_Details (  Reference_Code      ,               Company_IdNo       ,            Reference_No           ,                                 for_OrderBy                                , Reference_Date,        Ledger_IdNo     ,            Party_Bill_No          ,           SL_No      ,           Item_IdNo     ,            Unit_IdNo    ,                    Quantity                               ,          Size_IdNo ) " & _
                                                " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ",    @RecDate, " & Str(Val(led_id)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & ", " & Str(-1 * Val(dgv_Details.Rows(i).Cells(4).Value)) & " ,   " & Str(Val(Sz_id)) & "  )"
                        cmd.ExecuteNonQuery()
            ...
            With dgv_GSTTax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Sales_Receipt_GST_Tax_Details   (        Sales_Receipt_Code      ,               Company_IdNo       ,                Sales_Receipt_No           ,                               for_OrderBy                                  , Sales_Receipt_Date ,         Ledger_IdNo     ,            Sl_No     ,                    HSN_Code            ,                      Taxable_Amount      ,                      CGST_Percentage     ,                      CGST_Amount         ,                      SGST_Percentage      ,                      SGST_Amount         ,                      IGST_Percentage     ,                      IGST_Amount          ) " & _
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(2).Value = cbo_Style.Text
                    .Rows(i).Cells(3).Value = (cbo_Size.Text)
                    ...
                    .Rows(i).Cells(10).Value = Trim(txt_Description.Text)
                    .Rows(i).Cells(11).Value = Val(txt_NoOFRolls.Text)
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(2).Value = cbo_Style.Text
                .Rows(n).Cells(3).Value = (cbo_Size.Text)
                ...
                .Rows(n).Cells(10).Value = Trim(txt_Description.Text)
                .Rows(n).Cells(11).Value = Trim(txt_NoOFRolls.Text)
    ...
    Private Sub cbo_BookedBy_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_BookedBy.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_BookedBy, txt_DateTime_Of_Supply, txt_Weight, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_BookedBy_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_BookedBy.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_BookedBy, txt_Weight, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_Size_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Size.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Size, cbo_Style, txt_NoofPcs, "size_head", "size_name", "", "(size_idno = 0)")
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.Sales_Receipt_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = " a.Sales_Receipt_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.Sales_Receipt_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            If Val(Itm_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Sales_Receipt_Code IN (select z.Sales_Receipt_Code from Sales_Receipt_Details z where z.Item_IdNo = " & Str(Val(Itm_IdNo)) & ") "
            End If

            da = New SqlClient.SqlDataAdapter("select a.Sales_Receipt_No, a.Sales_Receipt_Date, a.Total_Qty, a.Net_Amount, b.Ledger_Name from Sales_Receipt_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Sales_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Sales_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Sales_Receipt_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Panel2.Enabled = True And txt_SlNo.Enabled = True Then
            ...
            If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
                ...
                lbl_Grid_HsnCode.Text = dgv_Details.CurrentRow.Cells(8).Value
                lbl_Grid_GstPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(9).Value), "########0.00")
                txt_Description.Text = Trim(dgv_Details.CurrentRow.Cells(10).Value)
                txt_NoOFRolls.Text = Trim(dgv_Details.CurrentRow.Cells(11).Value)
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        If ItmIdNo <> 0 Then
                            ...
                            .Rows(i).Cells(7).Value = Format(Val(.Rows(i).Cells(6).Value), "#########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                ...
                TotNoOfRolls = TotNoOfRolls + Val(dgv_Details.Rows(i).Cells(11).Value)
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(11).Value = Format(Val(TotNoOfRolls), "########0.00")
        End With
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Unit_Name from Sales_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on b.unit_idno = c.unit_idno where a.Sales_Receipt_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        dt2 = New DataTable
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_Receipt_No").ToString, LMargin + Cen1 + W1 + 30, BlockInvNoY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Receipt_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + W2 + 30, BlockInvNoY + Yinc, 0, 0, pFont)
    ...
    Private Sub printing_invoice()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, b.Ledger_Address1, b.Ledger_Address2, b.Ledger_Address3, b.Ledger_Address4, b.Ledger_TinNo from Sales_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Sales_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* ,D.* from Sales_Receipt_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo LEFT OUTER JOIN  Transport_Head D ON A.Transport_IdNo = D.Transport_IdNo  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Receipt_Code = '" & Trim(NewCode) & "'", con)
        prn_HdDt = New DataTable
        da1.Fill(prn_HdDt)

        If prn_HdDt.Rows.Count > 0 Then

            da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Size_Name from Sales_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Size_Head c on a.size_idno = c.size_idno   where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
        ...
        If prn_HdDt.Rows.Count > 0 Then
            ...
            da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, b.Item_Name_tamil, c.Size_Name ,d.Style_Name  from Sales_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Size_Head c on a.Size_idno = c.Size_idno LEFT OUTER JOIN Style_Head D on a.Style_idno = D.Style_idno where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
            prn_DetDt = New DataTable
            da2.Fill(prn_DetDt)
            ...
            If prn_DetDt.Rows.Count > 0 Then
                ...
                For I = 0 To prn_DetDt.Rows.Count - 1
                    ...
                    prn_DetAr(prn_DetMxIndx, 5) = Val(prn_DetDt.Rows(I).Item("qUANTITY").ToString)
                    prn_DetAr(prn_DetMxIndx, 6) = Trim(prn_DetDt.Rows(I).Item("Style_Name").ToString)
                    prn_DetAr(prn_DetMxIndx, 7) = prn_DetDt.Rows(I).Item("Size_Name").ToString
...
LOOP1:
    ...
    Public Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Size_Name from Sales_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Size_Head c on a.size_idno = c.size_idno where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Receipt_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        da2.Fill(dt2)
        If dt2.Rows.Count > NoofItems_PerPage Then
            Common_Procedures.Print_To_PrintDocument(e, "Page : " & Trim(Val(PageNo)), PageWidth - 10, CurY - TxtHgt, 1, 0, pFont)
        End If
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_Receipt_No").ToString, LMargin + Cen1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Receipt_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + W2 + 30, CurY + Yinc, 0, 0, pFont)
    ...
    Private Sub Printing_GST_HSN_Details_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByRef CurY As Single, ByVal LMargin As Integer, ByVal PageWidth As Integer, ByVal PrintWidth As Double, ByVal LnAr As Single)
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("Select * from Sales_Receipt_GST_Tax_Details Where Sales_Receipt_Code = '" & Trim(EntryCode) & "'", con)
            Dt = New DataTable
            Da.Fill(Dt)
                    ...
                    If prn_DetMxIndx > 0 Then
                        ...
                        Do While DetIndx <= prn_DetMxIndx
                            ...
                            Else
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 7), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + 10, CurY, 0, 0, pFont)
...
1:
    ...
    Private Sub cbo_VehicleNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_VehicleNo.GotFocus
        With cbo_Style
            '  vcmb_SizNm = Trim(.Text)
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Sales_Receipt_Head", "Vehicle_No", "", "")
        End With
    ...
    Private Sub cbo_VehicleNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_VehicleNo.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_VehicleNo, txt_Electronic_RefNo, txt_LrNo, "Sales_Receipt_Head", "Vehicle_No", "", "")
    End Sub
    ...
    Private Sub cbo_VehicleNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_VehicleNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_VehicleNo, txt_LrNo, "Sales_Receipt_Head", "Vehicle_No", "", "", False)
    End Sub
