Public Class Invoice_Garments3_GST
    ...
    Private Pk_Condition As String = "GING3-"
    ...
    Dim myColor As Color = Color.FromArgb(9, 22, 102)
    Dim BrushColor_ALPHA As Brush
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_placeofsupply.Text = Trim(dt1.Rows(0).Item("Place_Of_Supply").ToString)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(2).Value = Val(dt2.Rows(i).Item("Noof_Items").ToString)
                        dgv_Details.Rows(n).Cells(3).Value = Format(Val(dt2.Rows(i).Item("Rate").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Amount").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("Cash_Discount_Perc_For_All_Item").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("Cash_Discount_Amount_For_All_Item").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("Assessable_Value").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(8).Value = dt2.Rows(i).Item("HSN_Code").ToString
    ...
    Private Sub Invoice_Garments_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1217" Then ' alpha traders
            txt_placeofsupply.Visible = True
            cbo_Destination.Visible = False
            lbl_destination_caption.Text = "Place of Supply"
        End If
        lbl_Company.Text = ""
        lbl_Company.Tag = 0
        ...
        BrushColor_ALPHA = myBrush
        vLine_Pen = New Pen(Color.FromArgb(9, 22, 102))
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If dgv_Details_Total.RowCount > 0 Then
            vTot_Qty = Val(dgv_Details_Total.Rows(0).Cells(2).Value())
        End If
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Val(dgv_Details.Rows(i).Cells(2).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Sales_Details ( Sales_Code,            Company_IdNo          ,              Sales_No             ,                                              for_OrderBy                   , Sales_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo      ,          Unit_IdNo      ,                 Noof_Items ,   Rate                     ,                 Amount                   ,                    Total_Amount                                      ,    Cash_Discount_Perc_For_All_Item    ,       Cash_Discount_Amount_For_All_Item  ,              Assessable_Value            ,                      HSN_Code           ,                      Tax_Perc             ) " & _
                        ...
                        cmd.CommandText = "Insert into Item_Processing_Details (  Reference_Code      ,               Company_IdNo       ,            Reference_No           ,                                 for_OrderBy                                , Reference_Date,        Ledger_IdNo     ,            Party_Bill_No          ,           SL_No      ,           Item_IdNo     ,            Unit_IdNo    ,                    Quantity                                 ) " & _
                                                " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ",    @SalesDate, " & Str(Val(led_id)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & ", " & Str(-1 * Val(dgv_Details.Rows(i).Cells(2).Value)) & "   )"
                        cmd.ExecuteNonQuery()
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(2).Value = Val(txt_Pcs.Text)
                    .Rows(i).Cells(3).Value = Format(Val(txt_Rate.Text), "########0.00")
                    .Rows(i).Cells(4).Value = Format(Val(lbl_Amount.Text), "########0.00")

                    .Rows(i).Cells(5).Value = Format(Val(lbl_Grid_DiscPerc.Text), "########0.00")
                    .Rows(i).Cells(6).Value = Format(Val(lbl_Grid_DiscAmount.Text), "########0.00")

                    .Rows(i).Cells(7).Value = Format(Val(lbl_Grid_AssessableValue.Text), "########0.00")

                    .Rows(i).Cells(8).Value = lbl_Grid_HsnCode.Text
                    .Rows(i).Cells(9).Value = Format(Val(lbl_Grid_GstPerc.Text), "########0.00")
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(2).Value = Val(txt_Pcs.Text)
                .Rows(n).Cells(3).Value = Format(Val(txt_Rate.Text), "########0.00")
                .Rows(n).Cells(4).Value = Format(Val(lbl_Amount.Text), "########0.00")
                .Rows(n).Cells(5).Value = Format(Val(lbl_Grid_DiscPerc.Text), "########0.00")
                .Rows(n).Cells(6).Value = Format(Val(lbl_Grid_DiscAmount.Text), "########0.00")

                .Rows(n).Cells(7).Value = Format(Val(lbl_Grid_AssessableValue.Text), "########0.00")

                .Rows(n).Cells(8).Value = lbl_Grid_HsnCode.Text
                .Rows(n).Cells(9).Value = Format(Val(lbl_Grid_GstPerc.Text), "########0.00")
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        txt_Pcs.Text = Val(.Rows(i).Cells(2).Value)
                        txt_Rate.Text = Format(Val(.Rows(i).Cells(3).Value), "########0.00")
                        lbl_Amount.Text = Format(Val(.Rows(i).Cells(4).Value), "########0.00")
                        lbl_Grid_DiscPerc.Text = Format(Val(.Rows(i).Cells(5).Value), "########0.00")
                        lbl_Grid_DiscAmount.Text = Format(Val(.Rows(i).Cells(6).Value), "########0.00")

                        lbl_Grid_AssessableValue.Text = Format(Val(.Rows(i).Cells(7).Value), "########0.00")
                        lbl_Grid_HsnCode.Text = Trim(.Rows(i).Cells(8).Value)
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
            ...
            txt_Pcs.Text = Val(dgv_Details.CurrentRow.Cells(2).Value)
            txt_Rate.Text = Format(Val(dgv_Details.CurrentRow.Cells(3).Value), "########0.00")
            lbl_Amount.Text = Format(Val(dgv_Details.CurrentRow.Cells(4).Value), "########0.00")
            lbl_Grid_DiscPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(5).Value), "########0.00")
            lbl_Grid_DiscAmount.Text = Format(Val(dgv_Details.CurrentRow.Cells(6).Value), "########0.00")

            lbl_Grid_AssessableValue.Text = Format(Val(dgv_Details.CurrentRow.Cells(7).Value), "########0.00")
            lbl_Grid_HsnCode.Text = Trim(dgv_Details.CurrentRow.Cells(8).Value)
            lbl_Grid_GstPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(9).Value), "########0.00")
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If Trim(.Rows(I).Cells(1).Value) <> "" Or Val(.Rows(I).Cells(2).Value) <> 0 Then
                    ...
                    TotQty = TotQty + Val(dgv_Details.Rows(I).Cells(2).Value)
                    TotAmt = TotAmt + Val(dgv_Details.Rows(I).Cells(4).Value)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        'If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1070" Then
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1217" Then
            Printing_Format7Gst(e)
        Else
            Printing_Format6Gst(e)
        End If
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        '    If ps.Width = 850 And ps.Height = 1100 Then
        '        PrintDocument1.DefaultPageSettings.PaperSize = ps
        ...
        '    Dim pkCustomSize1 As New System.Drawing.Printing.PaperSize("PAPER 8.5X11", 850, 1100)
        '    PrintDocument1.PrinterSettings.DefaultPageSettings.PaperSize = pkCustomSize1
        '    PrintDocument1.DefaultPageSettings.PaperSize = pkCustomSize1
        'End If
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(DetIndx).Item("Noof_Items").ToString), LMargin + 500, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Rate").ToString), "########0.00"), LMargin + 610, CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer)
        ...
        Try
            ...
            '    Indx = Indx + 1
            '    LedAr(Indx) = Trim(Led_TinNo)
            'End If
            p1Font = New Font("Calibri", 14, FontStyle.Bold)
            CurY = TMargin + 240  ' 130
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_No").ToString, LMargin + 580, CurY, 0, 0, p1Font)
            ...
            CurY = TMargin + 290
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Date").ToString), "dd-MM-yyyy"), LMargin + 580, CurY, 0, 0, pFont)
            ...
            CurY = TMargin + 225  ' 110
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "M/s. " & LedAr(1), LMargin + 70, CurY, 0, 0, p1Font)
            ...
            CurY = CurY + TxtHgt - 1
            'CurY = TMargin + 225
            Common_Procedures.Print_To_PrintDocument(e, Led_TinNo, LMargin + 60, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Led_TinNo, LMargin + 350, CurY, 0, 0, pFont)
            ...
            CurY = TMargin + 350
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Order_No").ToString, LMargin + 120, CurY, 0, 0, pFont)
            Trans_Nm = Common_Procedures.Transport_IdNoToName(con, Val(prn_HdDt.Rows(0).Item("Transport_IdNo").ToString))
            Common_Procedures.Print_To_PrintDocument(e, Trans_Nm, LMargin + 340, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Lr_No").ToString, LMargin + 620, CurY, 0, 0, pFont)

            CurY = TMargin + 375 ' 228
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Order_Date").ToString, LMargin + 120, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Despatch_To").ToString, LMargin + 340, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Lr_Date").ToString, LMargin + 620, CurY, 0, 0, pFont)

            CurY = TMargin + 410 ' 259
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Document_Through").ToString, LMargin + 130, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Total_Bags").ToString, LMargin + 620, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format1_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal PageHeight As Single, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If is_LastPage = True Then
                CurY = TMargin + 730
                e.Graphics.DrawLine(Pens.Black, LMargin + 640, CurY, LMargin + 780, CurY)
                If is_LastPage = True Then
                    Erase BnkDetAr
                    If Trim(prn_HdDt.Rows(0).Item("Company_Bank_Ac_Details").ToString) <> "" Then
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, "OUR BANK", LMargin + 80, Yax, 0, 0, p1Font)
                        ...
                        If UBound(BnkDetAr) >= BInc Then
                            Yax = Yax + TxtHgt
                            Common_Procedures.Print_To_PrintDocument(e, Trim(BnkDetAr(BInc)), LMargin + 80, Yax, 0, 0, p1Font)
                        End If
                ...
                If Val(prn_HdDt.Rows(0).Item("Tax_Amount").ToString) <> 0 Then
                    If is_LastPage = True Then
                        Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Tax_Type").ToString) & " @ " & Trim(Val(prn_HdDt.Rows(0).Item("Tax_Perc").ToString)) & " %", LMargin + 420, CurY, 1, 0, pFont)
                ...
                If is_LastPage = True Then
                    If Val(prn_HdDt.Rows(0).Item("Freight_Amount").ToString) <> 0 Then
                        CurY = CurY + TxtHgt
                        Common_Procedures.Print_To_PrintDocument(e, "Freight", LMargin + 420, CurY, 1, 0, pFont)
                ...
                If is_LastPage = True Then
                    If Val(prn_HdDt.Rows(0).Item("Round_Off").ToString) <> 0 Then
                        CurY = CurY + TxtHgt
                        Common_Procedures.Print_To_PrintDocument(e, "Round Off", LMargin + 420, CurY, 1, 0, pFont)
                ...
                Common_Procedures.Print_To_PrintDocument(e, Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString), LMargin + 500, CurY, 1, 0, pFont)
                ...
                CurY = TMargin + 915
                Common_Procedures.Print_To_PrintDocument(e, Rup1, LMargin + 100, CurY, 0, 0, pFont)
                ...
                CurY = TMargin + 870 ' 975
                p1Font = New Font("Calibri", 13, FontStyle.Bold)

                Common_Procedures.Print_To_PrintDocument(e, (prn_HdDt.Rows(0).Item("Payment_Terms").ToString), LMargin + 60, CurY, 0, 0, pFont)
                CurY = TMargin + 850
    ...
    Private Sub cbo_Agent_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Agent.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Agent, txt_Weight, cbo_TransportMode, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'AGENT')", "(Ledger_IdNo = 0)")
    ...
    Private Sub cbo_Agent_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Agent.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Agent, cbo_TransportMode, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = 'AGENT')", "(Ledger_IdNo = 0)")
        'If Asc(e.KeyChar) = 13 Then
    ...
    Private Sub txt_PaymentTerms_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_PaymentTerms.KeyPress
        ...
        End If
    End Sub
    Private Sub Printing_Format55(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim EntryCode As String
        Dim I As Integer, NoofDets As Integer, NoofItems_PerPage As Integer
    ...
    Private Sub Printing_Format5(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(0) = 0
        ClArr(1) = 45
        ClArr(2) = 305 : ClArr(3) = 120 : ClArr(4) = 150
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Rate").ToString), "########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 10, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Amount").ToString), "########0.00"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 10, CurY, 1, 0, pFont)
...
LOOP1:
    ...
    Private Sub Printing_Format5_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            Else
                Common_Procedures.Print_To_PrintDocument(e, "Order No", LMargin + Cen1 + 10, CurY + 15, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY + 15, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("order_No").ToString, LMargin + Cen1 + W1 + 30, CurY + 15, 0, 0, pFont)
            ...
            If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1062" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) <> "2002" Then
                Common_Procedures.Print_To_PrintDocument(e, "Order Date", LMargin + Cen1 + 10, CurY + 25, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY + 25, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Order_Date").ToString, LMargin + Cen1 + W1 + 30, CurY + 25, 0, 0, pFont)
            End If
    ...
    Private Sub Printing_Format5_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            If Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString) <> 0 Then
                CurY = CurY + TxtHgt
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "Cash Discount @ " & Trim(Val(prn_HdDt.Rows(0).Item("CashDiscount_Perc").ToString)) & "%", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
                End If
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Tax_Amount").ToString) <> 0 Then
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "VAT @ " & Trim(Val(prn_HdDt.Rows(0).Item("Tax_Perc").ToString)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Tax_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
                End If
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Freight_Amount").ToString) <> 0 Then
                CurY = CurY + TxtHgt + 5
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "Freight Charge", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 5, CurY, 1, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Freight_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
                End If
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    ...
                    If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) > 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "Add", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "Less", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 10, CurY, 1, 0, pFont)
                    End If
                    Common_Procedures.Print_To_PrintDocument(e, Format(Math.Abs(Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString)), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
            ...
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "For " & Cmp_Name, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Authorised Signatory", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
    ...
    Private Sub cbo_TransportMode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TransportMode.KeyDown
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TransportMode, cbo_Agent, txt_DateTime_Of_Supply, "", "", "", "")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
        End Try
    End Sub
                        ...
                        If ItmIdNo <> 0 Then
                            ...
                            If Trim(UCase(cbo_TaxType.Text)) = "GST" Then
                                ...
                                If dt.Rows.Count > 0 Then
                                    ...
                                    If IsDBNull(dt.Rows(0)("Item_HSN_Code").ToString) = False Then
                                        .Rows(i).Cells(8).Value = dt.Rows(0)("Item_HSN_Code").ToString
                                    End If
                                    If IsDBNull(dt.Rows(0)("Item_GST_Percentage").ToString) = False Then
                                        .Rows(i).Cells(9).Value = Format(Val(dt.Rows(0)("Item_GST_Percentage").ToString), "#########0.00")
                                    End If
                            ...
                            .Rows(i).Cells(4).Value = Format(Val(.Rows(i).Cells(2).Value) * Val(.Rows(i).Cells(3).Value), "#########0.00")
                            .Rows(i).Cells(5).Value = Format(Val(txt_CashDiscPerc.Text), "#########0.00")
                            .Rows(i).Cells(6).Value = Format(Val(.Rows(i).Cells(4).Value) * Val(.Rows(i).Cells(5).Value) / 100, "#########0.00")
                            .Rows(i).Cells(7).Value = Format(Val(.Rows(i).Cells(4).Value) - Val(.Rows(i).Cells(6).Value), "#########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(2).Value) <> 0 Then
                TotQty = TotQty + Val(dgv_Details.Rows(i).Cells(2).Value)
                TotGrsAmt = TotGrsAmt + Val(dgv_Details.Rows(i).Cells(4).Value)


                TotDiscAmt = TotDiscAmt + Val(dgv_Details.Rows(i).Cells(6).Value)
                TotAssval = TotAssval + Val(dgv_Details.Rows(i).Cells(7).Value)
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(2).Value = Val(TotQty)
            .Rows(0).Cells(4).Value = Format(Val(TotGrsAmt), "########0.00")

            .Rows(0).Cells(6).Value = Format(Val(TotDiscAmt), "########0.00")
            .Rows(0).Cells(7).Value = Format(Val(TotAssval), "########0.00")
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(txt_GrossAmount.Text) - Val(txt_CashDiscAmount.Text) + Val(lbl_VatAmount.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text) + Val(txt_Freight.Text) + Val(txt_AddLess.Text)
                    ...
                    For i = 0 To .Rows.Count - 1
                        ...
                        If Trim(.Rows(i).Cells(1).Value) <> "" And Trim(.Rows(i).Cells(8).Value) <> "" And Val(.Rows(i).Cells(9).Value) <> 0 Then
                            ...
                            cmd.CommandText = "Insert into EntryTemp (                    Name1                ,                   Currency1            ,                       Currency2                                      ) " & _
                                              "            Values    ( '" & Trim(.Rows(i).Cells(8).Value) & "', " & (Val(.Rows(i).Cells(9).Value)) & ", " & Str(Val(.Rows(i).Cells(7).Value) + AssVal_Frgt_Othr_Charges) & " ) "
                            cmd.ExecuteNonQuery()
    ...
    End Function
    Private Sub Printing_Format6Gst(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim EntryCode As String
        Dim I As Integer, NoofDets As Integer, NoofItems_PerPage As Integer
        Dim pFont As Font
        Dim LMargin As Single, RMargin As Single, TMargin As Single, BMargin As Single
        ...
        ClArr(0) = 0
        ClArr(1) = Val(35)
        ClArr(2) = 280 : ClArr(3) = 90 : ClArr(4) = 55 : ClArr(5) = 85 : ClArr(6) = 85
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_Format6Gst_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            If NoofDets > NoofItems_PerPage Then
                                ...
                                Printing_Format6Gst_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, Cmp_Name, NoofDets, False)
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(DetIndx).Item("Tax_Perc").ToString & "%", LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 5, CurY, 1, 0, pFont)

                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(DetIndx).Item("Noof_Items").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 10, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(DetIndx).Item("Rate").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) - 10, CurY, 1, 0, pFont)
                    ...
                    Printing_Format6Gst_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, Cmp_Name, NoofDets, True)
    ...
    Private Sub Printing_Format6Gst_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        Dim Cmp_Name As String, Cmp_Add1 As String, Cmp_Add2 As String
        ...
        Try
            ...
            Cen1 = ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 30
            W1 = e.Graphics.MeasureString("INVOICE DATE  :", pFont).Width
            W2 = e.Graphics.MeasureString("TO :", pFont).Width
            ...
            Common_Procedures.Print_To_PrintDocument(e, "VALUE", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 2, ClAr(7), pFont)
    ...
    Private Sub Printing_Format6Gst_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        Dim p1Font As Font
        Dim Rup1 As String, Rup2 As String
        Dim I As Integer
        ...
        Try
            ...
            If Val(prn_HdDt.Rows(0).Item("Freight_Amount").ToString) <> 0 Then
                CurY = CurY + TxtHgt
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "Freight Charge", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) - 10, CurY, 1, 0, pFont)
            ...
            If Val(prn_HdDt.Rows(0).Item("CGst_Amount").ToString) <> 0 Or Val(prn_HdDt.Rows(0).Item("SGst_Amount").ToString) <> 0 Or Val(prn_HdDt.Rows(0).Item("IGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    ...
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Assessable_Value").ToString), "########0.00"), PageWidth - 10, CurY, 1, 0, p1Font)
                End If
            End If
            ...
            If is_LastPage = True Then
                'If vTaxPerc <> 0 Then
                '    Common_Procedures.Print_To_PrintDocument(e, "CGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
                'Else
                '    Common_Procedures.Print_To_PrintDocument(e, "CGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
                'End If
                Common_Procedures.Print_To_PrintDocument(e, "CGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
            ...
            If is_LastPage = True Then
                'If vTaxPerc <> 0 Then
                '    Common_Procedures.Print_To_PrintDocument(e, "SGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
                'Else
                '    Common_Procedures.Print_To_PrintDocument(e, "SGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
                'End If
                Common_Procedures.Print_To_PrintDocument(e, "SGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
            ...
            If is_LastPage = True Then
                'If vTaxPerc1 <> 0 Then
                '    Common_Procedures.Print_To_PrintDocument(e, "IGST @ " & Trim(Val(vTaxPerc1)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
                'Else
                '    Common_Procedures.Print_To_PrintDocument(e, "IGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
                'End If
                Common_Procedures.Print_To_PrintDocument(e, "IGST @ " & Trim(Val(vTaxPerc1)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format7Gst(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(0) = 0
        ClArr(1) = Val(35)
        ClArr(2) = 70 : ClArr(3) = 380 : ClArr(4) = 70 : ClArr(5) = 70
        ClArr(6) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5))
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            If NoofDets > NoofItems_PerPage Then
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, "Continued....", LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) - 10, CurY, 1, 0, pFont, BrushColor_ALPHA)

                                NoofDets = NoofDets + 1

                                Printing_Format7Gst_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, Cmp_Name, NoofDets, False)
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Trim(Val(DetSNo)), LMargin + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(DetIndx).Item("Hsn_Code").ToString, LMargin + ClArr(1) + 5, CurY, 0, 0, pFont, BrushColor_ALPHA)
                            Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm1), LMargin + ClArr(1) + ClArr(2) + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)


                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(DetIndx).Item("Noof_Items").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) - 5, CurY, 1, 0, pFont, BrushColor_ALPHA)
                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(DetIndx).Item("Rate").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) - 5, CurY, 1, 0, pFont, BrushColor_ALPHA)

                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Amount").ToString), "########0.00"), PageWidth - 5, CurY, 1, 0, pFont, BrushColor_ALPHA)
                            ...
                            If Trim(ItmNm2) <> "" Then
                                CurY = CurY + TxtHgt - 5
                                Common_Procedures.Print_To_PrintDocument(e, Trim(ItmNm2), LMargin + ClArr(1) + 30, CurY, 0, 0, pFont, BrushColor_ALPHA)
                                NoofDets = NoofDets + 1
                            End If
                    ...
                    Printing_Format7Gst_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, Cmp_Name, NoofDets, True)
    ...
    Private Sub Printing_Format7Gst_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Dim strHeight As Single
        Dim Led_Name As String, Led_Add1 As String, Led_Add2 As String, Led_Add3 As String, Led_Add4 As String, Led_TinNo As String
        Dim Led_GSTTinNo As String, Led_State As String, Led_StateCode As String
        Dim PnAr() As String
        Dim LedNmAr(10) As String
        Dim Cmp_Desc As String, Cmp_Email As String
        Dim Cen1 As Single = 0
        ...
        CurY = CurY + TxtHgt - 10
        p1Font = New Font("Calibri", 10, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, "GSTIN : " & Cmp_GSTIN_No, LMargin + 10, CurY, 0, 0, p1Font, BrushColor_ALPHA)
        p1Font = New Font("Calibri", 15, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, "TAX INVOICE", PageWidth - 5, CurY - 5, 1, 0, p1Font, BrushColor_ALPHA)

        CurY = CurY + 3
        p1Font = New Font("Times new roman", 30, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, Cmp_Name, LMargin, CurY, 2, PrintWidth, p1Font, BrushColor_ALPHA)
        strHeight = e.Graphics.MeasureString(Cmp_Name, p1Font).Height

        CurY = CurY + TxtHgt
        p1Font = New Font("Calibri", 10, FontStyle.Bold)
        Common_Procedures.Print_To_PrintDocument(e, "Cell : " & Trim(Cmp_PhNo), PageWidth - 5, CurY, 1, 0, p1Font, BrushColor_ALPHA)

        p1Font = New Font("Times new roman", 10, FontStyle.Bold)
        CurY = CurY + strHeight - TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, Cmp_Add1, LMargin, CurY, 2, PrintWidth, p1Font, BrushColor_ALPHA)

        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, Cmp_Add2, LMargin, CurY, 2, PrintWidth, p1Font, BrushColor_ALPHA)

        CurY = CurY + TxtHgt
        Common_Procedures.Print_To_PrintDocument(e, "State : " & StrConv(Cmp_StateNm, VbStrConv.ProperCase) & ", State Code : " & Cmp_StateCode, LMargin, CurY, 2, PrintWidth, p1Font, BrushColor_ALPHA)
        ...
        Try
            ...
            Led_Name = "" : Led_Add1 = "" : Led_Add2 = "" : Led_Add3 = "" : Led_Add4 = "" : Led_TinNo = "" : Led_PhNo = "" : Led_GSTTinNo = "" : Led_State = "" : Led_StateCode = ""
            ...
            Else
                ...
                Led_State = Trim(prn_HdDt.Rows(0).Item("Ledger_State_Name").ToString)
                Led_StateCode = Trim(prn_HdDt.Rows(0).Item("Ledger_State_Code").ToString)
                If Trim(prn_HdDt.Rows(0).Item("Ledger_GSTinNo").ToString) <> "" Then Led_GSTTinNo = Trim(prn_HdDt.Rows(0).Item("Ledger_GSTinNo").ToString)
            ...
            W1 = e.Graphics.MeasureString("INVOICE DATE  :", pFont).Width
            W2 = e.Graphics.MeasureString("Date & Time Supply  ", pFont).Width

            CurY = CurY + TxtHgt - 10
            p1Font = New Font("Calibri", 14, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Tax is Payable on Reverse on Charge : Yes/No ", LMargin + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)


            Trans_Nm = Common_Procedures.Transport_IdNoToName(con, Val(prn_HdDt.Rows(0).Item("Transport_IdNo").ToString))
            Common_Procedures.Print_To_PrintDocument(e, "Transport Name", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W2 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trans_Nm, LMargin + Cen1 + W2 + 30, CurY, 0, 0, pFont, BrushColor_ALPHA)

            CurY = CurY + TxtHgt
            p1Font = New Font("Calibri", 16, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Invoice No.", LMargin + 10, CurY + 3, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY + 3, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_No").ToString, LMargin + W1 + 30, CurY - 2, 0, 0, p1Font, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "Transport Mode", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W2 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Transportation_Mode").ToString, LMargin + Cen1 + W2 + 30, CurY, 0, 0, pFont, BrushColor_ALPHA)

            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "Invoice Date", LMargin + 10, CurY + 8, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY + 8, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Date").ToString), "dd-MM-yyyy"), LMargin + W1 + 30, CurY + 8, 0, 0, pFont, BrushColor_ALPHA)



            Common_Procedures.Print_To_PrintDocument(e, "Date & Time Supply", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W2 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Date_Time_Of_Supply").ToString, LMargin + Cen1 + W2 + 30, CurY, 0, 0, pFont, BrushColor_ALPHA)

            CurY = CurY + TxtHgt
            
            Common_Procedures.Print_To_PrintDocument(e, "Place of Supply", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W2 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Place_Of_Supply").ToString, LMargin + Cen1 + W2 + 30, CurY, 0, 0, pFont, BrushColor_ALPHA)
            ...
            W1 = 0 : W2 = 0
            W1 = e.Graphics.MeasureString("State Code  ", pFont).Width
            W2 = e.Graphics.MeasureString("Date & Time Supply  ", pFont).Width

            CurY = CurY + TxtHgt - 13
            p1Font = New Font("Calibri", 11, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Details of Receiver (Billed to)", LMargin, CurY, 2, LMargin + Cen1, p1Font, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, "Details of Consignee (Shipped to)", LMargin + Cen1, CurY, 2, LMargin + Cen1, p1Font, BrushColor_ALPHA)
            ...
            p1Font = New Font("Calibri", 11, FontStyle.Bold)
            CurY = CurY + TxtHgt - 10
            Common_Procedures.Print_To_PrintDocument(e, "Name", LMargin + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_Name), LMargin + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "Name", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_Name), LMargin + Cen1 + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "Address", LMargin + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_Add1), LMargin + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "Address", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_Add1), LMargin + Cen1 + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)
            CurY = CurY + TxtHgt
            ' Common_Procedures.Print_To_PrintDocument(e, "", LMargin + 10, CurY, 0, 0, pFont)
            ' Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_Add2), LMargin + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            ' Common_Procedures.Print_To_PrintDocument(e, "", LMargin + Cen1 + 10, CurY, 0, 0, pFont)
            ' Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_Add2), LMargin + Cen1 + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            CurY = CurY + TxtHgt
            ' Common_Procedures.Print_To_PrintDocument(e, "", LMargin + 10, CurY, 0, 0, pFont)
            '   Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_Add3), LMargin + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            '  Common_Procedures.Print_To_PrintDocument(e, "", LMargin + Cen1 + 10, CurY, 0, 0, pFont)
            '  Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_Add3), LMargin + Cen1 + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)


            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "State", LMargin + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_State), LMargin + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "State", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_State), LMargin + Cen1 + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "State Code", LMargin + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_StateCode), LMargin + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "State Code", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_StateCode), LMargin + Cen1 + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "GSTIN No.", LMargin + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_GSTTinNo), LMargin + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "GSTIN No.", LMargin + Cen1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, Trim(Led_GSTTinNo), LMargin + Cen1 + W1 + 20, CurY, 0, 0, pFont, BrushColor_ALPHA)

            '***** GST END *****

            CurY = CurY + TxtHgt
            e.Graphics.DrawLine(vLine_Pen, LMargin + Cen1, CurY, LMargin + Cen1, LnAr(2))
            e.Graphics.DrawLine(vLine_Pen, LMargin, CurY, PageWidth, CurY)
            LnAr(3) = CurY

            CurY = CurY + TxtHgt - 10
            Common_Procedures.Print_To_PrintDocument(e, "S.NO", LMargin, CurY, 2, ClAr(1), pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "HSN", LMargin + ClAr(1), CurY - 5, 2, ClAr(2), pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, "Code", LMargin + ClAr(1), CurY + 10, 2, ClAr(2), pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "Description", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "Quantity", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY - 5, 2, ClAr(4), pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, "Pcs", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY + 10, 2, ClAr(4), pFont, BrushColor_ALPHA)

            Common_Procedures.Print_To_PrintDocument(e, "Rate", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY, 2, ClAr(5), pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, "Amount", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 2, ClAr(6), pFont, BrushColor_ALPHA)
    ...
    Private Sub Printing_Format7Gst_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            e.Graphics.DrawLine(vLine_Pen, LMargin, LnAr(5), LMargin, LnAr(3))
            e.Graphics.DrawLine(vLine_Pen, LMargin + ClAr(1), LnAr(5), LMargin + ClAr(1), LnAr(3))
            e.Graphics.DrawLine(vLine_Pen, LMargin + ClAr(1) + ClAr(2), LnAr(5), LMargin + ClAr(1) + ClAr(2), LnAr(3))
            e.Graphics.DrawLine(vLine_Pen, LMargin + ClAr(1) + ClAr(2) + ClAr(3), LnAr(5), LMargin + ClAr(1) + ClAr(2) + ClAr(3), LnAr(3))
            e.Graphics.DrawLine(vLine_Pen, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), LnAr(5), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), LnAr(3))
            e.Graphics.DrawLine(vLine_Pen, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), LnAr(5), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), LnAr(3))
            e.Graphics.DrawLine(vLine_Pen, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), LnAr(5), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), LnAr(3))

            '  e.Graphics.DrawLine(Pens.Black, PageWidth - 30, LnAr(5), PageWidth - 30, LnAr(4))
            ...
            strWidth = e.Graphics.MeasureString("Bank Details : ", pFont).Width
            strWidth1 = e.Graphics.MeasureString("Bank Account Number : ", pFont).Width

            Common_Procedures.Print_To_PrintDocument(e, "Bank Name", LMargin + strWidth + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + strWidth + strWidth1 + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, BankNm1, LMargin + strWidth + strWidth1 + 20, CurY1, 0, 0, pFont, BrushColor_ALPHA)

            CurY1 = CurY1 + TxtHgt - 3
            Common_Procedures.Print_To_PrintDocument(e, "Bank Account Number", LMargin + strWidth + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + strWidth + strWidth1 + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, BankNm2, LMargin + strWidth + strWidth1 + 20, CurY1, 0, 0, pFont, BrushColor_ALPHA)


            Common_Procedures.Print_To_PrintDocument(e, "Bank Details : ", LMargin + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)
            CurY1 = CurY1 + TxtHgt - 3
            Common_Procedures.Print_To_PrintDocument(e, "Bank Branch IFSC", LMargin + strWidth + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + strWidth + strWidth1 + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)
            Common_Procedures.Print_To_PrintDocument(e, BankNm3, LMargin + strWidth + strWidth1 + 20, CurY1, 0, 0, pFont, BrushColor_ALPHA)

            CurY1 = CurY1 + TxtHgt - 3
            Common_Procedures.Print_To_PrintDocument(e, BankNm4, LMargin + strWidth + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)
          
            CurY1 = CurY1 + 5
            e.Graphics.DrawLine(vLine_Pen, LMargin, CurY1, LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY1)

            CurY1 = CurY1 + TxtHgt - 15
            Common_Procedures.Print_To_PrintDocument(e, "Electronic Ref No. : " & prn_HdDt.Rows(0).Item("Electronic_Reference_No").ToString, LMargin + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)

            CurY1 = CurY1 + TxtHgt
            e.Graphics.DrawLine(vLine_Pen, LMargin, CurY1, LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY1)

            CurY1 = CurY1 + 5
            Common_Procedures.Print_To_PrintDocument(e, "Terms and Conditions : ", LMargin + 10, CurY1, 0, 0, pFont, BrushColor_ALPHA)

            p1Font = New Font("Calibri", 9, FontStyle.Regular)
            CurY1 = CurY1 + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "1. Goods once sold cannot be tacken back.", LMargin + 10, CurY1, 0, 0, p1Font, BrushColor_ALPHA)
            CurY1 = CurY1 + TxtHgt - 3
            Common_Procedures.Print_To_PrintDocument(e, "2. Interest at 18% will be charge for payment after stipulated time.", LMargin + 10, CurY1, 0, 0, p1Font, BrushColor_ALPHA)
            CurY1 = CurY1 + TxtHgt - 3
            Common_Procedures.Print_To_PrintDocument(e, "3. Our responsibility ceases when goods leave our godown.", LMargin + 10, CurY1, 0, 0, p1Font, BrushColor_ALPHA)
            CurY1 = CurY1 + TxtHgt - 3
            Common_Procedures.Print_To_PrintDocument(e, "4. Subject to Tirupur Juristiction.", LMargin + 10, CurY1, 0, 0, p1Font, BrushColor_ALPHA)
            ...
            '    CurY = CurY + TxtHgt
            '    If is_LastPage = True Then
            '        Common_Procedures.Print_To_PrintDocument(e, "Freight Charge", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 10, CurY, 1, 0, pFont)
            '        Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Freight_Amount").ToString), "########0.00"), PageWidth - 10, CurY, 1, 0, pFont)
            '    End If
            'End If
            ...
            If Val(prn_HdDt.Rows(0).Item("CGst_Amount").ToString) <> 0 Or Val(prn_HdDt.Rows(0).Item("SGst_Amount").ToString) <> 0 Or Val(prn_HdDt.Rows(0).Item("IGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    p1Font = New Font("Calibri", 10, FontStyle.Bold)
                    Common_Procedures.Print_To_PrintDocument(e, "Taxable Value", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + 10, CurY, 0, 0, p1Font, BrushColor_ALPHA)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Assessable_Value").ToString), "########0.00"), PageWidth - 10, CurY, 1, 0, p1Font, BrushColor_ALPHA)
                End If
            End If

            CurY = CurY + TxtHgt
            e.Graphics.DrawLine(vLine_Pen, LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY, PageWidth, CurY)

            CurY = CurY + TxtHgt - 12
            If is_LastPage = True Then

                Common_Procedures.Print_To_PrintDocument(e, "CGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("CGst_Amount").ToString), "########0.00"), PageWidth - 10, CurY, 1, 0, pFont, BrushColor_ALPHA)
            End If
            ...
            If is_LastPage = True Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, "SGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("SGst_Amount").ToString), "########0.00"), PageWidth - 10, CurY, 1, 0, pFont, BrushColor_ALPHA)
            End If
            ...
            If is_LastPage = True Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, "IGST @ " & Trim(Val(vTaxPerc1)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("IGst_Amount").ToString), "########0.00"), PageWidth - 10, CurY, 1, 0, pFont, BrushColor_ALPHA)
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Round_Off").ToString) <> 0 Then
                If is_LastPage = True Then
                    Common_Procedures.Print_To_PrintDocument(e, "Round Off", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + 10, CurY, 0, 0, pFont, BrushColor_ALPHA)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Round_Off").ToString), "########0.00"), PageWidth - 10, CurY, 1, 0, pFont, BrushColor_ALPHA)
                End If
            End If
            ...
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Total Value", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + 10, CurY, 0, 0, p1Font, BrushColor_ALPHA)
            If is_LastPage = True Then
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Common_Procedures.Currency_Format(Val(prn_HdDt.Rows(0).Item("Net_Amount").ToString)), PageWidth - 10, CurY, 1, 0, p1Font, BrushColor_ALPHA)
            End If
            ...
            e.Graphics.DrawLine(vLine_Pen, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), LnAr(6), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), LnAr(5))
            ...
            CurY = CurY + TxtHgt - 12
            p1Font = New Font("Calibri", 10, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Rupees : " & Rup1, LMargin + 10, CurY, 0, 0, p1Font, BrushColor_ALPHA)

            If Trim(Rup2) <> "" Then
                CurY = CurY + TxtHgt - 5
                Common_Procedures.Print_To_PrintDocument(e, "                                " & Rup2, LMargin + 10, CurY, 0, 0, p1Font, BrushColor_ALPHA)
            End If
            ...
            Common_Procedures.Print_To_PrintDocument(e, "For " & Cmp_Name, PageWidth - 20, CurY, 1, 0, p1Font, BrushColor_ALPHA)
            ...
            CurY = CurY + TxtHgt
            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "Authorised Signatory", PageWidth - 10, CurY, 1, 0, pFont, BrushColor_ALPHA)
