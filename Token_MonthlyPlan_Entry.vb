Public Class Token_MonthlyPlan_Entry
    ...
    Private Pk_Condition As String = "GMNTH-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName, B.* from Token_Monthly_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Token_Monthly_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_InvoiceNo.Text = dt1.Rows(0).Item("Token_Monthly_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Token_Monthly_Date").ToString
                ...
                If Val(dt1.Rows(0).Item("Ledger_Idno").ToString) = 0 Then
                    ...
                    txt_MobileNo.Text = Trim(dt1.Rows(0).Item("Party_MobileNo").ToString)
                ...
                Else
                    ...
                    txt_MobileNo.Text = Trim(dt1.Rows(0).Item("Ledger_PhoneNo").ToString)
                ...
                msk_inTime.Text = Trim(dt1.Rows(0).Item("StartDate").ToString)
                If InStr(Trim(dt1.Rows(0).Item("EndDate").ToString), "1990") = 0 Then
                    msk_outTime.Text = Trim(dt1.Rows(0).Item("EndDate").ToString)
                End If


                dtp_InDateTime.Text = Trim(dt1.Rows(0).Item("StartDateTime").ToString)

                If InStr(Trim(dt1.Rows(0).Item("EndDateTime").ToString), "1990") = 0 Then

                    dtp_OutDateTime.Text = Trim(dt1.Rows(0).Item("EndDateTime").ToString)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Token_Monthly_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Token_Monthly_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Token_Monthly_No from Token_Monthly_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Token_Monthly_Code  like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "'  Order by for_Orderby, Token_Monthly_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select Token_Monthly_No from Token_Monthly_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Token_Monthly_Code LIKE '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "'  Order by for_Orderby, Token_Monthly_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Token_Monthly_No from Token_Monthly_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Token_Monthly_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Token_Monthly_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select Token_Monthly_No from Token_Monthly_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Token_Monthly_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Token_Monthly_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Token_Monthly_Head", "Token_Monthly_Code", "For_OrderBy", "Token_Monthly_Code LIKE '" & Trim(Pk_Condition) & "%' ", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_InvoiceNo.ForeColor = Color.Red

            da = New SqlClient.SqlDataAdapter("select  a.* from Token_Monthly_Head a  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Token_Monthly_Code like '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.Token_Monthly_No desc", con)
            da.Fill(dt2)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Token_Monthly_No from Token_Monthly_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Token_Monthly_Code = '" & Trim(NewCode) & "'"
            dr = cmd.ExecuteReader
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            inpno = InputBox("Enter New Token No.", "FOR INSERTION...")
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Token_Monthly_Head", "Token_Monthly_Code", "For_OrderBy", "Token_Monthly_Code LIKE '" & Trim(Pk_Condition) & "%'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If Trim(msk_inTime.Text) <> "/  /" And IsDate(msk_inTime.Text) = True Then
                cmd.Parameters.AddWithValue("@InDate", msk_inTime.Text)
            ...
            If Trim(msk_outTime.Text) <> "/  /" And IsDate(msk_outTime.Text) = True Then
                cmd.Parameters.AddWithValue("@OutDate", Convert.ToDateTime(msk_outTime.Text))
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Token_Monthly_Head(Token_Monthly_Code     ,             Company_IdNo         ,              Token_Monthly_No     ,                               for_OrderBy                                  , Token_Monthly_Date    ,           Vehicle_No             , Sur_Name                ,       Ledger_Idno      ,       StartDate   ,        EndDate   , StartDateTime   ,EndDateTime   ,Total_Days                     ,Party_Name                     , Party_Address1                   ,Party_Address2                   ,Party_Address3                   ,Party_Address4                   ,Party_MobileNo                   ,Rate                       ,Amount                       ,Vehicle_Type                        ,Close_Status              ) " & _
                                                      " Values ('" & Trim(NewCode) & "'  , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @TockenDate           ,'" & Trim(cbo_VehicleNo.Text) & "', '" & Trim(SurName) & "' ," & Str(Val(led_id)) & ",      @InDate      ,        @OutDate  , @InDateTime     ,@OutDateTime  ," & Val(lbl_TotalDays.Text) & ",'" & Trim(cbo_Ledger.Text) & "','" & Trim(txt_Address1.Text) & "' ,'" & Trim(txt_Address2.Text) & "','" & Trim(txt_Address3.Text) & "','" & Trim(txt_Address4.Text) & "','" & Trim(txt_MobileNo.Text) & "'," & Val(lbl_Rate.Text) & " ," & Val(txt_amount.Text) & ",'" & Trim(cbo_Vehicle_type.Text) & "'," & Str(Val(Cls_Sts)) & " )"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Token_Monthly_Head set Token_Monthly_Date = @TockenDate , StartDate = @InDate ,EndDate =@OutDate , StartDateTime =@InDateTime , EndDateTime =  @OutDateTime , Vehicle_No = '" & Trim(cbo_VehicleNo.Text) & "' ,Sur_Name = '" & Trim(SurName) & "' , Ledger_Idno =  " & Str(Val(led_id)) & " ,Total_Days = " & Val(lbl_TotalDays.Text) & ", Party_Name ='" & Trim(cbo_Ledger.Text) & "' , Party_Address1  ='" & Trim(txt_Address1.Text) & "' ,Party_Address2  ='" & Trim(txt_Address2.Text) & "' ,Party_Address3  ='" & Trim(txt_Address3.Text) & "' ,Party_Address4 ='" & Trim(txt_Address4.Text) & "' ,Party_MobileNo  ='" & Trim(txt_MobileNo.Text) & "',Rate = " & Val(lbl_Rate.Text) & " ,Amount = " & Val(txt_amount.Text) & " ,Vehicle_Type = '" & Trim(cbo_Vehicle_type.Text) & "',Close_Status = " & Str(Val(Cls_Sts)) & " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Token_Monthly_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.Token_Monthly_No, a.Token_Monthly_Date, a.Total_Days, a.Amount, b.Ledger_Name from Token_Monthly_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Token_Monthly_Code LIKE '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Token_Monthly_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Token_Monthly_No").ToString
                    ...
                    dgv_Filter_Details.Rows(n).Cells(4).Value = Val(dt2.Rows(i).Item("Total_Days").ToString)
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Token_Monthly_Head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Token_Monthly_Code = '" & Trim(NewCode) & "' ", con)
            dt1 = New DataTable
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code from Token_Monthly_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  LEFT OUTER JOIN State_Head Lsh ON b.State_Idno = Lsh.State_IdNo INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo  LEFT OUTER JOIN State_Head Csh ON c.Company_State_IdNo = csh.State_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Token_Monthly_Code = '" & Trim(NewCode) & "'", con)
...
LOOP1:
    ...
    Private Sub cbo_Vehicle_type_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Vehicle_type.KeyDown
        Try
            vcbo_KeyDwnVal = e.KeyValue
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Vehicle_type, cbo_VehicleNo, cbo_Ledger, "Token_Monthly_Head", "Vehicle_Type", "", "")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub cbo_Vehicle_type_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Vehicle_type.KeyPress
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Vehicle_type, cbo_Ledger, "Token_Monthly_Head", "Vehicle_Type", "", "", False)
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub Get_Hours()
        ...
        If Trim(msk_inTime.Text) <> "/  /" And Trim(msk_inTime.Text) <> "" Then
            ...
            If IsDate(Trim(msk_inTime.Text)) = True Then
                msk_outTime.Text = DateAdd(DateInterval.Day, 29, Convert.ToDateTime(Trim(msk_inTime.Text)))
                lbl_TotalDays.Text = DateDiff(DateInterval.Day, Convert.ToDateTime(Trim(msk_inTime.Text)), Convert.ToDateTime(Trim(msk_outTime.Text))) + 1
            End If
    ...
    Private Sub Printing_Format5_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            p1Font = New Font("Calibri", 10, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Plan No.", LMargin + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W2 + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Token_Monthly_No").ToString & " - " & Microsoft.VisualBasic.Left(Microsoft.VisualBasic.Right(Common_Procedures.FnYearCode, 5), 2), LMargin + W2 + 15, CurY, 0, 0, p1Font)
            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "Date", LMargin + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W2 + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Token_Monthly_Date").ToString), "dd-MM-yyyy"), LMargin + W2 + 15, CurY, 0, 0, p1Font)
            ...
            CurY = CurY + TxtHgt + 5
            p1Font = New Font("Calibri", 11, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Start Date", LMargin + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("StartDate").ToString), "dd-MM-yyyy hh:mm tt"), LMargin + W1 + 15, CurY, 0, 0, p1Font)

            CurY = CurY + TxtHgt + 5
            p1Font = New Font("Calibri", 11, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "End Date", LMargin + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("EndDate").ToString), "dd-MM-yyyy hh:mm tt"), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Ledger_Name").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Ledger_Name").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            Else
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Party_Name").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Ledger_Address1").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Ledger_Address1").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            Else
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Party_Address1").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)

            End If

            If Trim(prn_HdDt.Rows(0).Item("Ledger_Address2").ToString) <> "" Then
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Ledger_Address2").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            Else

                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Party_Address2").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            End If


            If Trim(prn_HdDt.Rows(0).Item("Ledger_Address3").ToString) <> "" Then
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Ledger_Address3").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            Else
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Party_Address3").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Ledger_Address4").ToString) <> "" Then
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Ledger_Address4").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            Else
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Party_Address4").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            ...
            Else
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Party_MobileNo").ToString), LMargin + W1 + 15, CurY, 0, 0, p1Font)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                If Not IsDBNull(dt1.Rows(0).Item("Close_Status").ToString) Then
                    ...
                    If Val(dt1.Rows(0).Item("Close_Status").ToString) = 0 Then
                        movno = dt1.Rows(0).Item("Token_Monthly_No").ToString
                        move_record(movno)
