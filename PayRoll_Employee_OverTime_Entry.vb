Public Class PayRoll_Employee_OverTime_Entry
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.* from Payroll_Employee_OverTime_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Timing_OverTime_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RefNo.Text = dt1.Rows(0).Item("Timing_OverTime_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Timing_OverTime_Date").ToString

                dtp_Date.Tag = dtp_Date.Text

                lbl_Day.Text = dt1.Rows(0).Item("Day_Name").ToString

                da2 = New SqlClient.SqlDataAdapter("Select a.*, b.Employee_Name from Payroll_Employee_OverTime_Details a INNER JOIN PayRoll_Employee_Head b ON a.Employee_IdNo <> 0 and a.Employee_IdNo = b.Employee_IdNo  Where a.Timing_OverTime_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            If Val(dt2.Rows(i).Item("OT_Hours").ToString) <> 0 Then
                                .Rows(n).Cells(2).Value = Format(Val(dt2.Rows(i).Item("OT_Hours").ToString), "########0.00")
                            End If
    ...
    Private Sub PayRoll_Employee_OverTime_Entry_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub PayRoll_Employee_OverTime_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub PayRoll_Employee_OverTime_Entry_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        On Error Resume Next
        con.Close()
        con.Dispose()
    ...
    Private Sub PayRoll_Employee_OverTime_Entry_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Payroll_Employee_OverTime_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
            cmd.CommandText = "delete from Payroll_Employee_OverTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Timing_OverTime_No from Payroll_Employee_OverTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Timing_OverTime_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Timing_OverTime_No from Payroll_Employee_OverTime_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Timing_OverTime_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Timing_OverTime_No from Payroll_Employee_OverTime_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Timing_OverTime_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Timing_OverTime_No from Payroll_Employee_OverTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Timing_OverTime_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Payroll_Employee_OverTime_Head", "Timing_OverTime_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Timing_OverTime_No from Payroll_Employee_OverTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "Payroll_Employee_OverTime_Head", "Timing_OverTime_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Payroll_Employee_OverTime_Head (   Timing_OverTime_Code   ,               Company_IdNo       ,           Timing_OverTime_No  ,         for_OrderBy    , Timing_OverTime_Date ,       Day_Name               ) " & _
                                  "            Values                       (   '" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(OrdBy)) & ",      @EntryDate         , '" & Trim(lbl_Day.Text) & "' ) "
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = "Update Payroll_Employee_OverTime_Head set Timing_OverTime_Date = @EntryDate,  Day_Name = '" & Trim(lbl_Day.Text) & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
                    ...
                    For i = 0 To .RowCount - 1
                        ...
                        If Val(Empe_ID) <> 0 Then
                            ...
                            If Trim(.Rows(i).Cells(2).Value) <> "" Then
                                ...
                                Ot_Int = Int(Val(.Rows(i).Cells(2).Value))

                                Ot_Dbl = Val(.Rows(i).Cells(2).Value) - Val(Ot_Int)

                                OT_Mins = Val((Ot_Int) * 60) + Val(Ot_Dbl * 100)

                                cmd.CommandText = "Insert into Payroll_Employee_OverTime_Details (         Timing_OverTime_Code                ,               Company_IdNo       ,       Timing_OverTime_No      , Timing_OverTime_Date,    for_OrderBy        ,                Sl_No     ,      Employee_IdNo       , OT_Hours                                 ,       OT_Minutes   ) " & _
                                                  "            Values                          ( '" & Trim(Pk_Condition) & Trim(NewCode) & "'  , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "',  @EntryDate         ," & Str(Val(OrdBy)) & ",     " & Str(Val(Sno)) & ", " & Str(Val(Empe_ID)) & ", " & Str(Val(.Rows(i).Cells(2).Value)) & ",  " & Str(Val(OT_Mins)) & " ) "
                                cmd.ExecuteNonQuery()
    ...
    Public Sub get_DateDetails()
        ...
        Try
            ...
            Cmd.CommandText = "select Timing_OverTime_No from Payroll_Employee_OverTime_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Timing_OverTime_Date = @EntryDate"
