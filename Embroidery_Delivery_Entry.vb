Public Class Embroidery_Delivery_Entry
    ...
    Private Pk_Condition As String = "EMDEL-"
    ...
    Private prn_TwoCopySinglepage As Integer = 2
    ...
    Dim Displaying_Saved_Qty As Boolean
    ...
    Private Sub clear()
        ...
        cbo_colour.Text = ""
        cbo_Size.Text = ""
        lbl_Grid_Order_Code.Text = ""
        lbl_Grid_OrderDate.Text = ""
        txt_Manual_DC_No.Text = ""
        ...
        Cbo_OrderCode.Enabled = True
        Cbo_OrderCode.BackColor = Color.White

        lbl_Design.Enabled = True
        lbl_Design.BackColor = Color.White
        ...
        'txt_Reason_Not_Invoicable.Enabled = False
        'txt_Reason_Not_Invoicable.Text = ""
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                lbl_DcNo.Text = dt1.Rows(0).Item("Sales_Delivery_No").ToString
                ...
                txt_Manual_DC_No.Text = dt1.Rows(0).Item("Manual_DC_No").ToString
                txt_Remarks.Text = dt1.Rows(0).Item("Remarks").ToString
                txt_NoOfBags.Text = dt1.Rows(0).Item("Total_Bags").ToString
                txt_Weight.Text = FormatNumber(dt1.Rows(0).Item("Weight").ToString, 3, TriState.False, TriState.False, TriState.False)

                If Not IsDBNull(dt1.Rows(0).Item("Vehicle_No")) Then
                    txt_VehicleNo.Text = dt1.Rows(0).Item("Vehicle_No").ToString
                End If

            End If

            da2 = New SqlClient.SqlDataAdapter(" Select a.*,O.Unit_IdNo AS Unit_No from Sales_Delivery_Details a inner join Order_Program_Head O on a.OrderCode_forSelection = o.OrderCode_forSelection " &
                                               " where a.Sales_Delivery_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
            dt2 = New DataTable
                da2.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Details.Rows(n).Cells(12).Value = dt2.Rows(i).Item("Order_code").ToString
                    dgv_Details.Rows(n).Cells(13).Value = dt2.Rows(i).Item("Order_Date").ToString
                    dgv_Details.Rows(n).Cells(14).Value = dt2.Rows(i).Item("Sales_Delivery_Detail_Slno").ToString
                    dgv_Details.Rows(n).Cells(15).Value = Val(dt2.Rows(i).Item("Receipt_Quantity").ToString)
                    dgv_Details.Rows(n).Cells("GRNNo").Value = dt2.Rows(i).Item("GRN_No").ToString
                    dgv_Details.Rows(n).Cells("ISBILLED").Value = dt2.Rows(i).Item("ISBILLED")
                    ...
                    dgv_Details.Rows(n).Cells(18).Value = dt2.Rows(i).Item("Job_No").ToString
                    dgv_Details.Rows(n).Cells(19).Value = dt2.Rows(i).Item("Party_DC_NO").ToString
                    dgv_Details.Rows(n).Cells(20).Value = Common_Procedures.Component_IdNoToName(con, dt2.Rows(i).Item("Component_IdNo"))
                    dgv_Details.Rows(n).Cells(21).Value = dt2.Rows(i).Item("Bundles").ToString
                    dgv_Details.Rows(n).Cells(22).Value = dt2.Rows(i).Item("Delivery_Purpose")

                    dgv_Details.Rows(n).Cells(23).Value = "PCS-PIECES"

                    If Not IsDBNull(dt2.Rows(i).Item("Unit_No")) Then
                        If dt2.Rows(i).Item("Unit_No") > 0 Then
                            dgv_Details.Rows(n).Cells(23).Value = Common_Procedures.Unit_IdNoToName(con, dt2.Rows(i).Item("Unit_No"))
                        End If
                    End If
            ...
            If LockSTS = True Then
                ...
                Cbo_OrderCode.Enabled = False
                Cbo_OrderCode.BackColor = Color.LightGray

                lbl_Design.Enabled = False
                lbl_Design.BackColor = Color.LightGray
    ...
    Private Sub Invoice_Garments_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
    ...
    Private Sub Invoice_Embroidery_Delivery_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        AddHandler cbo_PartyDCNo.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_DeliveryType.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_NoOfPcs.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_NoOfBags.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Weight.LostFocus, AddressOf ControlLostFocus
        AddHandler lbl_Design.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_VehicleNo.LostFocus, AddressOf ControlLostFocus
        AddHandler cbo_DeliveryType.LostFocus, AddressOf ControlLostFocus
        ...
        If Common_Procedures.settings.CustomerCode <> "1244" Then
            dgv_Details.Columns("isbilled").Visible = False
            dgv_Details.Columns("grnno").Visible = False
        Else
            dgv_Details.Columns("Column2").Width = 120
            dgv_Details.Columns("Column3").Width = 250
            dgv_Details_Total.Columns("Column17").Width = 120
            dgv_Details_Total.Columns("Column24").Width = 250
        End If
        ...
        With dgv_Details
            ...
            .Columns(18).DisplayIndex = 4
            .Columns(19).DisplayIndex = 5
            .Columns(20).DisplayIndex = 6
            .Columns(4).DisplayIndex = 7
            .Columns(3).DisplayIndex = 8
            .Columns(21).DisplayIndex = 9
            .Columns(8).DisplayIndex = 10
            .Columns(23).DisplayIndex = 11
            .Columns(22).DisplayIndex = 12

        End With

        For I As Integer = 0 To dgv_Details.ColumnCount - 1

            If dgv_Details_Total.ColumnCount <= I Then
                dgv_Details_Total.Columns.Add(dgv_Details.Columns(I).Name & "_T", dgv_Details.Columns(I).HeaderText)
            End If
        ...
        If Val(Common_Procedures.settings.CustomerCode) = 5022 Then
            Label19.Text = Label19.Text.Replace("SPC", "RVM")
        ElseIf Val(Common_Procedures.settings.CustomerCode) = 5027 Then
            Label19.Text = Label19.Text.Replace("SPC", "FWC")
        End If
    ...
    Private Sub Invoice_Garments_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Invoice_Garments_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Sales_Delivery_No from Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Sales_Delivery_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select Sales_Delivery_No from Sales_Delivery_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Sales_Delivery_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            OrdByNo = Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text)

            cmd.Connection = con
            cmd.CommandText = "select Sales_Delivery_No from Sales_Delivery_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Sales_Delivery_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select Sales_Delivery_No from Sales_Delivery_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Delivery_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Sales_Delivery_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Delivery_Head", "Sales_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vTotBndls As Single = 0
        Dim vforOrdby As Single = 0
        Dim IsBillable As String = "1"
        Dim Unit_Id As Int16 = 0
        ...
        'If Common_Procedures.UserRight_Check(Common_Procedures.UR.Sales_Delivery_Entry, New_Entry) = False Then Exit Sub
        ...
        If dgv_Details_Total.RowCount > 0 Then
            ...
            vTotBndls = Val(dgv_Details_Total.Rows(0).Cells(21).Value())
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Delivery_Head", "Sales_Delivery_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            cmd.Parameters.AddWithValue("@Sales_DeliveryDate", dtp_Date.Value.Date)

            vforOrdby = Val(Common_Procedures.OrderBy_CodeToValue(lbl_DcNo.Text))

            If New_Entry = True Then

                cmd.CommandText = "Insert into Sales_Delivery_Head (    Sales_Delivery_Code     ,       Ledger_IdNo    ,           Company_IdNo            ,       Sales_Delivery_No           ,         for_OrderBy      ,    Sales_Delivery_Date    ,       Total_Qty       ,       Gross_Amount           ,           Remarks         ,Manual_DC_No                    ,Total_Bundles                , Total_Bags                       ,  Weight                                 ,Vehicle_No                   ,User_Name) " &
                                                      " Values (  '" & Trim(NewCode) & "',     " & Str(Val(Led_ID)) & "   , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(vforOrdby)) & ",   @Sales_DeliveryDate    ," & Str(Val(vTotPcs)) & "," & Str(Val(vTotAmt)) & ",'" & Trim(txt_Remarks.Text) & "','" & txt_Manual_DC_No.Text & "', " & vTotBndls.ToString & "," & Val(txt_NoOfBags.Text).ToString & "," & Val(txt_Weight.Text).ToString & "  ,'" & txt_VehicleNo.Text & "' ,'" & Common_Procedures.User.RealName.ToString & "')"


                cmd.ExecuteNonQuery()
            Else
                cmd.CommandText = "Update Sales_Delivery_Head set  Sales_Delivery_Date = @Sales_DeliveryDate, Ledger_IdNo=" & Str(Val(Led_ID)) & " , Total_Qty=" & Str(Val(vTotPcs)) & ", Gross_Amount=" & Str(Val(vTotAmt)) & ", Remarks='" & Trim(txt_Remarks.Text) & "', Manual_DC_No = '" & txt_Manual_DC_No.Text & "',Total_Bundles  = " & vTotBndls.ToString & ", Total_Bags  = " & Val(txt_NoOfBags.Text).ToString & " ,  Weight = " & Val(txt_Weight.Text).ToString & ",Vehicle_No = '" & txt_VehicleNo.Text & "',User_Name = '" & Common_Procedures.User.RealName.ToString & "'  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " And Sales_Delivery_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(8).Value) <> 0 Then
                        ...
                        If Led_ID <> 0 Then
                            ...
                            Cmp_Id = Common_Procedures.Component_NameToIdNo(con, .Rows(i).Cells(20).Value, tr)
                            Unit_Id = Common_Procedures.Unit_NameToIdNo(con, .Rows(i).Cells(23).Value, tr)

                            If Unit_Id = 0 Then
                                Unit_Id = Common_Procedures.Unit_NameToIdNo(con, "PCS-PIECES", tr)
                            End If

                            Sno = Sno + 1

                            cmd.CommandText = "Insert into Sales_Delivery_Details ( Sales_Delivery_Code     ,       Company_IdNo                ,          Sales_Delivery_No       ,        for_OrderBy         , Sales_Delivery_Date,          Ledger_IdNo    ,        Sl_No         ,          Order_No            ,        Item_Description        ,   Colour_Idno         ,    Size_Idno           ,                  Quantity                     ,       Rate                                ,                      Amount                , Ordercode_forSelection                  ,        Order_Code                     ,                 Order_Date               ,GRN_No                                           , ISBILLED                                                      ,Job_No                                  ,   Party_DC_No                           , Component_IdNo       ,Bundles                                               , Delivery_Purpose                                       ,Unit_IdNo) " &
                                                                        " Values ('" & Trim(NewCode) & "'," & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(vforOrdby)) & ", @Sales_DeliveryDate, " & Str(Val(Led_ID)) & ", " & Str(Val(Sno)) & ", '" & Trim(.Rows(i).Cells(11).Value) & "','" & Trim(.Rows(i).Cells(2).Value) & "'," & Val(Clr_ID) & " , " & Val(Siz_ID) & "   , " & Str(Val(.Rows(i).Cells(8).Value)) & ",  " & Str(Val(.Rows(i).Cells(9).Value)) & " ," & Str(Val(.Rows(i).Cells(10).Value)) & " ,'" & Trim(.Rows(i).Cells(1).Value) & "' ,'" & Trim(.Rows(i).Cells(12).Value) & "','" & Trim(.Rows(i).Cells(13).Value) & "' ,'" & Trim(.Rows(i).Cells("GRNNo").Value) & "', " & IIf(.Rows(i).Cells("ISBILLED").Value = True, "1", "0") & ",'" & Trim(.Rows(i).Cells(18).Value) & "','" & Trim(.Rows(i).Cells(19).Value) & "'," & Cmp_Id.ToString & "," & Val(Trim(.Rows(i).Cells(21).Value)).ToString & ",'" & Trim(.Rows(i).Cells(22).Value) & "'                       ," & Unit_Id.ToString & ")"
                            cmd.ExecuteNonQuery()
            ...
            'cmd.CommandText = "Update Sales_delivery_Details Set Unit_IdNo = (Select isnull(unit_idno,0) from Order_Program_Head where OrderCode_forSelection = " &
            '                  "Sales_delivery_Details.OrderCode_forSelection where Sales_Delivery_Code = '" & NewCode & "')"
            'cmd.ExecuteNonQuery()
    ...
    Private Sub btn_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Add.Click
        ...
        If Trim(Cbo_OrderCode.Text) = "" Then
            ...
            Exit Sub
        End If
        If Trim(lbl_Design.Text) = "" Then
            MessageBox.Show("Invalid Design ", "DOES Not ADD...", MessageBoxButtons.OK)
            If lbl_Design.Enabled Then lbl_Design.Focus()
            Exit Sub
        End If
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If .Rows(i).Cells(1).Value + .Rows(i).Cells(18).Value + .Rows(i).Cells(19).Value + .Rows(i).Cells(20).Value + .Rows(i).Cells(4).Value + .Rows(i).Cells(3).Value + .Rows(i).Cells(22).Value =
                    Cbo_OrderCode.Text + cbo_JobNumber.Text + cbo_PartyDCNo.Text + cbo_Component.Text + cbo_Size.Text + cbo_colour.Text + cbo_DeliveryType.Text And Val(txt_SlNo.Text) <> .Rows(i).Cells(0).Value Then
                    MsgBox("A Similar Entry already Exists. Cannot make duplicate entry !", vbOKOnly, "Redundant Entry Alert ! ")
                    Exit Sub
                End If
            Next
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(2).Value = lbl_Design.Text
                    ...
                    .Rows(i).Cells(12).Value = lbl_Grid_Order_Code.Text
                    .Rows(i).Cells(13).Value = lbl_Grid_OrderDate.Text

                    .Rows(i).Cells(18).Value = cbo_JobNumber.Text
                    .Rows(i).Cells(19).Value = cbo_PartyDCNo.Text
                    .Rows(i).Cells(20).Value = cbo_Component.Text
                    .Rows(i).Cells(21).Value = txt_Bundles.Text
                    .Rows(i).Cells(22).Value = cbo_DeliveryType.Text
                    .Rows(i).Cells(23).Value = txt_UoM.Text

                    '.Rows(i).Cells("GRNNo").Value = txt_GRN_No.Text
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(2).Value = lbl_Design.Text
                ...
                .Rows(n).Cells(12).Value = lbl_Grid_Order_Code.Text
                .Rows(n).Cells(13).Value = lbl_Grid_OrderDate.Text
                .Rows(n).Cells(18).Value = cbo_JobNumber.Text
                .Rows(n).Cells(19).Value = cbo_PartyDCNo.Text
                .Rows(n).Cells(20).Value = cbo_Component.Text
                .Rows(n).Cells(21).Value = txt_Bundles.Text
                .Rows(n).Cells(22).Value = cbo_DeliveryType.Text
                .Rows(n).Cells(23).Value = txt_UoM.Text
    ...
    Private Sub cbo_ItemName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        With lbl_Design
            ...
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Sales_Delivery_Details", "Design", "", "")
        End With
    ...
    Private Sub cbo_ItemName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        'Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, lbl_Design, Cbo_OrderCode, cbo_colour, "Sales_Delivery_Details", "Design", "", "")
    ...
    Private Sub cbo_ItemName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        'Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, lbl_Design, cbo_colour, "Sales_Delivery_Details", "Design", "", "", False)
    ...
    Private Sub cbo_ItemName_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        ...
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            ...
            Common_Procedures.Master_Return.Control_Name = lbl_Design.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub cbo_ItemName_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        QuantityDetails()
    End Sub
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        ...
        'If Asc(e.KeyChar) = 13 And cbo_Ledger.DroppedDown = False Then
        '    cbo_shift.Focus()
        'End If
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If Len(Trim(cbo_Filter_Partyname.Text)) > 0 Then
                Led_IdNo = Common_Procedures.Ledger_AlaisNameToIdNo(con, Trim(cbo_Filter_Partyname.Text))
            End If
            ...
            'MsgBox("select a.*,a.Sales_Delivery_No, a.Sales_Delivery_Date , a.Ledger_IdNo as LEd_Id from Sales_Delivery_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Sales_Delivery_No")

            da = New SqlClient.SqlDataAdapter("select a.*,a.Sales_Delivery_No, a.Sales_Delivery_Date , a.Ledger_IdNo as LEd_Id from Sales_Delivery_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) &
                                              " and a.Sales_Delivery_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' and a.Sales_Delivery_Code LIKE '" & Pk_Condition & "%' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Sales_Delivery_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Sales_Delivery_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Sales_Delivery_Date").ToString), "dd-MM-yyyy")
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If pnl_InputDetails.Enabled = True And txt_SlNo.Enabled = True Then
            ...
            If IsDBNull(dgv_Details.CurrentRow.Cells("IsBilled").Value) Then
                txt_SlNo.Text = Val(dgv_Details.CurrentRow.Cells(0).Value)
                Cbo_OrderCode.Text = Trim(dgv_Details.CurrentRow.Cells(1).Value)
                lbl_Design.Text = Trim(dgv_Details.CurrentRow.Cells(2).Value)
                cbo_colour.Text = Trim(dgv_Details.CurrentRow.Cells(3).Value)
                cbo_Size.Text = Trim(dgv_Details.CurrentRow.Cells(4).Value)
                cbo_JobNumber.Text = dgv_Details.CurrentRow.Cells(18).Value
                cbo_PartyDCNo.Text = dgv_Details.CurrentRow.Cells(19).Value
                cbo_Component.Text = dgv_Details.CurrentRow.Cells(20).Value

                QuantityDetails()

                txt_NoOfStiches.Text = Val(dgv_Details.CurrentRow.Cells(7).Value)
                txt_NoOfPcs.Text = Val(dgv_Details.CurrentRow.Cells(8).Value)
                txt_UoM.Text = dgv_Details.CurrentRow.Cells(23).Value

                'lbl_OrderNo.Text = Trim(dgv_Details.CurrentRow.Cells(11).Value)
                lbl_Grid_Order_Code.Text = Trim(dgv_Details.CurrentRow.Cells(12).Value)
                lbl_Grid_OrderDate.Text = Trim(dgv_Details.CurrentRow.Cells(13).Value)
                txt_Bundles.Text = dgv_Details.CurrentRow.Cells(21).Value
                cbo_DeliveryType.Text = dgv_Details.CurrentRow.Cells(22).Value

                If txt_SlNo.Enabled And txt_SlNo.Visible Then txt_SlNo.Focus()
                'txt_GRN_No.Text = Trim(dgv_Details.CurrentRow.Cells("GRNNo").Value)
            ...
            If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
                ...
                If dgv_Details.CurrentRow.Cells("IsBilled").Value = False Then
                ...
                Else
                    ...
                    MsgBox("Delivery Item which has been already billed cannot be modified")
                    Exit Sub
    ...
    Private Sub btn_Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Delete.Click
        ...
        lbl_Grid_Order_Code.Text = ""
        lbl_Grid_OrderDate.Text = ""
        If lbl_Design.Enabled And lbl_Design.Visible Then lbl_Design.Focus()
    ...
    Private Sub Amount_Calculation()
        ...
        vTotHead = 0 : vTotStchs = 0 : vTotPcs = 0 : vTotAmt = 0 : vTotBndls = 0
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            vTotBndls = vTotBndls + Val(dgv_Details.Rows(i).Cells(21).Value())
        Next
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(21).Value = vTotBndls
        ...
        If InvPrintFrmt_Letter <> 1 Then
            If prn_Status <> 1 Then
                ...
                If Trim(UCase(InvPrintFrmt)) <> "FORMAT-6" Then
                    prn_InpOpts = InputBox("Select    -   0. None" & Chr(13) & "     1. Original" & Space(5) & "    2. Duplicate", "DC PRINTING...", "12")
                    '& Chr(13) & "     3. Triplicate" & Space(3) & "   4. Transport Copy" & Chr(13) & "     5. Extra Copy  " & Space(1) & "6.All", "FOR INVOICE PRINTING...", "12")
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*,O.Order_Program_No As SPC_No,S.Size_Name,C.Colour_Name,Co.Component_Name,O.Unit_IdNo from Sales_Delivery_Details a Inner Join Order_Program_Head O On " &
                                                   " O.OrderCode_forSelection = a.OrderCode_forSelection left outer join Colour_Head C On a.Colour_IdNo = c.Colour_IdNo " &
                                                   " left outer join Size_Head S On a.Size_IdNo = s.Size_IdNo left outer join Component_Head Co On a.Component_IdNo = Co.Component_IdNo  where a.Sales_Delivery_Code = " &
                                                   "'" & Trim(NewCode) & "' Order by a.for_orderby, a.Sales_Delivery_No", con)
    ...
    Private Sub Printing_Format3(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(0) = 0
        ClArr(1) = 30 : ClArr(2) = 45 : ClArr(3) = 40 : ClArr(4) = 135 : ClArr(5) = 135 : ClArr(6) = 40 : ClArr(7) = 80 : ClArr(8) = 100 : ClArr(9) = 25 : ClArr(10) = 70
...
Loop2:  EntryCode = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
                ...
                If prn_DetDt.Rows.Count > 0 Then
                    ...
                    Do While prn_DetIndx <= prn_DetDt.Rows.Count - 1
                        ...
                        If NoofDets >= NoofItems_PerPage Then
                            ...
                            Printing_Format3_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, False, Unit1)
...
LOOP1:
                        ...
                        Common_Procedures.Print_To_PrintDocument(e, Trim(Val(SNo)), LMargin + 5, CurY, 0, 0, pFont)

                        Common_Procedures.Print_To_PrintDocument(e, Microsoft.VisualBasic.Left(Trim(prn_DetDt.Rows(prn_DetIndx).Item("Party_DC_No").ToString), 5), LMargin + ClArr(1) + 2, CurY, 0, 0, pFont) 'party dc no
                        Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetDt.Rows(prn_DetIndx).Item("SPC_No").ToString), LMargin + ClArr(1) + ClArr(2) + 5, CurY, 0, 0, pFont) 'SPC No

                        If Microsoft.VisualBasic.Len(Trim(prn_DetDt.Rows(prn_DetIndx).Item("JOB_No"))) <= 18 Then
                            Common_Procedures.Print_To_PrintDocument(e, Microsoft.VisualBasic.Left(Trim(prn_DetDt.Rows(prn_DetIndx).Item("JOB_No")), 18), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + 2, CurY, 0, 0, pFont) 'JOB No
                        Else
                            Dim p1Font As New Font("Calibri", 7, FontStyle.Regular)
                            Common_Procedures.Print_To_PrintDocument(e, Microsoft.VisualBasic.Left(Trim(prn_DetDt.Rows(prn_DetIndx).Item("JOB_No")), 25), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + 2, CurY, 0, 0, p1Font) 'JOB No
                        End If

                        'Common_Procedures.Print_To_PrintDocument(e, Trim(ItmDescAr(0)), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 5, CurY, 0, 0, pFont) 'DESIGN
                        'TEMP

                        If Microsoft.VisualBasic.Len(Trim(ItmNmDesc)) <= 18 Then
                            Common_Procedures.Print_To_PrintDocument(e, Microsoft.VisualBasic.Left(Trim(ItmNmDesc), 18), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 2, CurY, 0, 0, pFont) 'DESIGN
                        Else
                            Dim p1Font As New Font("Calibri", 7, FontStyle.Regular)
                            Common_Procedures.Print_To_PrintDocument(e, Microsoft.VisualBasic.Left(Trim(ItmNmDesc), 25), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 5, CurY, 0, 0, p1Font) 'DESIGN
                        End If

                        '/TEMP

                        Common_Procedures.Print_To_PrintDocument(e, Microsoft.VisualBasic.Left(Trim(prn_DetDt.Rows(prn_DetIndx).Item("Size_Name")), 5), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + 2, CurY, 0, 0, pFont) 'size
                        Common_Procedures.Print_To_PrintDocument(e, Common_Procedures.Component_IdNoToName(con, Val(prn_DetDt.Rows(prn_DetIndx).Item("Component_IdNo"))), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + 2, CurY, 0, 0, pFont) 'style
                        Common_Procedures.Print_To_PrintDocument(e, Microsoft.VisualBasic.Left(Trim(prn_DetDt.Rows(prn_DetIndx).Item("Colour_Name")), 12), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + 2, CurY, 0, 0, pFont) 'colour

                        Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Bundles").ToString), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9) - 4, CurY, 1, 0, pFont) 'bundles

                        Dim Unit As String = "PCS"

                        If Not IsDBNull(prn_DetDt.Rows(prn_DetIndx).Item("Unit_IdNo")) Then
                            If prn_DetDt.Rows(prn_DetIndx).Item("Unit_IdNo") > 0 Then
                                Unit = Common_Procedures.Unit_IdNoToName(con, prn_DetDt.Rows(prn_DetIndx).Item("Unit_IdNo"))
                                If Len(Trim(Unit)) > 3 Then
                                    Unit = Microsoft.VisualBasic.Left(Unit, 3)
                                End If
                            End If
                        End If

                        If prn_DetIndx > 0 Then 'if not first row
                            If Unit <> Unit1 Then
                                Unit1 = ""
                            End If
                        Else 'if first row uom to be printed in footer
                            Unit1 = Unit
                        End If

                        Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(prn_DetIndx).Item("Quantity").ToString) & " " & Unit, LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9) + ClArr(10) - 4, CurY, 1, 0, pFont) 'quantity

                        Common_Procedures.Print_To_PrintDocument(e, prn_DetDt.Rows(prn_DetIndx).Item("Delivery_Purpose"), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9) + ClArr(10) + 5, CurY, 0, 0, pFont) 'STATUS
                        ...
                        'For k = 1 To m1
                        '    CurY = CurY + TxtHgt - 5
                        '    Common_Procedures.Print_To_PrintDocument(e, Trim(ItmDescAr(k)), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 5, CurY, 0, 0, pFont)
                        '    NoofDets = NoofDets + 1
                        'Next
                        '''/TEMP
                ...
                Printing_Format3_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, NoofDets, True, Unit1)
    ...
    Private Sub Printing_Format3_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        End If
        Dim ImageLocationEndY As Integer = 0
        If Common_Procedures.settings.CustomerCode = "5010" Then
            e.Graphics.DrawImage(DirectCast(Global.Billing.My.Resources.Resources.SPC_LOGO_GRAYSCALE, Drawing.Image), LMargin + 5, CurY, 100, 100)
            e.Graphics.DrawImage(DirectCast(Global.Billing.My.Resources.Resources.SPC_ISO_GRAYSCALE, Drawing.Image), LMargin + 600, CurY + 5, 130, 95)

            ImageLocationEndY = CurY + 110
        ...
        da2 = New SqlClient.SqlDataAdapter("select Item_HSN_Code from ItemGroup_Head Where ItemGroup_Name = 'EMBROIDERY'", con)
        da2.Fill(dt3)

        If dt3.Rows.Count > 0 Then
            If Not IsDBNull(dt3.Rows(0).Item(0)) Then
                HSN_CODE = dt3.Rows(0).Item(0)
            End If
        End If
        dt3.Clear()
        dt3.Dispose()
        ...
        'da2 = New SqlClient.SqlDataAdapter(" Select distinct(a.Component_Name) from Component_Head a inner join Sales_Delivery_Details b on a.Component_IdNo = b.Component_IdNo " &
        '                                   " Where b.Sales_Delivery_Code = '" & Trim(EntryCode) & "'", con)
        'da2.Fill(dt3)

        'If dt3.Rows.Count > 0 Then
        '    For k As Integer = 0 To dt3.Rows.Count - 1
        '        If Len(Parts) > 0 Then Parts = Parts + ","
        '        Parts = Parts + dt3.Rows(k).Item(1)
        '    Next
        'End If
        'dt3.Clear()
        ...
        If Trim(Cmp_Add1) <> "" Then
            If Microsoft.VisualBasic.Right(Trim(Cmp_Add1), 1) = "," Then
                Cmp_Add1 = Trim(Cmp_Add1) & ", " & Trim(prn_HdDt.Rows(0).Item("Company_Address3").ToString)
            Else
                Cmp_Add1 = Trim(Cmp_Add1) & " " & Trim(prn_HdDt.Rows(0).Item("Company_Address3").ToString)
            End If
        Else
            Cmp_Add1 = Trim(prn_HdDt.Rows(0).Item("Company_Address3").ToString)
        End If

        If Trim(Cmp_Add1) <> "" Then
            If Microsoft.VisualBasic.Right(Trim(Cmp_Add1), 1) = "," Then
                Cmp_Add1 = Trim(Cmp_Add1) & ", " & Trim(prn_HdDt.Rows(0).Item("Company_Address4").ToString)
            Else
                Cmp_Add1 = Trim(Cmp_Add1) & " " & Trim(prn_HdDt.Rows(0).Item("Company_Address4").ToString)
            End If
        Else
            Cmp_Add1 = Trim(prn_HdDt.Rows(0).Item("Company_Address4").ToString)
        End If
        ...
        CurY = CurY + TxtHgt - 15
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1117" Then
        ...
        CurY = CurY + TxtHgt
        p1Font = New Font("Calibri", 10, FontStyle.Bold)
        Dim CMP_STATE_GSTIN As String = Cmp_StateCap + " : " + Cmp_StateNm + "        " + Cmp_GSTIN_Cap + " : " + Cmp_GSTIN_No
        Common_Procedures.Print_To_PrintDocument(e, Trim(CMP_STATE_GSTIN), LMargin, CurY, 2, PrintWidth, p1Font)

        CurY = CurY + TxtHgt

        If CurY < ImageLocationEndY Then
            CurY = ImageLocationEndY
        End If
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "DC.NO", LMargin + C1 + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 - 50, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_Delivery_No").ToString, LMargin + C1 + W1 - 40, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "DC DATE", LMargin + C1 + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 - 50, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Delivery_Date").ToString), "dd-MM-yyyy").ToString & "-" & Format(Now, "hh:mm tt"), LMargin + C1 + W1 - 40, CurY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "HSN CODE", LMargin + C1 + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 - 50, CurY, 0, 0, pFont)
            p1Font = New Font("Calibri", 11, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, HSN_CODE, LMargin + C1 + W1 - 40, CurY, 0, 0, p1Font)
            ...
            'If Len(Trim(Parts)) > 0 Then
            '    CurY = CurY + TxtHgt
            '    p1Font = New Font("Calibri", 10, FontStyle.Bold)
            '    Common_Procedures.Print_To_PrintDocument(e, "PART(S) : " & Parts, LMargin + S1 + 10, CurY, 0, 0, p1Font)
            'End If
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Your ", LMargin + ClAr(1), CurY - 3, 2, ClAr(2), p1Font)
            Common_Procedures.Print_To_PrintDocument(e, "DC.No.", LMargin + ClAr(1), CurY + 7, 2, ClAr(2), p1Font)

            If Val(Common_Procedures.settings.CustomerCode) = 5010 Then
                Common_Procedures.Print_To_PrintDocument(e, "SPC #", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont)
            ElseIf Val(Common_Procedures.settings.CustomerCode) = 5022 Then
                Common_Procedures.Print_To_PrintDocument(e, "RVM #", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont)
            ElseIf Val(Common_Procedures.settings.CustomerCode) = 5027 Then
                Common_Procedures.Print_To_PrintDocument(e, "FWC #", LMargin + ClAr(1) + ClAr(2), CurY, 2, ClAr(3), pFont)
            End If
            Common_Procedures.Print_To_PrintDocument(e, "Job No.", LMargin + ClAr(1) + ClAr(2) + ClAr(3), CurY, 2, ClAr(4), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Design Name", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4), CurY, 2, ClAr(5), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Size", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5), CurY, 2, ClAr(6), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Part", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 2, ClAr(7), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Colour", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7), CurY, 2, ClAr(8), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Bnd", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8), CurY, 2, ClAr(9), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Qty", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9), CurY, 2, ClAr(10), pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Status", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10), CurY, 2, ClAr(11), pFont)
    ...
    Private Sub Printing_Format3_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean, Optional FooterUoM As String = "")
        ...
        Try
            ...
            If prn_HdDt.Rows(0).Item("Total_Bags") > 0 Then
                Common_Procedures.Print_To_PrintDocument(e, "Bags : " & Val(prn_HdDt.Rows(0).Item("Total_Bags").ToString), LMargin + 5, CurY, 0, 0, pFont)
            End If

            If prn_HdDt.Rows(0).Item("Weight") > 0 Then
                Common_Procedures.Print_To_PrintDocument(e, "Weight : " & Val(prn_HdDt.Rows(0).Item("Weight").ToString) & " Kgs", LMargin + 150, CurY, 0, 0, pFont)
            End If

            Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_Bundles").ToString), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) - 4, CurY, 1, 0, pFont)

            If Len(Trim(FooterUoM)) > 0 Then
                Common_Procedures.Print_To_PrintDocument(e, "" & Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString) & " " & FooterUoM, LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10) - 4, CurY, 1, 0, pFont)
            End If

            Common_Procedures.Print_To_PrintDocument(e, "Total", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) - 5, CurY, 1, 0, pFont)
            ...
            If Trim(prn_HdDt.Rows(0).Item("Remarks").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "Remarks : " & Microsoft.VisualBasic.Left(prn_HdDt.Rows(0).Item("Remarks").ToString, 60), LMargin + 5, CurY, 0, 0, pFont)
            End If
            CurY = CurY + TxtHgt

            e.Graphics.DrawLine(Pens.Black, LMargin, CurY, (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8)), CurY)

            e.Graphics.DrawLine(Pens.Black, (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8)),
                                            LnAr(5), (LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8)), CurY)

            ' Common_Procedures.Print_To_PrintDocument(e, Microsoft.VisualBasic.Left(Trim(prn_HdDt.Rows(0).Item("Ledger_MainName").ToString), 20), LMargin + 50, CurY, 2, PrintWidth / 2, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Vehicle_No").ToString), LMargin, CurY, 2, PrintWidth, pFont)

            Cmp_Name = prn_HdDt.Rows(0).Item("Company_Name").ToString
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "For " & Cmp_Name, PageWidth - 15, CurY, 1, 0, p1Font)

            If Not IsDBNull(prn_HdDt.Rows(0).Item("Vehicle_No")) Then
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("User_Name").ToString, LMargin + (PrintWidth / 2) - 50, CurY, 2, PrintWidth / 2, pFont)
            End If
            ...
            p1Font = New Font("Calibri", 12, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Party Signature ", LMargin + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Party Name ", LMargin + 50, CurY, 2, PrintWidth / 2, pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Vehicle No.", LMargin, CurY, 2, PrintWidth, pFont)
            Common_Procedures.Print_To_PrintDocument(e, "Prepared By ", LMargin + (PrintWidth / 2 - 50), CurY, 2, PrintWidth / 2, pFont)
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '    Da = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, e.Size_Name, f.Noof_Items as Ent_Sales_Delivery_Quantity, f.Rate as Ent_Rate, f.Sales_Delivery_Detail_SlNo as Ent_Sales_Delivery_SlNo from Sales_Delivery_Order_Details a INNER JOIN Item_Head b ON a.Item_idno = b.Item_idno  LEFT OUTER JOIN Size_Head e ON a.Size_IdNo = e.Size_IdNo LEFT OUTER JOIN Sales_Delivery_Details F ON f.Sales_Delivery_Code = '" & Trim(NewCode) & "' and f.Entry_Type = '" & Trim(cbo_EntType.Text) & "' and a.Sales_Delivery_Order_Code = f.Sales_Delivery_Order_Code and a.Sales_Delivery_Order_Detail_SlNo = f.Sales_Delivery_Order_Detail_SlNo Where a.ledger_idno = " & Str(Val(LedIdNo)) & " and ( (a.Noof_Items  - a.Sales_Delivery_Items ) > 0 or f.Noof_Items > 0 ) Order by a.For_OrderBy, a.Sales_Delivery_Order_No, a.Sales_Delivery_Order_Detail_SlNo", con)
        '    Dt1 = New DataTable
        '    Da.Fill(Dt1)
        ...
        '            If IsDBNull(Dt1.Rows(i).Item("Ent_Sales_Delivery_SlNo").ToString) = False Then Ent_DetSlNo = Val(Dt1.Rows(i).Item("Ent_Sales_Delivery_SlNo").ToString)
        '            If IsDBNull(Dt1.Rows(i).Item("Ent_Sales_Delivery_Quantity").ToString) = False Then Ent_Qty = Val(Dt1.Rows(i).Item("Ent_Sales_Delivery_Quantity").ToString)
        ...
        '            If (Val(Dt1.Rows(i).Item("Noof_Items").ToString) - Val(Dt1.Rows(i).Item("Sales_Delivery_Items").ToString) + Ent_Qty) > 0 Then
        ...
        '                .Rows(n).Cells(1).Value = Dt1.Rows(i).Item("Sales_Delivery_Order_No").ToString
        '                .Rows(n).Cells(2).Value = Dt1.Rows(i).Item("Item_name").ToString
        '                .Rows(n).Cells(3).Value = Dt1.Rows(i).Item("Size_Name").ToString
        '                .Rows(n).Cells(4).Value = (Val(Dt1.Rows(i).Item("Noof_Items").ToString) - Val(Dt1.Rows(i).Item("Sales_Delivery_Items").ToString) + Ent_Qty)
        ...
        '                End If
        '                .Rows(n).Cells(7).Value = Dt1.Rows(i).Item("Sales_Delivery_Order_Code").ToString
        '                .Rows(n).Cells(8).Value = Val(Dt1.Rows(i).Item("Sales_Delivery_Order_Detail_SlNo").ToString)
                ...
                ElseIf keyData = Keys.Up Then
                    ...
                    If .CurrentCell.ColumnIndex <= 4 Then
                        If .CurrentCell.RowIndex = 0 Then
                            If pnl_InputDetails.Enabled = True And lbl_Design.Enabled = True Then
                                lbl_Design.Focus()
    ...
    Private Sub getItemDetails()
        ...
        Try
            ...
            '    da1 = New SqlClient.SqlDataAdapter("select  Piece_Box ,Sales_Delivery_rate from Item_Details where Item_IdNo = " & Common_Procedures.Item_NameToIdNo(con, Trim(cbo_ItemName.Text)) & " and  Size_IdNo =" & Common_Procedures.Size_NameToIdNo(con, Trim(cbo_Size.Text)), con)
            '    da1.Fill(dt1)

            '    If dt1.Rows.Count > 0 Then
            '        txt_Pc_Box.Text = Val(dt1.Rows(0).Item("Piece_Box").ToString)
            '        txt_Rate.Text = Val(dt1.Rows(0).Item("Sales_Delivery_rate").ToString)
            '    End If
            '    dt1.Clear()
    ...
    Private Sub cbo_Framer_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        '   Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Employee_Head", "Employee_Name", "", "(Employee_IdNo = 0)")
    End Sub

    Private Sub cbo_Framer_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        'vcbo_KeyDwnVal = e.KeyValue
    ...
    Private Sub cbo_Framer_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub cbo_Framer_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        'If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
    ...
    Private Sub cbo_Machine_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Machine_Head", "Machine_Name", "", "(Machine_IdNo = 0)")
    End Sub

    Private Sub cbo_Machine_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        'vcbo_KeyDwnVal = e.KeyValue
    ...
    Private Sub cbo_Machine_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub cbo_Machine_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        'If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
        ...
        'End If
    End Sub
    Private Sub cbo_Operator_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Employee_Head", "Employee_Name", "", "(Employee_IdNo = 0)")
    End Sub

    Private Sub cbo_Operator_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        'vcbo_KeyDwnVal = e.KeyValue
    ...
    Private Sub cbo_Operator_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub cbo_Operator_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        'If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
        '    Dim f As New Employee_Creation
    ...
    Private Sub cbo_shift_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        'Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_shift, cbo_Ledger, cbo_Machine, "", "", "", "")
    End Sub

    Private Sub cbo_shift_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        'Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_shift, cbo_Machine, "", "", "", "")
    End Sub

    Private Sub cbo_shift_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        '_____________
    End Sub
    ...
    Private Sub txt_NoOfPcs_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub txt_NoOfHeads_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        'txt_NoOfStiches.Text = Format(Val(txt_Stch_Pcs.Text) * Val(txt_NoOfHeads.Text), "#######0")
    End Sub

    Private Sub txt_Stch_Pcs_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        'txt_NoOfStiches.Text = Format(Val(txt_Stch_Pcs.Text) * Val(txt_NoOfHeads.Text), "#######0")
    End Sub
    ...
    Private Sub txt_Manual_DC_No_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Manual_DC_No.KeyPress
        'If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
        If Asc(e.KeyChar) = 13 Then
            txt_Remarks.Focus()
        End If
    ...
    Private Sub lbl_Design_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub Cbo_OrderCode_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub b1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b1.TextChanged
        ...
        If Val(txt_NoOfPcs.Text) > Val(b2.Text) Then
    ...
    Private Sub t1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles t1.TextChanged
        b1.Text = Val(t1.Text) - Val(s1.Text)
        b2.Text = Val(t2.Text) - Val(s2.Text)
    End Sub
    ...
    Private Sub cbo_colour_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_colour.LostFocus
        ...
        If cbo_Buff <> cbo_colour.Text Then
    ...
    Private Sub cbo_Size_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Size.LostFocus
        ...
        If cbo_Buff <> cbo_Size.Text Then
    ...
    Private Sub QuantityDetails(Optional ForceDisplayQty As Boolean = True)
        ...
        If Len(Trim(Cbo_OrderCode.Text)) = 0 Then
        ...
        Else
            ...
            t1.Text = Common_Procedures.get_FieldValue(con, "Simple_Receipt_Details", "sum(Quantity)", "OrderCode_forSelection = '" & Cbo_OrderCode.Text & "' and Job_No = '" & cbo_JobNumber.Text & "'" &
                                                   " And Simple_Receipt_Code Like 'EMREC%'", Common_Procedures.CompIdNo)
            s1.Text = Common_Procedures.get_FieldValue(con, "Sales_Delivery_Details", "sum(Quantity)", "OrderCode_forSelection = '" & Cbo_OrderCode.Text & "' and Job_No = '" & cbo_JobNumber.Text & "' " &
                                                       " And Sales_Delivery_Code Like 'EMDEL%' " &
                                                       " AND NOT SALES_DELIVERY_CODE = '" & Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode) & "'", Common_Procedures.CompIdNo)
        End If

        If Len(Trim(Cbo_OrderCode.Text)) = 0 Or Len(Trim(cbo_JobNumber.Text)) = 0 Or Len(Trim(cbo_PartyDCNo.Text)) = 0 Or Len(Trim(cbo_Size.Text)) = 0 Or Len(Trim(cbo_colour.Text)) = 0 Then
        ...
        Else
            ...
            t2.Text = Common_Procedures.get_FieldValue(con, "Simple_Receipt_Details", "sum(Quantity)", "OrderCode_forSelection = '" & Cbo_OrderCode.Text & "' and Job_No = '" & cbo_JobNumber.Text & "' and " &
                                                   " Colour_IdNo = " & Common_Procedures.Colour_NameToIdNo(con, cbo_colour.Text) & " " &
                                                   " And Size_IdNo = " & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text) & " and Simple_Receipt_Code Like 'EMREC%' and Simple_Receipt_Code in " &
                                                   "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "')", Common_Procedures.CompIdNo)

            s2.Text = Common_Procedures.get_FieldValue(con, "Sales_Delivery_Details", "sum(Quantity)", "OrderCode_forSelection = '" & Cbo_OrderCode.Text & "' and Sales_Delivery_Code Like 'EMDEL%' " &
                                                        " And Job_No = '" & cbo_JobNumber.Text & "' and Party_DC_No = '" & cbo_PartyDCNo.Text & "' and " &
                                                        " Colour_IdNo = " & Common_Procedures.Colour_NameToIdNo(con, cbo_colour.Text).ToString &
                                                        " And Size_IdNo = " & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text).ToString &
                                                        " and Not SALES_DELIVERY_CODE = '" & Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode) & "'", Common_Procedures.CompIdNo)
    ...
    Private Sub txt_GRN_No_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub chk_Billable_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'If chk_Billable.Checked Then
        '    txt_Reason_Not_Invoicable.Enabled = False
        'Else
        '    txt_Reason_Not_Invoicable.Enabled = True
        '    txt_Reason_Not_Invoicable.Focus()
        'End If
    End Sub
    ...
    Private Sub Cbo_OrderCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Cbo_OrderCode.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_OrderCode, txt_SlNo, Nothing, "Order_Program_Head", "Ordercode_forSelection", " Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text) & IIf(Len(Order_Disp_Cond) > 0, " and " & Order_Disp_Cond, ""), "")
    ...
    Private Sub Cbo_OrderCode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Cbo_OrderCode.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, Cbo_OrderCode, Nothing, "Order_Program_Head", "Ordercode_forSelection", "Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text) & IIf(Len(Order_Disp_Cond) > 0, " and " & Order_Disp_Cond, ""), "")
        If Asc(e.KeyChar) = 13 Then
            If Trim(Cbo_OrderCode.Text) <> "" Then
                cbo_JobNumber.Focus()
            Else
    ...
    Private Sub txt_SlNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_SlNo.KeyDown
        ...
        If e.KeyCode = 38 Then e.Handled = True : cbo_Ledger.Focus()
    ...
    Private Sub cbo_JobNumber_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_JobNumber.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_JobNumber, txt_SlNo, Nothing, "OrderJobNo_Head", "OrderJobNo_Name", " OrderNo_Name = '" & Cbo_OrderCode.Text & "'", "")
    ...
    Private Sub cbo_PartyDCNo_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_PartyDCNo.SelectedIndexChanged

    End Sub

    Private Sub cbo_PartyDCNo_GotFocus(sender As Object, e As EventArgs) Handles cbo_PartyDCNo.GotFocus

        cbo_Buff = cbo_PartyDCNo.Text

        Try

            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Simple_Receipt_Head", "Electronic_Reference_No",
                              "Simple_Receipt_Code In (Select Simple_Receipt_Code from Simple_Receipt_Details Where Ordercode_forSelection = '" & Cbo_OrderCode.Text &
                              "' and Job_No = '" & cbo_JobNumber.Text & "')", "")
    ...
    Private Sub cbo_Component_GotFocus(sender As Object, e As EventArgs) Handles cbo_Component.GotFocus
    ...
    Private Sub cbo_Component_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Component.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Component, txt_SlNo, Nothing, "Component_Head", "Component_Name",
                             "Component_IdNo In (Select Component_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                              " and Job_No = '" & cbo_JobNumber.Text & "')", "(Component_IdNo = 0)")

        If (e.KeyValue = 40 And Cbo_OrderCode.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            If Trim(cbo_Component.Text) <> "" Then
                cbo_Size.Focus()
            Else
                txt_NoOfBags.Focus()
            End If
    ...
    Private Sub cbo_Component_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Component.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Component, Nothing, "Component_Head", "Component_Name",
                             "Component_IdNo In (Select Component_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                             " and Job_No = '" & cbo_JobNumber.Text & "')", "(Component_IdNo = 0)")
    ...
    Private Sub Cbo_OrderCode_SelectedIndexChanged_1(sender As Object, e As EventArgs) Handles Cbo_OrderCode.SelectedIndexChanged

    End Sub

    Private Sub Cbo_OrderCode_GotFocus(sender As Object, e As EventArgs) Handles Cbo_OrderCode.GotFocus
    ...
    Private Sub cbo_PartyDCNo_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_PartyDCNo.KeyDown

        vcbo_KeyDwnVal = e.KeyValue


        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyDCNo, cbo_JobNumber, Nothing, "Simple_Receipt_Head", "Electronic_Reference_No",
                                                         "Simple_Receipt_Code In (Select Simple_Receipt_Code from Simple_Receipt_Details Where Ordercode_forSelection = '" & Cbo_OrderCode.Text &
                                                         "' and Job_No = '" & cbo_JobNumber.Text & "')", "")
    ...
    Private Sub cbo_PartyDCNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_PartyDCNo.KeyPress


        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PartyDCNo, Nothing, "Simple_Receipt_Head", "Electronic_Reference_No",
                                                          "Simple_Receipt_Code In (Select Simple_Receipt_Code from Simple_Receipt_Details Where Ordercode_forSelection = '" & Cbo_OrderCode.Text &
                             "' and Job_No = '" & cbo_JobNumber.Text & "')", "")
    ...
    Private Sub cbo_Size_GotFocus(sender As Object, e As EventArgs) Handles cbo_Size.GotFocus
        ...
        cbo_Buff = cbo_Size.Text

        Try

            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Size_Head", "Size_Name",
                             "Size_IdNo In (Select Size_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                              " and Job_No = '" & cbo_JobNumber.Text & "')",
                             "(Size_IdNo = 0)")
    ...
    Private Sub cbo_Size_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Size.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Size, cbo_Component, Nothing, "Size_Head", "Size_Name",
                             "Size_IdNo In (Select Size_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                              " and Job_No = '" & cbo_JobNumber.Text & "')", "(Size_IdNo = 0)")
    ...
    Private Sub cbo_Size_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Size.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Size, Nothing, "Size_Head", "Size_Name",
                             " Size_IdNo In (Select Size_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             " (Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                             " and Job_No = '" & cbo_JobNumber.Text & "')", "(Size_IdNo = 0)")
    ...
    Private Sub cbo_colour_GotFocus(sender As Object, e As EventArgs) Handles cbo_colour.GotFocus
        ...
        Try
            ...
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Colour_Head", "Colour_Name",
                             "Colour_IdNo In (Select Colour_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                              " and Job_No = '" & cbo_JobNumber.Text & "' and Size_IdNo = " & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text) & ")",
                             "(Colour_IdNo = 0)")
    ...
    Private Sub cbo_colour_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_colour.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_colour, cbo_Size, Nothing, "Colour_Head", "Colour_Name",
                             "Colour_IdNo In (Select Colour_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                              " and Job_No = '" & cbo_JobNumber.Text & "' and Size_IdNo = " & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text) & ")",
    ...
    Private Sub cbo_colour_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_colour.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_colour, Nothing, "Colour_Head", "Colour_Name",
                             "Colour_IdNo In (Select Colour_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                              " and Job_No = '" & cbo_JobNumber.Text & "' and Size_IdNo = " & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text) & ")",
    ...
    Private Sub txt_Bundles_TextChanged(sender As Object, e As EventArgs) Handles txt_Bundles.TextChanged

    End Sub

    Private Sub txt_Bundles_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Bundles.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
        If Asc(e.KeyChar) = 13 Then
            txt_NoOfPcs.Focus()
        End If
    ...
    Private Sub txt_NoOfPcs_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_NoOfPcs.KeyPress

        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True

        If Asc(e.KeyChar) = 13 Then
            cbo_DeliveryType.Focus()
        End If

    End Sub

    Private Sub txt_NoOfBags_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_NoOfBags.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
        If Asc(e.KeyChar) = 13 Then
            txt_Weight.Focus()
        End If
    ...
    Private Sub txt_Remarks_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Remarks.KeyPress
        If Asc(e.KeyChar) = 13 Then
            Dim c As Integer = MsgBox("Do you want to Save the Delivery ?", vbYesNo, "SAVE ?")
            If c = vbYes Then
                save_record()
            End If
        End If
    ...
    Private Sub cbo_PartyDCNo_LostFocus(sender As Object, e As EventArgs) Handles cbo_PartyDCNo.LostFocus

        If cbo_Buff <> cbo_PartyDCNo.Text Then
    ...
    Private Sub txt_VehicleNo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_VehicleNo.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_Manual_DC_No.Focus()
        End If
    End Sub

    Private Sub txt_NoOfPcs_TextChanged_1(sender As Object, e As EventArgs) Handles txt_NoOfPcs.TextChanged
        If (Val(txt_NoOfPcs.Text) > Val(b2.Text)) Or Val(txt_NoOfPcs.Text) = 0 Then
            txt_NoOfPcs.BackColor = Color.Red
            txt_NoOfPcs.ForeColor = Color.Yellow
            btn_Add.Enabled = False
    ...
    Private Sub btn_Quantity_Click(sender As Object, e As EventArgs) Handles btn_Quantity.Click
    ...
    Private Sub cbo_DeliveryType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_DeliveryType.SelectedIndexChanged

    End Sub

    Private Sub cbo_DeliveryType_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_DeliveryType.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_DeliveryType, txt_NoOfPcs, Nothing, "", "", "", "")
    ...
    Private Sub cbo_DeliveryType_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_DeliveryType.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_DeliveryType, txt_NoOfPcs, "", "", "", "")


    End Sub

    Private Sub btn_Quantity_GotFocus(sender As Object, e As EventArgs) Handles btn_Quantity.GotFocus
    ...
    Private Sub cbo_Component_LostFocus(sender As Object, e As EventArgs) Handles cbo_Component.LostFocus

        If cbo_Buff <> cbo_Component.Text Then
    ...
    Private Sub cbo_DeliveryType_GotFocus(sender As Object, e As EventArgs) Handles cbo_DeliveryType.GotFocus

        If Len(cbo_DeliveryType.Text) = 0 Then
            cbo_DeliveryType.Text = "Good"
        End If
    ...
    Private Sub cbo_JobNumber_Leave(sender As Object, e As EventArgs) Handles cbo_JobNumber.Leave
        ...
        If cbo_Buff <> cbo_JobNumber.Text Then
    ...
    Private Sub cbo_Component_Enter(sender As Object, e As EventArgs) Handles cbo_Component.Enter

        cbo_Buff = cbo_Component.Text

        Try

            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Component_Head", "Component_Name",
                             "Component_IdNo In (Select Component_IdNo from Simple_Receipt_Details Where Simple_Receipt_Code In " &
                             "(Select Simple_Receipt_Code from Simple_Receipt_Head Where Electronic_Reference_No = '" & cbo_PartyDCNo.Text & "') " &
                             " And Ordercode_forSelection = '" & Cbo_OrderCode.Text & "' " &
                              " and Job_No = '" & cbo_JobNumber.Text & "')",
    ...
    Private Sub Cbo_OrderCode_Leave(sender As Object, e As EventArgs) Handles Cbo_OrderCode.Leave
        ...
        If cbo_Buff <> Cbo_OrderCode.Text Then
            ...
            If Trim(UCase(Cbo_OrderCode.Text)) <> "" Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    If Not IsDBNull(dt.Rows(0)("Unit_IdNo")) Then
