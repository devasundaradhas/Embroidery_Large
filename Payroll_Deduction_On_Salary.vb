Public Class Payroll_Deduction_On_Salary
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.* from PayRoll_Employee_Deduction_Head a Where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Employee_Deduction_Code = '" & Trim(NewCode) & "'", con)
            dt1 = New DataTable
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, PEH.Employee_Name from PayRoll_Employee_Deduction_Details a INNER JOIN PayRoll_Employee_Head PEH  ON a.Employee_IdNo <> 0 and a.Employee_IdNo = PEH.Employee_IdNo where a.Employee_Deduction_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            .Rows(n).Cells(2).Value = Format(Val(dt2.Rows(i).Item("Other_Addition").ToString), "#########0.00")
                            .Rows(n).Cells(3).Value = Format(Val(dt2.Rows(i).Item("Mess").ToString), "#########0.00")
                            .Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Medical").ToString), "#########0.00")
                            .Rows(n).Cells(5).Value = Format(Val(dt2.Rows(i).Item("Store").ToString), "#########0.00")
                            .Rows(n).Cells(6).Value = Format(Val(dt2.Rows(i).Item("Advance_Deduction_Amount").ToString), "########0.00")
                            .Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("Quality_Fine").ToString), "########0.00")
                            .Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("Other_Deduction_Amount").ToString), "########0.00")
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from PayRoll_Employee_Deduction_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Employee_Deduction_No from PayRoll_Employee_Deduction_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Employee_Deduction_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Employee_Deduction_No from PayRoll_Employee_Deduction_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Employee_Deduction_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Employee_Deduction_No from PayRoll_Employee_Deduction_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Employee_Deduction_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RefNo.Text = Common_Procedures.get_MaxCode(con, "PayRoll_Employee_Deduction_Head", "Employee_Deduction_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Employee_Deduction_No from PayRoll_Employee_Deduction_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code = '" & Trim(RecCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        'If Not (Convert.ToDateTime(dtp_date.Text) >= Common_Procedures.Company_FromDate And Convert.ToDateTime(msk_date.Text) <= Common_Procedures.Company_ToDate) Then
        ...
        With dgv_Details
            ...
            For i = 0 To .RowCount - 1
                ...
                If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(4).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(6).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Or Val(.Rows(i).Cells(8).Value) <> 0 Then
                    ...
                    If Emp_id = 0 Then
                        ...
                        If cbo_Grid_Employee.Enabled Then cbo_Grid_Employee.Focus()
                        Exit Sub
                    End If
                End If
            Next
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into PayRoll_Employee_Deduction_Head  (Employee_Deduction_Code,           Company_IdNo           ,        Employee_Deduction_No , for_OrderBy                                                            , Employee_Deduction_Date      ) " & _
                                "   Values                                      ('" & Trim(NewCode) & "' , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RefNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_RefNo.Text))) & ", @EntryDate                      )"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "Update PayRoll_Employee_Deduction_Head set Employee_Deduction_Date = @EntryDate Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code = '" & Trim(NewCode) & "' "
                cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Delete from PayRoll_Employee_Deduction_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Employee_Deduction_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(Emp_id) <> 0 Then
                        ...
                        If Val(.Rows(i).Cells(3).Value) <> 0 Or Val(.Rows(i).Cells(4).Value) <> 0 Or Val(.Rows(i).Cells(5).Value) <> 0 Or Val(.Rows(i).Cells(6).Value) <> 0 Or Val(.Rows(i).Cells(7).Value) <> 0 Or Val(.Rows(i).Cells(8).Value) <> 0 Then
                            ...
                            cmd.CommandText = "Insert into PayRoll_Employee_Deduction_Details(Employee_Deduction_Code , Company_IdNo                     , Employee_Deduction_No        , for_OrderBy                                                            , Employee_Deduction_Date    ,  Sl_No               , Employee_IdNo           ,         Other_Addition                   ,   Mess                                   ,          Medical                        ,             Store                        ,         Advance_Deduction_Amount        ,  Quality_Fine                           , Other_Deduction_Amount ) " & _
    ...
    '                If (e.ColumnIndex = 1 Or e.ColumnIndex = 2 Or e.ColumnIndex = 3 Or e.ColumnIndex = 4 Or e.ColumnIndex = 5 Or e.ColumnIndex = 6 Or e.ColumnIndex = 7 Or e.ColumnIndex = 8) And Trim(.Rows(e.RowIndex).Cells(e.ColumnIndex).Value) <> "" Then
    '                    .Rows.Add()
    '                End If
    '            End If
    '        End With
    ...
    Private Sub dtp_Date_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        '.Text = Trim(Format(dtp_Date.Value, "dddddd"))
    End Sub
