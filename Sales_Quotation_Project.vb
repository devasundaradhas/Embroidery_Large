Public Class Sales_Quotation_Project
    ...
    Private Pk_Condition As String = "SQUOT-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName from Sales_Quotation_Head a INNER JOIN lEDGER_Head b on a.ledger_IdNo = b.Ledger_IdNo where a.Sales_Quotation_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_InvoiceNo.Text = dt1.Rows(0).Item("Sales_Quotation_No").ToString
                ...
                cbo_EnquiryNo.Text = Trim(dt1.Rows(0).Item("Enquiry_No").ToString)
                txt_Enq_Date.Text = Trim(dt1.Rows(0).Item("Enquiry_Date").ToString)

                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Unit_Name from Sales_Quotation_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on a.unit_idno = c.unit_idno where a.Sales_Quotation_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
    ...
    Private Sub Sales_Quotation_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler cbo_EnquiryNo.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_Enq_Date.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_EnquiryNo.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_Enq_Date.LostFocus, AddressOf ControlLostFocus
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Sales_Quotation_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Quotation_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Sales_Quotation_No from Sales_Quotation_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Quotation_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Entry_VAT_GST_Type <> 'GST' Order by for_Orderby, Sales_Quotation_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Sales_Quotation_No from Sales_Quotation_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Quotation_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Entry_VAT_GST_Type <> 'GST' Order by for_Orderby, Sales_Quotation_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 Sales_Quotation_No from Sales_Quotation_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Quotation_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Entry_VAT_GST_Type <> 'GST' Order by for_Orderby desc, Sales_Quotation_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 Sales_Quotation_No from Sales_Quotation_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Quotation_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' AND Entry_VAT_GST_Type <> 'GST' Order by for_Orderby desc, Sales_Quotation_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Quotation_Head", "Sales_Quotation_Code", "For_OrderBy", "Entry_VAT_GST_Type <> 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
            lbl_InvoiceNo.ForeColor = Color.Red

            da = New SqlClient.SqlDataAdapter("select top 1 a.* from Sales_Quotation_Head a  where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Quotation_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by a.for_Orderby desc, a.Sales_Quotation_No desc", con)
            dt2 = New DataTable
            da.Fill(dt2)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Sales_Quotation_No from Sales_Quotation_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Quotation_Code = '" & Trim(RefCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub insert_record() Implements Interface_MDIActions.insert_record
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("select Sales_Quotation_No from Sales_Quotation_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Sales_Quotation_Code = '" & Trim(InvCode) & "'", con)
            Da.Fill(Dt)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim Sales_QuotationSelection_Code As String = ""
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Sales_Quotation_Head", "Sales_Quotation_Code", "For_OrderBy", "Entry_VAT_GST_Type <> 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)

                NewCode = Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_InvoiceNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)

            End If

            Sales_QuotationSelection_Code = Trim(lbl_InvoiceNo.Text) & "/" & Trim(Common_Procedures.FnYearCode) & "/" & Trim(Val(lbl_Company.Tag)) & "-QTN"
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(3).Value) <> 0 Then
                        ...
                        If itm_id <> 0 Then
                            ...
                            cmd.CommandText = "Insert into Sales_Quotation_Details ( Sales_Quotation_Code,             Company_IdNo         ,               Sales_Quotation_No            ,           for_OrderBy      , Sales_Quotation_Date,          Ledger_IdNo    ,        Sl_No         ,          Item_IdNo      ,           Unit_IdNo      ,                     Quantity               ,                      Rate                ,                      Amount            ,   Item_Description     ) " & _
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        Try
            vcbo_KeyDwnVal = e.KeyValue
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, dtp_Date, cbo_EnquiryNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10)", "(Ledger_IdNo = 0)")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, cbo_EnquiryNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10)", "(Ledger_IdNo = 0)")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If Val(Itm_IdNo) <> 0 Then
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Sales_Quotation_Code IN (select z.Sales_Quotation_Code from Sales_Quotation_Details z where z.Item_IdNo = " & Str(Val(Itm_IdNo)) & ") "
            End If

            da = New SqlClient.SqlDataAdapter("select a.Sales_Quotation_No, a.Sales_Quotation_Date, a.Total_Qty, a.Net_Amount, b.Ledger_Name from Sales_Quotation_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Quotation_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Sales_Quotation_No", con)
            dt2 = New DataTable
            da.Fill(dt2)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from Sales_Quotation_Head a INNER JOIN Company_Head b ON a.Company_IdNo = b.Company_IdNo INNER JOIN Ledger_Head c ON a.Ledger_IdNo = c.Ledger_IdNo   where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Quotation_Code = '" & Trim(NewCode) & "' ", con)
            prn_HdDt = New DataTable
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.* from Sales_Quotation_Details a  where a.Sales_Quotation_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Sales_Quotation_No", con)
...
LOOP1:
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Sales_Quotation_Head a  INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Quotation_Code = '" & Trim(EntryCode) & "'  Order by a.For_OrderBy", con)
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_Quotation_No").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Quotation_Date").ToString), "dd-MM-yyyy").ToString, LMargin + C1 + W1 + 30, CurY, 0, 0, pFont)
    ...
    Private Sub cbo_EnquiryNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_EnquiryNo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Order_Selection_Code_Head", "Order_Selection_Code", "Order_Selection_Code like '%-ENQ'", "")

    End Sub

    Private Sub cbo_EnquiryNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_EnquiryNo.KeyDown
        Try
            vcbo_KeyDwnVal = e.KeyValue
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_EnquiryNo, cbo_Ledger, txt_Enq_Date, "Order_Selection_Code_Head", "Order_Selection_Code", "Order_Selection_Code like '%-ENQ'", "")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub

    Private Sub cbo_EnquiryNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_EnquiryNo.KeyPress
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_EnquiryNo, txt_Enq_Date, "Order_Selection_Code_Head", "Order_Selection_Code", "Order_Selection_Code like '%-ENQ'", "")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub

    Private Sub txt_Enq_Date_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Enq_Date.KeyDown
        If e.KeyValue = 38 Then
            cbo_EnquiryNo.FindForm()
        End If
    ...
    Private Sub txt_Enq_Date_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Enq_Date.KeyPress
        If Asc(e.KeyChar) = 13 Then
            txt_SlNo.Focus()
        End If
    End Sub
