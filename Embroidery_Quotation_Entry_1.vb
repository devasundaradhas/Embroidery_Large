...
Public Class Embroidery_Quotation_Entry_1
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            'da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name,C.Design,C.Style_Ref_No from Sales_Quotation_Head a INNER JOIN Ledger_Head b " &
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Sales_Quotation_Head a INNER JOIN Ledger_Head b " &
                                               "ON a.Ledger_IdNo = b.Ledger_IdNo  " &
                                               " where a.Sales_Quotation_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_UID.Text = dt1.Rows(0).Item("uid").ToString
                txt_stitches1.Text = Val(dt1.Rows(0).Item("Stitches1").ToString)
                txt_Design1.Text = (dt1.Rows(0).Item("Design1").ToString)

                If Not IsDBNull(dt1.Rows(0).Item("Style_No").ToString) Then
                    txt_StyleNo.Text = (dt1.Rows(0).Item("Style_No").ToString)
                End If
                ...
                Lbl_Total_Stitches.Text = Val(dt1.Rows(0).Item("Total_Qty").ToString)
                ...
                If Not IsDBNull(dt1.Rows(0).Item("Rejection_Allowance")) Then cbo_RejectionAllowance.Text = dt1.Rows(0).Item("Rejection_Allowance")
    ...
    Private Sub Sales_Quotation_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler txt_UID.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_UID.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_UID.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_UID.KeyPress, AddressOf TextBoxControlKeyPress
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                cmd.CommandText = "Insert into Sales_Quotation_Head(Sales_Quotation_Code ,UID, Company_IdNo, Sales_Quotation_No, for_OrderBy, Sales_Quotation_Date, " &
                                                                    ...
                                                                    "No_Of_Sequins ,Is_Material_Provided , Material_Provided                      ,   Confirmed_By , Contact_Person   , Payment_Terms ,Prepared_By, Rejection_Allowance, Contact_Person_Phone, Style_No)" &
                                                           " Values ('" & Trim(NewCode) & "','" & txt_UID.Text & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_JobNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_JobNo.Text))) & ", @Sales_QuotationDate, " &
                                                                    Str(Val(Led_ID)) & ", " & Str(Val(txt_stitches1.Text)) & ", '" & Trim(txt_Design1.Text) & "',  " & Str(Val(txt_Rate_Per_Applique.Text)) & "," & Str(Val(txt_Rate_Per_Embroidery.Text)) & "," & Str(Val(txt_Rate_Per_Stiches.Text)) & ", " & Str(Val(txt_Rate_Foam_Removing.Text)) & "," & Str(Val(Lbl_Total_Stitches.Text)) & " ," &
                                                                    ...
                                                                    Val(txt_NoOfSequins.Text).ToString & "," & IIf(chk_Material.Checked, "1", "0") & ",'" & cbo_MaterialbyCustomer.Text & "','" & txt_ConfirmedBy.Text & "','" & txt_ContactPerson.Text & "','" & cbo_PaymentTerms.Text & "','" & cbo_PreparedBy.Text & "'," & Val(cbo_RejectionAllowance.Text).ToString & ",'" & txt_ContactPerson_Phone.Text & "','" & txt_StyleNo.Text & "')"
            ...
            Else
                ...
                cmd.CommandText = "Update Sales_Quotation_Head set Sales_Quotation_Date = @Sales_QuotationDate, Ledger_IdNo = " & Str(Val(Led_ID)) & " , Stitches1 = " & Str(Val(txt_stitches1.Text)) &
                    ...
                    " , Total_Qty =    " & Str(Val(Lbl_Total_Stitches.Text)) &
                    " , Net_Amount = " & Str(Val(txt_Net_Amount.Text)) & " , Sales_Quotation_Image = @Photo ,  Remarks = '" & txt_Remarks.Text & "'" &
                    " ,Finalised_Rate = " & Val(txt_FinalRate.Text).ToString & ", UID = '" & txt_UID.Text & "'," &
                    ...
                    " Contact_Person_Phone = '" & txt_ContactPerson_Phone.Text & "',Style_No = '" & txt_StyleNo.Text & "' Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " And Sales_Quotation_Code = '" & Trim(NewCode) & "'"
    ...
    Private Sub cbo_partyName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PartyName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PartyName, dtp_Date, txt_UID, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_partyName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PartyName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PartyName, txt_UID, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter(" select a.*, b.*, c.*, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, " &
                                               " Lsh.State_Code as Ledger_State_Code from Sales_Quotation_Head a  " &
...
LOOP1:
    ...
    Private Sub Printing_Format2_GST(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        If prn_HdDt.Rows.Count > 0 Then
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 9, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Design1").ToString, LMargin + W1 + 30, CurY, 0, 0, pFont)
            ...
            Else
                Common_Procedures.Print_To_PrintDocument(e, "ORDER #", LMargin + 9, CurY, 0, 0, pFont)
            End If
            ...
            Common_Procedures.Print_To_PrintDocument(e, "/Piece", LMargin + 9, CurY + TxtHgt, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 9, CurY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Rate/Piece", LMargin + 9, CurY + TxtHgt, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 9, CurY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Material Rate/Piece", LMargin + 9, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + W1 + 9, CurY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Total Rate per Piece", LMargin + 9, CurY + 9, 0, 0, pFont)
    ...
    'Private Sub txt_UID_KeyDown(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_UID.KeyDown
    ...
    'Private Sub txt_UID_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)
    '    vcbo_KeyDwnVal = e.KeyValue
    '    Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, txt_UID, cbo_PartyName, cbo_Part, "Order_Program_Head", "OrderCode_forSelection", "Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_PartyName.Text), "")
    'End Sub

    'Private Sub txt_UID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    '    Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, txt_UID, cbo_Part, "Order_Program_Head", "OrderCode_forSelection", "Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_PartyName.Text), "")
    'End Sub

    Private Sub txt_UID_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs)

        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            Dim f As New Embroidery_Order_Entry

            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = txt_UID.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub txt_UID_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Order_Program_Head  where Ordercode_forSelection = '" & Trim(txt_UID.Text) & "'", con)
            da1.Fill(dt1)
            ...
            dt1.Clear()
            da1 = New SqlClient.SqlDataAdapter("select Sales_Quotation_Code from Sales_Quotation_Head where UID = '" & Trim(txt_UID.Text) & "' and not sales_quotation_code = '" & NewCode & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub txt_ConfirmedBy_TextChanged(sender As Object, e As EventArgs) Handles txt_ConfirmedBy.TextChanged
    ...
    Private Sub txt_FinalRate_TextChanged(sender As Object, e As EventArgs) Handles txt_FinalRate.TextChanged

    End Sub

    Private Sub cbo_MaterialbyCustomer_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_MaterialbyCustomer.SelectedIndexChanged

    End Sub

    Private Sub txt_UID_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_PaymentTerms.SelectedIndexChanged
    ...
    Private Sub cbo_PreparedBy_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_PreparedBy.SelectedIndexChanged
    ...
    Private Sub txt_NoOfSequins_TextChanged(sender As Object, e As EventArgs) Handles txt_NoOfSequins.TextChanged

    End Sub

    Private Sub txt_ThColCnt_TextChanged(sender As Object, e As EventArgs) Handles txt_ThColCnt.TextChanged
    ...
    Private Sub cbo_RejectionAllowance_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_RejectionAllowance.SelectedIndexChanged

    End Sub

    Private Sub cbo_RejectionAllowance_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_RejectionAllowance.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_RejectionAllowance, txt_NoOfSequins, chk_Material, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_RejectionAllowance_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_RejectionAllowance.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_RejectionAllowance, chk_Material, "", "", "", "")
    End Sub
    ...
    Private Sub lbl_JobNo_Click(sender As Object, e As EventArgs) Handles lbl_JobNo.Click
