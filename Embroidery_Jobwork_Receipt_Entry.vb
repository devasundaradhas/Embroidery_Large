Public Class Embroidery_Jobwork_Receipt_Entry
    ...
    Private Pk_Condition As String = "EMJRC-"
    ...
    Private Sub clear()
        ...
        txt_Grid_Design.Enabled = True
        txt_Grid_Design.BackColor = Color.White
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName from Embroidery_Jobwork_Receipt_Head a INNER JOIN lEDGER_Head b on a.ledger_IdNo = b.Ledger_IdNo where a.Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "' ", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_DcNo.Text = dt1.Rows(0).Item("Embroidery_Jobwork_Receipt_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Embroidery_Jobwork_Receipt_Date").ToString
                ...
                If Not IsDBNull(dt1.Rows(0).Item("IsBillable")) Then
                    chk_Billable.Checked = dt1.Rows(0).Item("IsBillable")
                End If

                If Not IsDBNull(dt1.Rows(0).Item("Non_Billable_Reason")) Then
                    txt_Reason_Not_Invoicable.Text = dt1.Rows(0).Item("Non_Billable_Reason")
                End If

            End If

            da2 = New SqlClient.SqlDataAdapter("select a.* from Embroidery_Jobwork_Receipt_Details a where a.Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
            dt2 = New DataTable
            da2.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Details.Rows(n).Cells(11).Value = dt2.Rows(i).Item("Order_Code").ToString
                    dgv_Details.Rows(n).Cells(12).Value = dt2.Rows(i).Item("Order_No").ToString
                    dgv_Details.Rows(n).Cells(13).Value = dt2.Rows(i).Item("Order_Date").ToString
                    dgv_Details.Rows(n).Cells(14).Value = dt2.Rows(i).Item("Embroidery_Jobwork_Receipt_Detail_Slno").ToString
                    dgv_Details.Rows(n).Cells(15).Value = Val(dt2.Rows(i).Item("Invoice_Quantity").ToString)

                    If Not IsDBNull(dt2.Rows(i).Item("Receipt_Type")) Then
                        dgv_Details.Rows(n).Cells(16).Value = dt2.Rows(i).Item("Receipt_Type").ToString
                    End If
            ...
            If LockSTS = True Then
                ...
                txt_Grid_Design.Enabled = False
                txt_Grid_Design.BackColor = Color.LightGray
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Delivery_Quantity) from Embroidery_Jobwork_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        ...
        Try
            ...
            cmd.CommandText = "delete from Embroidery_Jobwork_Receipt_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Embroidery_Jobwork_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Embroidery_Jobwork_Receipt_No from Embroidery_Jobwork_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Embroidery_Jobwork_Receipt_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select Embroidery_Jobwork_Receipt_No from Embroidery_Jobwork_Receipt_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Embroidery_Jobwork_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Embroidery_Jobwork_Receipt_No from Embroidery_Jobwork_Receipt_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Embroidery_Jobwork_Receipt_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select Embroidery_Jobwork_Receipt_No from Embroidery_Jobwork_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Embroidery_Jobwork_Receipt_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Embroidery_Jobwork_Receipt_Head", "Embroidery_Jobwork_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Embroidery_Jobwork_Receipt_No from Embroidery_Jobwork_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "'"
            dr = cmd.ExecuteReader
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Not chk_Billable.Checked Then
            IsBillable = "0"
            Dim C As Integer = MsgBox("This Goods Delivery has been marked as 'NOT - BILLABLE'. Are you sure to contine ?", vbYesNo)
            If C = vbNo Then
                Exit Sub
            End If
        Else
        ...
        Try
            ...
            Else
                ...
                lbl_DcNo.Text = Common_Procedures.get_MaxCode(con, "Embroidery_Jobwork_Receipt_Head", "Embroidery_Jobwork_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Embroidery_Jobwork_Receipt_Head (    Embroidery_Jobwork_Receipt_Code     ,       Ledger_IdNo              ,           Company_IdNo            ,       Embroidery_Jobwork_Receipt_No           ,         for_OrderBy       ,    Embroidery_Jobwork_Receipt_Date    ,       Total_Qty            ,       Gross_Amount           ,           Remarks              , Party_DC_No                ,IsBillable         ,Non_Billable_Reason) " &
                                                      " Values (                     '" & Trim(NewCode) & "'            ,     " & Str(Val(Led_ID)) & "   , " & Str(Val(lbl_Company.Tag)) & " , '" & Trim(lbl_DcNo.Text) & "'                 , " & Str(Val(vforOrdby)) & ",   @Sales_DeliveryDate                 ," & Str(Val(vTotPcs)) & "  ," & Str(Val(vTotAmt)) & "     ,'" & Trim(txt_Remarks.Text) & "','" & txt_PartyDCNo.Text & "', " & IsBillable & ",'" & txt_Reason_Not_Invoicable.Text & "')"
                cmd.ExecuteNonQuery()
            Else
                cmd.CommandText = "Update Embroidery_Jobwork_Receipt_Head set  Embroidery_Jobwork_Receipt_Date = @Sales_DeliveryDate, Ledger_IdNo=" & Str(Val(Led_ID)) & " , Total_Qty=" & Str(Val(vTotPcs)) & ", Gross_Amount=" & Str(Val(vTotAmt)) &
                    ", Remarks='" & Trim(txt_Remarks.Text) & "',Party_DC_No = '" & txt_PartyDCNo.Text & "',IsBillable = " & IsBillable & ",Non_Billable_Reason = '" & txt_Reason_Not_Invoicable.Text & "'  Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "'"
                cmd.ExecuteNonQuery()

            End If

            cmd.CommandText = "Delete from Embroidery_Jobwork_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "' and Invoice_Quantity = 0 "
            cmd.ExecuteNonQuery()
            Dim NR As Integer = 0
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(8).Value) <> 0 Then
                        ...
                        If Led_ID <> 0 Then
                            ...
                            Sno = Sno + 1
                            cmd.CommandText = "Update Embroidery_Jobwork_Receipt_Details set Embroidery_Jobwork_Receipt_Date = @Sales_DeliveryDate,  Ledger_IdNo = " & Str(Val(Led_ID)) & ",  Sl_No = " & Str(Val(Sno)) & ",Order_No = '" & Trim(.Rows(i).Cells(11).Value) & "',Item_Description = '" & Trim(.Rows(i).Cells(2).Value) & "', Colour_Idno = " & Val(Clr_ID) & ", Size_Idno = " & Val(Siz_ID) & ", Quantity = " & Str(Val(.Rows(i).Cells(8).Value)) & ",Rate =" & Str(Val(.Rows(i).Cells(9).Value)) & ",Amount = " & Str(Val(.Rows(i).Cells(10).Value)) & ",Ordercode_forSelection = '" & Trim(.Rows(i).Cells(1).Value) & "',Order_Code = '" & Trim(.Rows(i).Cells(12).Value) & "',Order_Date = '" & Trim(.Rows(i).Cells(13).Value) & "',Receipt_Type = '" & Trim(.Rows(i).Cells(16).Value) & "'  where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "' and Embroidery_Jobwork_Receipt_Detail_Slno = " & Str(Val(.Rows(i).Cells(14).Value))
                            NR = cmd.ExecuteNonQuery()

                            If NR = 0 Then
                                cmd.CommandText = "Insert into Embroidery_Jobwork_Receipt_Details ( Embroidery_Jobwork_Receipt_Code     ,       Company_IdNo                ,          Embroidery_Jobwork_Receipt_No                    ,        for_OrderBy  , Embroidery_Jobwork_Receipt_Date,          Ledger_IdNo    ,        Sl_No         ,          Order_No            ,        Item_Description        ,   Colour_Idno         ,    Size_Idno           ,                  Quantity                     ,       Rate                                ,                      Amount           , Ordercode_forSelection                  ,        Order_Code                     ,                 Order_Date                         ,Receipt_Type ) " &
                                                                        " Values                  ('" & Trim(NewCode) & "'              ," & Str(Val(lbl_Company.Tag)) & "  , '" & Trim(lbl_DcNo.Text) & "', " & Str(Val(vforOrdby)) & ", @Sales_DeliveryDate  , " & Str(Val(Led_ID)) & "      , " & Str(Val(Sno)) & ", '" & Trim(.Rows(i).Cells(11).Value) & "','" & Trim(.Rows(i).Cells(2).Value) & "'," & Val(Clr_ID) & " , " & Val(Siz_ID) & "   , " & Str(Val(.Rows(i).Cells(8).Value)) & ",  " & Str(Val(.Rows(i).Cells(9).Value)) & " ," & Str(Val(.Rows(i).Cells(10).Value)) & " ,'" & Trim(.Rows(i).Cells(1).Value) & "' ,'" & Trim(.Rows(i).Cells(12).Value) & "'           ,'" & Trim(.Rows(i).Cells(13).Value) & "'             , '" & Trim(.Rows(i).Cells(16).Value) & "')"
                                cmd.ExecuteNonQuery()
                            End If
                        End If
    ...
    Private Sub btn_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Add.Click
        ...
        If Val(txt_NoOfPcs.Text) = 0 Then
            ...
            Exit Sub
        End If
        If Len(Trim(cbo_ReceiptType.Text)) = 0 Then
            MessageBox.Show("Invalid Delivery Type", "DOES NOT ADD...", MessageBoxButtons.OK)
            If cbo_ReceiptType.Enabled Then cbo_ReceiptType.Focus()
            Exit Sub
        End If
        MtchSTS = False
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(16).Value = cbo_ReceiptType.Text
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(16).Value = cbo_ReceiptType.Text
    ...
    '        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Embroidery_Jobwork_Receipt_Details", "Design", "", "")
    '    End With
    ...
    '    Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, txt_Grid_Design, Cbo_OrderCode, cbo_colour, "Embroidery_Jobwork_Receipt_Details", "Design", "", "")
    ...
    '    Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, txt_Grid_Design, cbo_colour, "Embroidery_Jobwork_Receipt_Details", "Design", "", "", False)
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        lbl_Grid_Order_Code.Text = Trim(.Rows(i).Cells(12).Value)
                        lbl_Grid_OrderDate.Text = Val(.Rows(i).Cells(13).Value)
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.Embroidery_Jobwork_Receipt_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = " a.Embroidery_Jobwork_Receipt_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.Embroidery_Jobwork_Receipt_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            End If
            da = New SqlClient.SqlDataAdapter("select a.*,a.Embroidery_Jobwork_Receipt_No, a.Embroidery_Jobwork_Receipt_Date , a.Ledger_IdNo as LEd_Id from Embroidery_Jobwork_Receipt_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Embroidery_Jobwork_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Embroidery_Jobwork_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Embroidery_Jobwork_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Embroidery_Jobwork_Receipt_Date").ToString), "dd-MM-yyyy")
            ...
            'Embroidery_Jobwork_Receipt_Code, Ledger_IdNo, Company_IdNo, Embroidery_Jobwork_Receipt_No, for_OrderBy, Embroidery_Jobwork_Receipt_Date, Shift, Machine_IdNo, Operator_IdNo, Framer_IdNo, Total_Heads, Total_Stchs, Total_Pcs, Total_Amt
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If pnl_InputDetails.Enabled = True And txt_SlNo.Enabled = True Then
            ...
            If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
                ...
                cbo_ReceiptType.Text = dgv_Details.CurrentRow.Cells(16).Value
    ...
    Private Sub printing_invoice()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, b.Ledger_Address1, b.Ledger_Address2, b.Ledger_Address3, b.Ledger_Address4, b.Ledger_TinNo from Embroidery_Jobwork_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code from Embroidery_Jobwork_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  LEFT OUTER JOIN State_Head Lsh ON b.State_Idno = Lsh.State_IdNo INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo  LEFT OUTER JOIN State_Head Csh ON c.Company_State_IdNo = csh.State_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "'", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.* from Embroidery_Jobwork_Receipt_Details a  where a.Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Embroidery_Jobwork_Receipt_No", con)
...
LOOP1:
    ...
    Private Sub Printing_Format3_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Embroidery_Jobwork_Receipt_Head a  INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Embroidery_Jobwork_Receipt_Code = '" & Trim(EntryCode) & "'  Order by a.For_OrderBy", con)
        da2.Fill(dt2)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Embroidery_Jobwork_Receipt_No").ToString, LMargin + C1 + W1 - 20, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 - 30, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Embroidery_Jobwork_Receipt_Date").ToString), "dd-MM-yyyy").ToString & " - " & Format(Now, "hh:mm tt"), LMargin + C1 + W1 - 20, CurY, 0, 0, pFont)
    ...
    Public Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Size_Name from Embroidery_Jobwork_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Size_Head c on a.size_idno = c.size_idno where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Embroidery_Jobwork_Receipt_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        da2.Fill(dt2)
        If dt2.Rows.Count > NoofItems_PerPage Then
            Common_Procedures.Print_To_PrintDocument(e, "Page : " & Trim(Val(PageNo)), PageWidth - 10, CurY - TxtHgt, 1, 0, pFont)
        End If
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Embroidery_Jobwork_Receipt_No").ToString, LMargin + Cen1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Embroidery_Jobwork_Receipt_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + W2 + 30, CurY + Yinc, 0, 0, pFont)
    ...
    Private Sub btn_Selection_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '    Da = New SqlClient.SqlDataAdapter("select a.*, b.Item_name, e.Size_Name, f.Noof_Items as Ent_Sales_Delivery_Quantity, f.Rate as Ent_Rate, f.Embroidery_Jobwork_Receipt_Detail_Slno as Ent_Sales_Delivery_SlNo from Sales_Delivery_Order_Details a INNER JOIN Item_Head b ON a.Item_idno = b.Item_idno  LEFT OUTER JOIN Size_Head e ON a.Size_IdNo = e.Size_IdNo LEFT OUTER JOIN Embroidery_Jobwork_Receipt_Details F ON f.Embroidery_Jobwork_Receipt_Code = '" & Trim(NewCode) & "' and f.Entry_Type = '" & Trim(cbo_EntType.Text) & "' and a.Sales_Delivery_Order_Code = f.Sales_Delivery_Order_Code and a.Sales_Delivery_Order_Detail_SlNo = f.Sales_Delivery_Order_Detail_SlNo Where a.ledger_idno = " & Str(Val(LedIdNo)) & " and ( (a.Noof_Items  - a.Sales_Delivery_Items ) > 0 or f.Noof_Items > 0 ) Order by a.For_OrderBy, a.Sales_Delivery_Order_No, a.Sales_Delivery_Order_Detail_SlNo", con)
        '    Dt1 = New DataTable
        '    Da.Fill(Dt1)
                ...
                ElseIf keyData = Keys.Up Then
                    ...
                    If .CurrentCell.ColumnIndex <= 4 Then
                        If .CurrentCell.RowIndex = 0 Then
                            If pnl_InputDetails.Enabled = True And txt_Grid_Design.Enabled = True Then
    ...
    Private Sub Cbo_OrderCode_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Cbo_OrderCode.GotFocus
        ...
        Try
            ...
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Order_Program_Head", "Ordercode_forSelection", "", "(Close_Status = 0)")
    ...
    Private Sub Cbo_OrderCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Cbo_OrderCode.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_OrderCode, txt_SlNo, Nothing, "Order_Program_Head", "Ordercode_forSelection", "", "(Close_Status = 0)")
    ...
    Private Sub Cbo_OrderCode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Cbo_OrderCode.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, Cbo_OrderCode, Nothing, "Order_Program_Head", "Ordercode_forSelection", "", "(Close_Status = 0)")
    ...
    Private Sub Cbo_OrderCode_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Cbo_OrderCode.LostFocus
        ...
        If Trim(UCase(Cbo_OrderCode.Text)) <> "" Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                End If
                If IsDBNull(dt.Rows(0)("Order_Program_Code").ToString) = False Then
                    lbl_Grid_Order_Code.Text = dt.Rows(0)("Order_Program_Code").ToString
                End If
            End If
            dt.Dispose()
            da.Dispose()
    ...
    Private Sub txt_PartyDCNo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_PartyDCNo.TextChanged
    ...
    Private Sub QuantityDetails()
        ...
        t1.Text = Common_Procedures.get_FieldValue(con, "Embroidery_Jobwork_Delivery_Details", "sum(Quantity)", "OrderCode_forSelection = '" & Cbo_OrderCode.Text & "' and Embroidery_Jobwork_Delivery_Code Like 'EMJDC-%' " &
                                                   " and Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text), Common_Procedures.CompIdNo)

        t2.Text = Common_Procedures.get_FieldValue(con, "Embroidery_Jobwork_Delivery_Details", "sum(Quantity)", "OrderCode_forSelection = '" & Cbo_OrderCode.Text & "' and Embroidery_Jobwork_Delivery_Code Like 'EMJDC-%' " &
                                                   " AND Colour_IdNo = '" & Common_Procedures.Colour_NameToIdNo(con, cbo_colour.Text) & "' and Size_IdNo = '" & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text) & " '" &
                                                   " and Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text), Common_Procedures.CompIdNo)

        s1.Text = Common_Procedures.get_FieldValue(con, "Embroidery_Jobwork_Receipt_Details", "sum(Quantity)", "OrderCode_forSelection = '" & Cbo_OrderCode.Text & "' and Embroidery_Jobwork_Receipt_Code Like 'EMJRC--%' " &
                                                           " AND NOT Embroidery_Jobwork_Receipt_CODE = '" & Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode) & "' " &
                                                   " and Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text), Common_Procedures.CompIdNo)

        s2.Text = Common_Procedures.get_FieldValue(con, "Embroidery_Jobwork_Receipt_Details", "sum(Quantity)", "OrderCode_forSelection = '" & Cbo_OrderCode.Text & "' and Embroidery_Jobwork_Receipt_Code Like 'EMJRC-%' " &
                                                           " AND Colour_IdNo = '" & Common_Procedures.Colour_NameToIdNo(con, cbo_colour.Text) & "' and Size_IdNo = '" & Common_Procedures.Size_NameToIdNo(con, cbo_Size.Text) & "' " &
                                                           " AND NOT Embroidery_Jobwork_Receipt_CODE = '" & Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_DcNo.Text) & "/" & Trim(Common_Procedures.FnYearCode) & "' " &
                                                   " and Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text), Common_Procedures.CompIdNo)
    ...
    Private Sub txt_Grid_Design_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub chk_Billable_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chk_Billable.CheckedChanged
    ...
    Private Sub cbo_DeliveryType_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_ReceiptType.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ReceiptType, Nothing, "", "", "", "")
        If Len(Trim(cbo_ReceiptType.Text)) > 0 Then
            If Asc(e.KeyChar) = 13 Then
                btn_Add_Click(sender, e)
            End If
