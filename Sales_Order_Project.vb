Public Class Sales_Order_Project
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                chk_CloseStatus.Checked = False
                chk_CloseStatus.BackColor = Color.Transparent
                If Val(dt1.Rows(0).Item("Order_Close").ToString) = 1 Then
                    chk_CloseStatus.Checked = True
                    chk_CloseStatus.BackColor = Color.Pink
                End If
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Order_Selection_Code_Head where  Reference_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Close_Sts = 0
        If chk_CloseStatus.Checked = True Then
            Close_Sts = 1
        End If
        ...
        Try
            ...
            Sales_OrderSelection_Code = Trim(lbl_InvoiceNo.Text) & "/" & Trim(Common_Procedures.FnYearCode) & "/" & Trim(Val(lbl_Company.Tag)) & "-ORD"
    ...
    Private Sub cbo_ItemName_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemName.GotFocus
        ...
        With cbo_ItemName
            ...
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Item_Head", "Item_Name", "Job_Work_Status =1", "(Item_IdNo = 0)")
        End With
    ...
    Private Sub cbo_ItemName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_ItemName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_ItemName, txt_VechileNo, Nothing, "Item_Head", "Item_Name", "Job_Work_Status = 1", "(Item_IdNo = 0)")
    ...
    Private Sub cbo_ItemName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ItemName.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ItemName, Nothing, "Item_Head", "Item_Name", " Job_Work_Status = 1", "(Item_IdNo = 0)")
