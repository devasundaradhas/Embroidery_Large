...
Public Class Invoice_Embroidery_Pcs_JobWork
    ...
    Private Pk_Condition As String = "GINEJ-"
    ...
    Private AcPos_Id As Integer = 0
    Private vVouPos_IdNos As String = ""
    Private vVouPos_Amts As String = ""
    Private vVouPos_ErrMsg As String = ""
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                txt_PartyDCNo.Text = dt1.Rows(0).Item("Vehicle_No").ToString
                ...
                chk_AgainstFormH.Checked = IIf(Val(dt1.Rows(0).Item("Form_H_Status").ToString) <> 0, True, False)
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            dgv_Details.Rows(n).Cells(9).Value = dt2.Rows(i).Item("Embroidery_Jobwork_Invoice_Details_SlNo").ToString
                            dgv_Details.Rows(n).Cells(10).Value = dt2.Rows(i).Item("Embroidery_Jobwork_Receipt_Code").ToString
                            dgv_Details.Rows(n).Cells(11).Value = dt2.Rows(i).Item("Embroidery_Jobwork_Receipt_Detail_SlNo").ToString
    ...
    Private Sub Invoice_Embroidery_Pcs_JobWork_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Invoice_Embroidery_Pcs_JobWork_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1201" Or Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1117" Then  '--- SWASTHICK KNITT (Tirupur ) Embroidery
            txt_Party_DC_No.Text = "Party Dc.No"
        End If
        ...
        AddHandler txt_PartyInvoiceNo.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_PartyInvoiceNo.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_PartyInvoiceNo.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_PartyInvoiceNo.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Private Sub Invoice_Embroidery_Pcs_JobWork_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Invoice_Embroidery_Pcs_JobWork_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.ExecuteNonQuery()
            cmd.CommandText = "Delete from Sales_GST_Tax_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Embroidery_Jobwork_Invoice_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If Len(Trim(txt_BillNo.Text)) = 0 Then
            MsgBox("Enter Supplier's Invoice Number.")
            Exit Sub
        End If
        ...
        Try
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Trim(dgv_Details.Rows(i).Cells(1).Value) <> "" Or Val(dgv_Details.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Embroidery_Jobwork_Invoice_Details ( Embroidery_Jobwork_Invoice_Code,            Company_IdNo          ,              Embroidery_Jobwork_Invoice_No             ,                                              for_OrderBy                   , Embroidery_Jobwork_Invoice_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo      , ItemGroup_IdNo             ,      Dc_No                    ,                            Noof_Items                 ,                 Rate_1000Stitches                   ,    Rate                             ,             Quantity                  ,      Amount                                 ,   Total_Amount                             ,                    Entry_Type       ,                  Embroidery_Jobwork_Receipt_Code ,            Embroidery_Jobwork_Receipt_Detail_SlNo,       Cash_Discount_Perc_For_All_Item    ,       Cash_Discount_Amount_For_All_Item  ,              Assessable_Value            ,                      HSN_Code           ,                      Tax_Perc           , Details_Design                          , Design_Picture   ,    Colour_IdNo      ,     Size_IdNo         , OrderCode_Forselection) " & _
                                                " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @SalesDate, " & Str(Val(led_id)) & ", " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & "," & Str(Val(itm_GrpId)) & ",'" & Trim(.Rows(i).Cells(3).Value) & "' , " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & "," & Str(Val(.Rows(i).Cells(6).Value)) & ", " & Str(Val(.Rows(i).Cells(7).Value)) & ", " & Str(Val(.Rows(i).Cells(8).Value)) & "," & Str(Val(.Rows(i).Cells(8).Value)) & " , '" & Trim(cbo_EntType.Text) & "' ,'" & Trim(.Rows(i).Cells(10).Value) & "' ,  " & Str(Val(.Rows(i).Cells(11).Value)) & ", " & Str(Val(.Rows(i).Cells(12).Value)) & ", " & Str(Val(.Rows(i).Cells(13).Value)) & ", " & Str(Val(.Rows(i).Cells(14).Value)) & ", '" & Trim(.Rows(i).Cells(15).Value) & "', " & Str(Val(.Rows(i).Cells(16).Value)) & " ,  '" & Trim(.Rows(i).Cells(17).Value) & "' , @photo            ,  " & Val(Clr_id) & "  , " & Val(Sz_id) & " ,'" & Trim(.Rows(i).Cells(2).Value) & "'  )"
                        cmd.ExecuteNonQuery()
                        '   End If

                        If Trim(UCase(cbo_EntType.Text)) = "DELIVERY" Then

                            cmd.CommandText = "Update Sales_Delivery_Details Set Receipt_Quantity = Receipt_Quantity + " & Str(Val(.Rows(i).Cells(7).Value)) & " where Embroidery_Jobwork_Receipt_Code = '" & Trim(.Rows(i).Cells(10).Value) & "' and Embroidery_Jobwork_Receipt_Detail_SlNo = " & Str(Val(.Rows(i).Cells(11).Value)) & " and Ledger_IdNo = " & Str(Val(led_id))
                            nr = cmd.ExecuteNonQuery()
            ...
            With dgv_GSTTax_Details
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Or Val(.Rows(i).Cells(6).Value) <> 0 Or Val(.Rows(i).Cells(8).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Jobwork_Invoice_GST_Tax_Details   (        Jobwork_Invoice_Code      ,               Company_IdNo       ,                Jobwork_Invoice_No           ,                               for_OrderBy                                  , Jobwork_Invoice_Date ,         Ledger_IdNo     ,            Sl_No     ,                    HSN_Code            ,                      Taxable_Amount      ,                      CGST_Percentage     ,                      CGST_Amount         ,                      SGST_Percentage      ,                      SGST_Amount         ,                      IGST_Percentage     ,                      IGST_Amount          ) " &
            ...
            vVouPos_IdNos = AcPos_Id & "|" & purcac_id & "|25|26|27"

            vVouPos_Amts = CSng(lbl_NetAmount.Text) & "|" & -1 * (CSng(lbl_NetAmount.Text) - CSng(lbl_CGstAmount.Text) - CSng(lbl_SGstAmount.Text) - CSng(lbl_IGstAmount.Text)) & "|" & -1 * CSng(lbl_CGstAmount.Text) & "|" & -1 * CSng(lbl_SGstAmount.Text) & "|" & -1 * CSng(lbl_IGstAmount.Text)

            If Common_Procedures.Voucher_Updation(con, "Gst.Purc", Val(lbl_Company.Tag), Trim(Pk_Condition) & Trim(NewCode), Trim(lbl_InvoiceNo.Text), dtp_Date.Value.Date, "Bill No : " & Trim(txt_PartyInvoiceNo.Text), vVouPos_IdNos, vVouPos_Amts, vVouPos_ErrMsg, tr) = False Then
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(2).Value = cbo_OrderNo.Text
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(2).Value = cbo_OrderNo.Text
    ...
    Private Sub cbo_ItemName_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_ItemName.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_ItemName, txt_PartyDCNo, cbo_OrderNo, "Item_Head", "Item_Name", "", "(Item_IdNo = 0)")
    ...
    Private Sub cbo_ItemName_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ItemName.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ItemName, cbo_OrderNo, "Item_Head", "Item_Name", "", "(Item_IdNo = 0)")
    ...
    Private Sub txt_SlNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_SlNo.KeyDown
        ...
        If e.KeyCode = 38 Then e.Handled = True : txt_PartyDCNo.Focus()
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select a.Embroidery_Jobwork_Invoice_No, a.Embroidery_Jobwork_Invoice_Date, a.Total_Qty, a.Net_Amount, b.Ledger_Name from Embroidery_Jobwork_Invoice_Head a " & _
                                              " INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & _
                                              " and a.Embroidery_Jobwork_Invoice_Code LIKE '" & Trim(Pk_Condition) & "%/" & Trim(Common_Procedures.FnYearCode) & "' " & _
                                              " and a.Embroidery_Jobwork_Invoice_Code LIKE '" & Pk_Condition & "%' " & _
                                              IIf(Trim(Condt) <> "", " and ", "") & _
                                              Condt & " Order by a.for_orderby, a.Embroidery_Jobwork_Invoice_No", con)
            da.Fill(dt2)
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If pnl_InputDetails.Enabled = True And txt_SlNo.Enabled = True Then
            ...
            If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
                ...
                txt_SlNo.Text = Val(dgv_Details.CurrentRow.Cells(0).Value)
                cbo_ItemName.Text = Trim(dgv_Details.CurrentRow.Cells(1).Value)
                cbo_OrderNo.Text = Trim(dgv_Details.CurrentRow.Cells(2).Value)
                ...
                If prn_HdDt.Rows.Count > 0 Then
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        For I = 0 To prn_DetDt.Rows.Count - 1
                            ...
                            If Not IsDBNull(prn_DetDt.Rows(I).Item("Order_No")) Then
                                If Len(Trim(prn_DetDt.Rows(I).Item("Order_No"))) > 0 Then
                                    ItmNm1 = ItmNm1 & "(Order No : " & Trim(prn_DetDt.Rows(I).Item("Order_No")) & ")"
                                End If
                            End If
...
LOOP1:
        ...
        With dgv_Selection
            ...
            If Dt1.Rows.Count > 0 Then
                ...
                For i = 0 To Dt1.Rows.Count - 1
                    ...
                    End If
                    .Rows(n).Cells(13).Value = Dt1.Rows(i).Item("Embroidery_Jobwork_Receipt_Code").ToString
                    .Rows(n).Cells(14).Value = Val(Dt1.Rows(i).Item("Embroidery_Jobwork_Receipt_Detail_SlNo").ToString)
    ...
    Private Sub cbo_TaxType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TaxType.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TaxType, txt_PartyInvoiceNo, cbo_ItemName.Text, "", "", "", "")
    ...
    Private Sub cbo_PaymentMethod_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PaymentMethod.KeyDown
        ...
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PaymentMethod, Nothing, txt_PartyDCNo, "", "", "", "")

            If (e.KeyValue = 38 And cbo_PaymentMethod.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then

                txt_Party_DC_No.Focus()
    ...
    Private Sub cbo_PaymentMethod_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PaymentMethod.KeyPress
        ...
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PaymentMethod, txt_PartyDCNo, "", "", "", "")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
        End Try
    End Sub
...
LOOP1:
    ...
    Private Sub Printing_GST_HSN_Details_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByRef CurY As Single, ByVal LMargin As Integer, ByVal PageWidth As Integer, ByVal PrintWidth As Double, ByVal LnAr As Single)
        ...
        Try
            ...
            Da = New SqlClient.SqlDataAdapter("Select * from Sales_GST_Tax_Details Where Embroidery_Jobwork_Invoice_Code = '" & Trim(EntryCode) & "'", con)
            Dt = New DataTable
            Da.Fill(Dt)
    ...
    Private Sub cbo_OrderNo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_OrderNo.GotFocus
        Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Order_Program_head", "Ordercode_forSelection", "not Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text) & IIf(Len(Order_Disp_Cond) > 0, " and " & Order_Disp_Cond, ""), "")
    End Sub
    ...
    Private Sub cbo_OrderNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_OrderNo.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_OrderNo, cbo_ItemName, txt_DetailsDesign, "Order_Program_head", "Ordercode_forSelection", "not Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text) & IIf(Len(Order_Disp_Cond) > 0, " and " & Order_Disp_Cond, ""), "")

        If (e.KeyValue = 40 And cbo_OrderNo.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            If Trim(cbo_OrderNo.Text) <> "" Then
    ...
    Private Sub cbo_OrderNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_OrderNo.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_OrderNo, txt_DetailsDesign, "Order_Program_head", "Ordercode_forSelection", " not Ledger_IdNo = " & Common_Procedures.Ledger_AlaisNameToIdNo(con, cbo_Ledger.Text) & IIf(Len(Order_Disp_Cond) > 0, " and " & Order_Disp_Cond, ""), "")

        If Asc(e.KeyChar) = 13 Then
            If Trim(UCase(cbo_OrderNo.Tag)) <> Trim(UCase(cbo_OrderNo.Text)) Then
                'get_Item_Unit_Rate_TaxPerc()
            End If
            If Trim(cbo_OrderNo.Text) <> "" Then
                txt_DetailsDesign.Focus()
    ...
    Private Sub cbo_OrderNo_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_OrderNo.LostFocus
        ...
        If Trim(UCase(cbo_OrderNo.Text)) <> "" Then

            da = New SqlClient.SqlDataAdapter("select a.* from Order_Program_Head a where a.Ordercode_forSelection = '" & Trim(cbo_OrderNo.Text) & "'", con)
            dt = New DataTable
            da.Fill(dt)
 ...
 Private Sub QuantityDetails()
        ...
        t1.Text = Common_Procedures.get_FieldValue(con, "Embroidery_Jobwork_Receipt_Details", "sum(Quantity)", "OrderCode_forSelection = '" & cbo_OrderNo.Text & "' and Embroidery_Jobwork_Receipt_Code Like 'EMJRC-%' ", Common_Procedures.CompIdNo)

        t2.Text = Common_Procedures.get_FieldValue(con, "Embroidery_Jobwork_Receipt_Details", "sum(Quantity)", "OrderCode_forSelection = '" & cbo_OrderNo.Text & "' and Embroidery_Jobwork_Receipt_Code Like 'EMJRC-%' " & _
        ...
        s1.Text = Common_Procedures.get_FieldValue(con, "Embroidery_Jobwork_Invoice_Details", "sum(Quantity)", "OrderCode_forSelection = '" & cbo_OrderNo.Text & "' and Embroidery_Jobwork_Invoice_Code Like 'GINEJ-%' " & _
                                                          " AND NOT Embroidery_Jobwork_Invoice_CODE = '" & Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_InvoiceNo.Text) & "/" & Trim(Common_Procedures.FnYearCode) & "'", Common_Procedures.CompIdNo)

        s2.Text = Common_Procedures.get_FieldValue(con, "Embroidery_Jobwork_Invoice_Details", "sum(Quantity)", "OrderCode_forSelection = '" & cbo_OrderNo.Text & "' and Embroidery_Jobwork_Invoice_Code Like 'GINEJ-%' " & _
    ...
    Private Sub cbo_OrderNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_OrderNo.SelectedIndexChanged
        QuantityDetails()
    End Sub
    ...
    Private Sub txt_DetailsDesign_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_DetailsDesign.LostFocus
        QuantityDetails()
    End Sub
