Public Class Embroidery_Receipt_Entry
    ...
    Private Pk_Condition As String = "EMREC-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName from Simple_Receipt_Head a INNER JOIN LEDGER_Head b on a.ledger_IdNo = b.Ledger_IdNo " &
                                               " where a.Simple_Receipt_Code = '" & Trim(NewCode) & "' ", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then

                lbl_RecNo.Text = dt1.Rows(0).Item("Simple_Receipt_No").ToString
                dtp_Date.Text = dt1.Rows(0).Item("Simple_Receipt_Date").ToString
                cbo_Ledger.Text = Common_Procedures.Ledger_IdNoToName(con, Val(dt1.Rows(0).Item("Ledger_IdNo").ToString))
                txt_Remarks.Text = dt1.Rows(0).Item("Remarks").ToString
                txt_PartyRecNo.Text = dt1.Rows(0).Item("Electronic_Reference_No").ToString


                If Not IsDBNull(dt1.Rows(0).Item("Total_Bags")) Then
                    txt_NoOfBags.Text = FormatNumber(dt1.Rows(0).Item("Total_Bags"), 0, TriState.False, TriState.False, TriState.False)
                End If

                If Not IsDBNull(dt1.Rows(0).Item("Weight")) Then
                    txt_Weight.Text = FormatNumber(dt1.Rows(0).Item("Weight"), 3, TriState.False, TriState.False, TriState.False)
                End If
            ...
            da2 = New SqlClient.SqlDataAdapter("select a.*,O.Unit_IdNo AS UNIT_NO from Simple_Receipt_Details a inner join Order_Program_Head  O on a.OrderCode_forSelection = O.OrderCode_forSelection where a.Simple_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
            dt2 = New DataTable
            da2.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Details.Rows(n).Cells(12).Value = dt2.Rows(i).Item("Job_No").ToString
                    dgv_Details.Rows(n).Cells(13).Value = Common_Procedures.Component_IdNoToName(con, dt2.Rows(i).Item("Component_IdNo").ToString)
                    dgv_Details.Rows(n).Cells(14).Value = dt2.Rows(i).Item("Receipt_Purpose").ToString
                    dgv_Details.Rows(n).Cells(15).Value = dt2.Rows(i).Item("Bundles").ToString

                    If Not IsDBNull(dt2.Rows(0).Item("Unit_No")) Then
                        Unit = Common_Procedures.Unit_IdNoToName(con, dt2.Rows(0).Item("Unit_No"))
                    End If

                    dgv_Details.Rows(n).Cells(16).Value = Unit
            ...
            With dgv_Details_Total
                ...
                .Rows(0).Cells(15).Value = Format(Val(dt1.Rows(0).Item("Total_Bundles").ToString), "############0")
            End With
    ...
    Private Sub Invoice_Garments_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(Cbo_OrderCode.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "ORDER" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
                Cbo_OrderCode.Text = Trim(Common_Procedures.Master_Return.Return_Value)
            End If
    ...
    Private Sub Invoice_Garments_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        cbo_Filter_Partyname.DisplayMember = "Machine_Name"
        ...
        'AddHandler cbo_Filter_Design.GotFocus, AddressOf ControlGotFocus
        AddHandler cbo_Filter_Partyname.GotFocus, AddressOf ControlGotFocus
        'AddHandler cbo_Filter_Shift.GotFocus, AddressOf ControlGotFocus
        'AddHandler cbo_Filter_Order_No.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_Grid_Design.GotFocus, AddressOf ControlGotFocus
        AddHandler cbo_JobNumber.GotFocus, AddressOf ControlGotFocus
        AddHandler cbo_Component.GotFocus, AddressOf ControlGotFocus
        AddHandler cbo_ReceiptType.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_Grid_Design.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler cbo_ReceiptType.LostFocus, AddressOf ControlLostFocus
        ...
        dgv_Details.Columns(12).DisplayIndex = 2
        dgv_Details.Columns(13).DisplayIndex = 3
        dgv_Details.Columns(2).DisplayIndex = 4
        dgv_Details.Columns(4).DisplayIndex = 5
        dgv_Details.Columns(11).DisplayIndex = 6
        dgv_Details.Columns(3).DisplayIndex = 7
        dgv_Details.Columns(15).DisplayIndex = 8
        dgv_Details.Columns(8).DisplayIndex = 9
        dgv_Details.Columns(16).DisplayIndex = 10
        dgv_Details.Columns(14).DisplayIndex = 11

        dgv_Details_Total.Columns(12).DisplayIndex = 2
        dgv_Details_Total.Columns(13).DisplayIndex = 3
        dgv_Details_Total.Columns(2).DisplayIndex = 4
        dgv_Details_Total.Columns(4).DisplayIndex = 5
        dgv_Details_Total.Columns(11).DisplayIndex = 6
        dgv_Details_Total.Columns(3).DisplayIndex = 7
        dgv_Details_Total.Columns(15).DisplayIndex = 8
        dgv_Details_Total.Columns(8).DisplayIndex = 9
        dgv_Details_Total.Columns(16).DisplayIndex = 10
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "delete from Simple_Receipt_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()

            cmd.CommandText = "delete from Simple_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Simple_Receipt_No from Simple_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Simple_Receipt_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select Simple_Receipt_No from Simple_Receipt_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, Simple_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Simple_Receipt_No from Simple_Receipt_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Simple_Receipt_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select Simple_Receipt_No from Simple_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, Simple_Receipt_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Simple_Receipt_Head", "Simple_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Simple_Receipt_No from Simple_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code = '" & Trim(NewCode) & "'"
            dr = cmd.ExecuteReader
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        '    IsReturn = "1"
        '    Dim C As Integer = MsgBox("This Goods Receipt has been marked as 'RETURN'. Are you sure to contine ?", vbYesNo)
        '    If C = vbNo Then
        '        Exit Sub
        '    End If
        'Else
        ...
        If dgv_Details_Total.RowCount > 0 Then
            ...
            vTotBundles = Val(dgv_Details_Total.Rows(0).Cells(15).Value)
        End If
        ...
        Try
            ...
            Else
                ...
                lbl_RecNo.Text = Common_Procedures.get_MaxCode(con, "Simple_Receipt_Head", "Simple_Receipt_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            cmd.Parameters.AddWithValue("@Simple_ReceiptDate", dtp_Date.Value.Date)

            vforOrdby = Val(Common_Procedures.OrderBy_CodeToValue(lbl_RecNo.Text))

            If New_Entry = True Then

                cmd.CommandText = "Insert into Simple_Receipt_Head (    Simple_Receipt_Code     ,       Ledger_IdNo    ,           Company_IdNo            ,       Simple_Receipt_No           ,         for_OrderBy      ,    Simple_Receipt_Date    ,       Total_Qty       ,       Gross_Amount           ,           Remarks    , Electronic_Reference_No                 ,   IsReturn     ,   Total_Bundles              ,Total_Bags                             ,Weight) " &
                                                      " Values (  '" & Trim(NewCode) & "',     " & Str(Val(Led_ID)) & "   , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(vforOrdby)) & ",   @Simple_ReceiptDate    ," & Str(Val(vTotPcs)) & "," & Str(Val(vTotAmt)) & ",'" & Trim(txt_Remarks.Text) & "','" & Trim(txt_PartyRecNo.Text) & "'," & IsReturn & ", " & vTotBundles.ToString & " ," & Val(txt_NoOfBags.Text).ToString & "," & Val(txt_Weight.Text).ToString & ")"
                cmd.ExecuteNonQuery()

            Else

                cmd.CommandText = " Update Simple_Receipt_Head Set  Simple_Receipt_Date = @Simple_ReceiptDate, Ledger_IdNo=" & Str(Val(Led_ID)) &
                                  " , Total_Qty=" & Str(Val(vTotPcs)) & ", Gross_Amount=" & Str(Val(vTotAmt)) & ", Remarks='" & Trim(txt_Remarks.Text) & "' " &
                                  " ,Electronic_Reference_No =   '" & Trim(txt_PartyRecNo.Text) & "' , IsReturn = " & IsReturn &
                                  " ,Total_Bundles = " & vTotBundles.ToString & ",Total_Bags = " & Val(txt_NoOfBags.Text).ToString & ",Weight = " & Val(txt_Weight.Text).ToString &
                                  " Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " And Simple_Receipt_Code = '" & Trim(NewCode) & "'"
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Trim(.Rows(i).Cells(2).Value) <> "" Then
                        ...
                        If Led_ID <> 0 Then
                            ...
                            cmd.CommandText = "Insert into Simple_Receipt_Details ( Simple_Receipt_Code     ,       Company_IdNo              ,          Simple_Receipt_No    ,        for_OrderBy         , Simple_Receipt_Date,          Ledger_IdNo    ,        Sl_No         ,        Item_Description               ,      Colour_Idno         ,    Size_Idno           ,                  Quantity                     ,       Rate                           ,                      Amount               , Ordercode_forSelection                 ,  Order_No                                ,Job_No                                  , Bundles                                             ,Receipt_Purpose                         ,Component_IdNo                                                                         ) " &
                                                                           " Values ('" & Trim(NewCode) & "'," & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_RecNo.Text) & "', " & Str(Val(vforOrdby)) & ", @Simple_ReceiptDate, " & Str(Val(Led_ID)) & ", " & Str(Val(Sno)) & ",'" & Trim(.Rows(i).Cells(2).Value) & "'," & Val(Clr_ID) & "       , " & Val(Siz_ID) & "   , " & Str(Val(.Rows(i).Cells(8).Value)) & ",  " & Str(Val(.Rows(i).Cells(9).Value)) & " ," & Str(Val(.Rows(i).Cells(10).Value)) & " ,'" & Trim(.Rows(i).Cells(1).Value) & "' , '" & Trim(.Rows(i).Cells(11).Value) & "' ,'" & Trim(.Rows(i).Cells(12).Value) & "'," & Val(Trim(.Rows(i).Cells(15).Value)).ToString & " ,'" & Trim(.Rows(i).Cells(14).Value) & "'," & Common_Procedures.Component_NameToIdNo(con, Trim(.Rows(i).Cells(13).Value), tr) & ") "
                            cmd.ExecuteNonQuery()
    ...
    Private Sub btn_Add_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Add.Click
        ...
        If Trim(Cbo_OrderCode.Text) = "" Then
            ...
            Exit Sub
        End If
        If Trim(cbo_Grid_Design.Text) = "" Then
            MessageBox.Show("Invalid Design ", "DOES NOT ADD...", MessageBoxButtons.OK)
            If cbo_Grid_Design.Enabled Then cbo_Grid_Design.Focus()
            Exit Sub
        End If
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(2).Value = cbo_Grid_Design.Text
                    ...
                    .Rows(i).Cells(16).Value = txt_UoM.Text
                    .Rows(i).Cells(12).Value = cbo_JobNumber.Text
                    .Rows(i).Cells(13).Value = cbo_Component.Text
                    .Rows(i).Cells(14).Value = cbo_ReceiptType.Text
                    .Rows(i).Cells(15).Value = txt_Bundles.Text
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(2).Value = cbo_Grid_Design.Text
                ...
                .Rows(n).Cells(16).Value = txt_UoM.Text
                .Rows(n).Cells(12).Value = cbo_JobNumber.Text
                .Rows(n).Cells(13).Value = cbo_Component.Text
                .Rows(n).Cells(14).Value = cbo_ReceiptType.Text
                .Rows(n).Cells(15).Value = txt_Bundles.Text
    ...
    Private Sub cbo_Grid_Design_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Grid_Design.GotFocus

        cbo_Buff = cbo_Grid_Design.Text

        With cbo_Grid_Design

            vcmb_ItmNm = Trim(.Text)
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Order_Program_Head", "Design", "Order_Program_Code = '" & Cbo_OrderCode.Text & "'", "")

        End With

    End Sub

    Private Sub cbo_Grid_Design_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_Design.KeyDown

        vcbo_KeyDwnVal = e.KeyValue

        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Grid_Design, cbo_Component, cbo_Size, "Order_Program_Head", "Design", "Order_Program_Code = '" & Cbo_OrderCode.Text & "'", "")

    End Sub

    Private Sub cbo_Grid_Design_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Grid_Design.KeyPress

        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Grid_Design, cbo_Size, "Order_Program_Head", "Design", "Order_Program_Code = '" & Cbo_OrderCode.Text & "'", "", False)

    End Sub

    Private Sub cbo_Grid_Design_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Grid_Design.KeyUp
        ...
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            ...
            Common_Procedures.Master_Return.Control_Name = cbo_Grid_Design.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, msk_Date, txt_PartyRecNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = '' and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) )", "(Ledger_IdNo = 0)")
    End Sub

    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, txt_PartyRecNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(Ledger_Type = '' and (AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14) )", "(Ledger_IdNo = 0)")
    ...
    Private Sub txt_SlNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_SlNo.KeyDown
        ...
        If e.KeyCode = 38 Then e.Handled = True : txt_PartyRecNo.Focus()
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        cbo_Grid_Design.Text = Trim(dgv_Details.CurrentRow.Cells(2).Value)
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If IsDate(dtp_Filter_Fromdate.Value) = True And IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.Simple_Receipt_Date between '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' and '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_Fromdate.Value) = True Then
                Condt = " a.Simple_Receipt_Date = '" & Trim(Format(dtp_Filter_Fromdate.Value, "MM/dd/yyyy")) & "' "
            ElseIf IsDate(dtp_Filter_ToDate.Value) = True Then
                Condt = " a.Simple_Receipt_Date = '" & Trim(Format(dtp_Filter_ToDate.Value, "MM/dd/yyyy")) & "' "
            End If
            ...
            'MsgBox("select a.*,a.Simple_Receipt_No, a.Simple_Receipt_Date , a.Ledger_IdNo as LEd_Id from Simple_Receipt_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Simple_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Simple_Receipt_No")

            da = New SqlClient.SqlDataAdapter("select a.*,a.Simple_Receipt_No, a.Simple_Receipt_Date , a.Ledger_IdNo as LEd_Id from Simple_Receipt_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Simple_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Simple_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(0).Value = dt2.Rows(i).Item("Simple_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(1).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Simple_Receipt_Date").ToString), "dd-MM-yyyy")
            ...
            'Simple_Receipt_Code, Ledger_IdNo, Company_IdNo, Simple_Receipt_No, for_OrderBy, Simple_Receipt_Date, Shift, Machine_IdNo, Operator_IdNo, Framer_IdNo, Total_Heads, Total_Stchs, Total_Pcs, Total_Amt
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Panel2.Enabled = True And txt_SlNo.Enabled = True Then
            ...
            If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
                ...
                txt_NoOfPcs.Text = Val(dgv_Details.CurrentRow.Cells(8).Value)
                txt_UoM.Text = dgv_Details.CurrentRow.Cells(16).Value
                'lbl_OrderNo.Text = Trim(dgv_Details.CurrentRow.Cells(11).Value)
                cbo_JobNumber.Text = dgv_Details.CurrentRow.Cells(12).Value
                cbo_Component.Text = dgv_Details.CurrentRow.Cells(13).Value
                cbo_ReceiptType.Text = dgv_Details.CurrentRow.Cells(14).Value
                txt_Bundles.Text = dgv_Details.CurrentRow.Cells(15).Value
    ...
    Private Sub btn_Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Delete.Click
        ...
        If cbo_Grid_Design.Enabled And cbo_Grid_Design.Visible Then cbo_Grid_Design.Focus()
    ...
    Private Sub Amount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            vTotBundles = vTotBundles + Val(dgv_Details.Rows(i).Cells(15).Value())
        Next
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(15).Value = vTotBundles
    ...
    Private Sub printing_invoice()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, b.Ledger_Address1, b.Ledger_Address2, b.Ledger_Address3, b.Ledger_Address4, b.Ledger_TinNo from Simple_Receipt_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Simple_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code from Simple_Receipt_head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo  LEFT OUTER JOIN State_Head Lsh ON b.State_Idno = Lsh.State_IdNo INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo  LEFT OUTER JOIN State_Head Csh ON c.Company_State_IdNo = csh.State_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Simple_Receipt_Code = '" & Trim(NewCode) & "'", con)
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.* from Simple_Receipt_Details a  where a.Simple_Receipt_Code = '" & Trim(NewCode) & "' Order by a.for_orderby, a.Simple_Receipt_No", con)
...
LOOP1:
    ...
    Private Sub Printing_Format3_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name from Simple_Receipt_head a  INNER JOIN Ledger_Head b ON b.Ledger_IdNo = a.Ledger_Idno  where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Simple_Receipt_Code = '" & Trim(EntryCode) & "'  Order by a.For_OrderBy", con)
        da2.Fill(dt2)
        ...
        Common_Procedures.Print_To_PrintDocument(e, "RECEIPT NOTE", LMargin, CurY - TxtHgt, 2, PrintWidth, p1Font)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Simple_Receipt_No").ToString, LMargin + C1 + W1 - 20, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 - 30, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Simple_Receipt_Date").ToString), "dd-MM-yyyy").ToString & " - " & Format(Now, "hh:mm tt"), LMargin + C1 + W1 - 20, CurY, 0, 0, pFont)
            ...
            Common_Procedures.Print_To_PrintDocument(e, "PARTY REC.NO", LMargin + C1 + 10, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + C1 + W1 - 30, CurY, 0, 0, pFont)
    ...
    Public Sub Printing_Format2_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Size_Name from Simple_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Size_Head c on a.size_idno = c.size_idno where a.company_idno = " & Str(Val(lbl_Company.Tag)) & " and a.Simple_Receipt_Code = '" & Trim(EntryCode) & "' Order by a.sl_no", con)
        da2.Fill(dt2)
        If dt2.Rows.Count > NoofItems_PerPage Then
            Common_Procedures.Print_To_PrintDocument(e, "Page : " & Trim(Val(PageNo)), PageWidth - 10, CurY - TxtHgt, 1, 0, pFont)
        End If
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Simple_Receipt_No").ToString, LMargin + Cen1 + W1 + 30, CurY, 0, 0, p1Font)
            ...
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Simple_Receipt_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + W2 + 30, CurY + Yinc, 0, 0, pFont)
                ...
                ElseIf keyData = Keys.Up Then
                    ...
                    If .CurrentCell.ColumnIndex <= 4 Then
                        If .CurrentCell.RowIndex = 0 Then
                            If Panel2.Enabled = True And cbo_Grid_Design.Enabled = True Then
                                cbo_Grid_Design.Focus()
    ...
    Private Sub cbo_Size_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Size.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Size, cbo_Grid_Design, cbo_colour, "size_head", "size_name", "", "(size_idno = 0)")
    End Sub
    ...
    Private Sub cbo_colour_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_colour.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_colour, cbo_Size, txt_Bundles, "Colour_head", "Colour_name", "", "(Colour_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_colour_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_colour.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_colour, txt_Bundles, "Colour_head", "Colour_name", "", "(Colour_IdNo = 0)")
    End Sub
    ...
    Private Sub chk_Return_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'If chk_Return.Checked Then
    ...
    Private Sub cbo_JobNumber_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_JobNumber.SelectedIndexChanged
    ...
    Private Sub cbo_Component_GotFocus(sender As Object, e As EventArgs) Handles cbo_Component.GotFocus
        ...
        Try
            ...
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "Component_Head", "Component_Name", "", "(Component_IdNo = 0)")
    ...
    Private Sub cbo_Component_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_Component.KeyDown
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Component, txt_SlNo, Nothing, "Component_Head", "Component_Name", "", "(Component_IdNo = 0)")
    ...
    Private Sub cbo_Component_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_Component.KeyPress
        ...
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Component, Nothing, "Component_Head", "Component_Name", "", "(Component_IdNo = 0)")
        If Asc(e.KeyChar) = 13 Then
            If Trim(Cbo_OrderCode.Text) <> "" Then
                cbo_Size.Focus()
            Else
    ...
    Private Sub txt_Bags_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_Bundles.KeyPress
        If Common_Procedures.Accept_NumericOnly(Asc(e.KeyChar)) = 0 Then e.Handled = True
        If Asc(e.KeyChar) = 13 Then
            txt_NoOfPcs.Focus()
        End If
    ...
    Private Sub cbo_DeliveryType_KeyDown(sender As Object, e As KeyEventArgs) Handles cbo_ReceiptType.KeyDown

        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_ReceiptType, txt_NoOfPcs, Nothing, "", "", "", "")

    End Sub

    Private Sub cbo_DeliveryType_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbo_ReceiptType.KeyPress

        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ReceiptType, Nothing, "", "", "", "", False)

        If Asc(e.KeyChar) = 13 Then
            If Len(cbo_ReceiptType.Text) > 0 Then
                btn_Add_Click(sender, e)
            Else
                txt_NoOfBags.Focus()
            End If
    ...
    Private Sub cbo_JobNumber_KeyUp(sender As Object, e As KeyEventArgs) Handles cbo_JobNumber.KeyUp

        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then

            If Len(Trim(Cbo_OrderCode.Text)) > 0 Then

                Dim f As New OrderJobNo_Creation
                f.txt_OrderNo.Text = Cbo_OrderCode.Text
                Common_Procedures.Master_Return.Form_Name = Me.Name
                Common_Procedures.Master_Return.Control_Name = cbo_JobNumber.Name
                Common_Procedures.Master_Return.Return_Value = ""
                Common_Procedures.Master_Return.Master_Type = ""
            ...
            Else
                ...
                MsgBox("Enter Order Code to Create Job Number")
    ...
    Private Sub cbo_Component_KeyUp(sender As Object, e As KeyEventArgs) Handles cbo_Component.KeyUp
        ...
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            ...
            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = cbo_Component.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub cbo_DeliveryType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_ReceiptType.SelectedIndexChanged
    ...
    Private Sub txt_NoOfBags_TextChanged(sender As Object, e As EventArgs) Handles txt_NoOfBags.TextChanged
    ...
    Private Sub cbo_DeliveryType_GotFocus(sender As Object, e As EventArgs) Handles cbo_ReceiptType.GotFocus

        If Len(cbo_ReceiptType.Text) = 0 Then
            cbo_ReceiptType.Text = "Embroidery"
        End If
    ...
    Private Sub txt_VehicleNo_TextChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub txt_VehicleNo_KeyPress(sender As Object, e As KeyPressEventArgs)
        If Asc(e.KeyChar) = 13 Then
            txt_Remarks.Focus()
        End If
    End Sub

    Private Sub Cbo_OrderCode_KeyUp(sender As Object, e As KeyEventArgs) Handles Cbo_OrderCode.KeyUp
        ...
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            ...
            Common_Procedures.Master_Return.Form_Name = Me.Name
            Common_Procedures.Master_Return.Control_Name = Cbo_OrderCode.Name
            Common_Procedures.Master_Return.Return_Value = ""
            Common_Procedures.Master_Return.Master_Type = ""
    ...
    Private Sub cbo_Grid_Design_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbo_Grid_Design.SelectedIndexChanged
    ...
    Private Sub cbo_Grid_Design_LostFocus(sender As Object, e As EventArgs) Handles cbo_Grid_Design.LostFocus

        If cbo_Grid_Design.Text <> cbo_Buff Then
    ...
    Private Sub cbo_Size_LostFocus(sender As Object, e As EventArgs) Handles cbo_Size.LostFocus

        If cbo_Size.Text <> cbo_Buff Then
    ...
    Private Sub Cbo_OrderCode_Leave(sender As Object, e As EventArgs) Handles Cbo_OrderCode.Leave
        ...
        If Trim(UCase(Cbo_OrderCode.Text)) <> "" Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                End If
                cbo_Grid_Design.Text = dt.Rows(0)("Design").ToString
            End If
            ...
            If Not IsDBNull(dt.Rows(0)("Unit_IdNo")) = False Then
