Public Class SalesReturn_Entry_Simple1
    ...
    Private Pk_Condition As String = "SLRET-"
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            dgv_Details.Rows(n).Cells(7).Value = Format(Val(dt2.Rows(i).Item("Actual_Rate").ToString), "########0.00")
                            dgv_Details.Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("Actual_Amount").ToString), "########0.00")
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 SalesReturn_No from SalesReturn_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and SalesReturn_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, SalesReturn_No", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 SalesReturn_No from SalesReturn_Head where for_orderby > " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and SalesReturn_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby, SalesReturn_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select top 1 SalesReturn_No from SalesReturn_Head where for_orderby < " & Str(Val(OrdByNo)) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and SalesReturn_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, SalesReturn_No desc", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select top 1 SalesReturn_No from SalesReturn_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and SalesReturn_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' Order by for_Orderby desc, SalesReturn_No desc", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_ReturnNo.Text = Common_Procedures.get_MaxCode(con, "SalesReturn_Head", "SalesReturn_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_ReturnNo.Text = Common_Procedures.get_MaxCode(con, "SalesReturn_Head", "SalesReturn_Code", "For_OrderBy", "", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        If itm_id <> 0 Then
                            ...
                            cmd.CommandText = "Insert into SalesReturn_Details ( SalesReturn_Code,             Company_IdNo         ,               SalesReturn_No      ,         for_OrderBy        , SalesReturn_Date,          Ledger_IdNo    ,        Sl_No         ,          Item_IdNo      ,          Unit_IdNo      ,                  Serial_No             ,                 Noof_Items               ,                      Rate                ,                      Amount              ,Actual_Rate                               ,Actual_Amount ) " & _
                            ...
                            cmd.CommandText = "Insert into Item_Processing_Details (    Reference_Code    ,             Company_IdNo         ,            Reference_No           ,          for_OrderBy       , Reference_Date,          Ledger_IdNo    ,           Party_Bill_No        ,            SL_No     ,          Item_IdNo      ,           Unit_IdNo     ,                    Quantity               ) " & _
                                                    " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReturnNo.Text) & "', " & Str(Val(vforOrdby)) & ",    @SalesDate , " & Str(Val(led_id)) & ", '" & Trim(txt_BillNo.Text) & "', " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & " )"
                            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Insert into Voucher_Head (     Voucher_Code            ,          For_OrderByCode   ,             Company_IdNo         ,           Voucher_No              ,             For_OrderBy    , Voucher_Type, Voucher_Date,           Debtor_Idno  ,          Creditor_Idno     ,                Total_VoucherAmount        ,       Narration       , Indicate,       Year_For_Report                                     ,       Entry_Identification                  , Voucher_Receipt_Code ) " & _
                                " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReturnNo.Text) & "', " & Str(Val(vforOrdby)) & ", 'Sales.Ret' ,   @SalesDate, " & Str(Val(saleac_id)) & ", " & Str(Val(Ac_id)) & ", " & Str(Val(CSng(lbl_NetAmount.Text))) & ",    '" & Trim(Narr) & "',    1    , " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "',          ''          ) "
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Insert into Voucher_Details (       Voucher_Code                   ,          For_OrderByCode   ,              Company_IdNo        ,           Voucher_No              ,           For_OrderBy      , Voucher_Type, Voucher_Date, SL_No,        Ledger_IdNo     ,                       Voucher_Amount     ,      Narration      ,             Year_For_Report                               ,           Entry_Identification               ) " & _
                              "   Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReturnNo.Text) & "', " & Str(Val(vforOrdby)) & ",  'Sales.Ret',  @SalesDate ,   1  , " & Str(Val(Ac_id)) & ", " & Str(Val(CSng(lbl_NetAmount.Text))) & ", '" & Trim(Narr) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
            cmd.ExecuteNonQuery()
            ...
            cmd.CommandText = "Insert into Voucher_Details (      Voucher_Code                  ,          For_OrderByCode   ,             Company_IdNo         ,           Voucher_No              ,           For_OrderBy      , Voucher_Type, Voucher_Date, SL_No,          Ledger_IdNo       ,           Voucher_Amount ,      Narration      ,             Year_For_Report                               ,           Entry_Identification               ) " & _
                              " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReturnNo.Text) & "', " & Str(Val(vforOrdby)) & ",  'Sales.Ret',  @SalesDate ,   2  , " & Str(Val(saleac_id)) & ", " & Str(-1 * Val(Amt)) & ", '" & Trim(Narr) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
            cmd.ExecuteNonQuery()

            If Val(lbl_TaxAmount.Text) <> 0 Then
                cmd.CommandText = "Insert into Voucher_Details ( Voucher_Code                       ,      For_OrderByCode       ,         Company_IdNo             ,           Voucher_No              ,            For_OrderBy     , Voucher_Type, Voucher_Date, SL_No,          Ledger_IdNo     ,             Voucher_Amount          ,          Narration      ,             Year_For_Report                               ,           Entry_Identification               ) " & _
                                  " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReturnNo.Text) & "', " & Str(Val(vforOrdby)) & ", 'Sales.Ret' ,   @SalesDate,   3  , " & Str(Val(txac_id)) & ", " & Str(-1 * Val(lbl_TaxAmount.Text)) & ", '" & Trim(Narr) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
                cmd.ExecuteNonQuery()
            End If
            ...
            If Val(txt_AddLess.Text) <> 0 Then
                L_ID = 17
                cmd.CommandText = "Insert into Voucher_Details ( Voucher_Code                       ,      For_OrderByCode       ,         Company_IdNo             ,           Voucher_No              ,            For_OrderBy     , Voucher_Type, Voucher_Date, SL_No,       Ledger_IdNo    ,             Voucher_Amount            ,          Narration      ,             Year_For_Report                               ,           Entry_Identification               ) " & _
                                  " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReturnNo.Text) & "', " & Str(Val(vforOrdby)) & ", 'Sales.Ret' ,   @SalesDate,   4  , " & Str(Val(L_ID)) & ", " & Str(-1 * Val(txt_AddLess.Text)) & ", '" & Trim(Narr) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
                cmd.ExecuteNonQuery()
            End If
            ...
            If Val(lbl_RoundOff.Text) <> 0 Then
                L_ID = 24
                cmd.CommandText = "Insert into Voucher_Details ( Voucher_Code                       ,      For_OrderByCode       ,         Company_IdNo             ,           Voucher_No              ,            For_OrderBy     , Voucher_Type, Voucher_Date, SL_No,       Ledger_IdNo    ,             Voucher_Amount             ,        Narration    ,             Year_For_Report                               ,           Entry_Identification               ) " & _
                                  " Values             ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(vforOrdby)) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_ReturnNo.Text) & "', " & Str(Val(vforOrdby)) & ", 'Sales.Ret' ,   @SalesDate,   5  , " & Str(Val(L_ID)) & ", " & Str(-1 * Val(lbl_RoundOff.Text)) & ", '" & Trim(Narr) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(Pk_Condition) & Trim(NewCode) & "' ) "
                cmd.ExecuteNonQuery()
            End If
            ...
            '---Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, led_id, Trim(lbl_ReturnNo.Text), 0, Val(CSng(lbl_NetAmount.Text)), "CR", Trim(Pk_Condition) & Trim(NewCode), tr)
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                ...
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(7).Value = Format(Val(txt_actualRate.Text), "########0.00")
                    .Rows(i).Cells(8).Value = Format(Val(lbl_Actual_Amount.Text), "########0.00")
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(7).Value = Format(Val(txt_actualRate.Text), "########0.00")
                .Rows(n).Cells(8).Value = Format(Val(lbl_Actual_Amount.Text), "########0.00")
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        txt_actualRate.Text = Format(Val(.Rows(i).Cells(7).Value), "########0.00")
                        lbl_Actual_Amount.Text = Format(Val(.Rows(i).Cells(8).Value), "########0.00")
                        Exit For
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
            ...
            txt_actualRate.Text = Format(Val(dgv_Details.CurrentRow.Cells(7).Value), "########0.00")
            lbl_Actual_Amount.Text = Format(Val(dgv_Details.CurrentRow.Cells(8).Value), "########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                ...
                TotActAmt = TotActAmt + Val(dgv_Details.Rows(i).Cells(8).Value)
            End If
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(8).Value = Format(Val(TotActAmt), "########0.00")
        End With
    ...
    Private Sub NetAmount_Calculation()
        ...
        End If
        '--Actual
        ActTaxAmt = Format(Val(lbl_Actual_GrossAmount.Text) * Val(txt_TaxPerc.Text) / 100, "#########0.00")
        lbl_Actual_NetAmount.Text = Val(lbl_Actual_GrossAmount.Text) + Val(ActTaxAmt)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.* from SalesReturn_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.SalesReturn_Code = '" & Trim(NewCode) & "'", con)
