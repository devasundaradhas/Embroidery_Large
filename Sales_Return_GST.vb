Public Class Sales_Return_GST
    ...
    Private Sub SalesReturn_Entry_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "2001" Then '---- Demo - Elpro Chem for Vasanth by Deva (Chennai)
            ...
            txt_BillNo.Width = 104
        Else
            lbl_OrderNo.Visible = False
            cbo_OrderNo.Visible = False
            txt_BillNo.Width = 299
        End If
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "Delete from Sales_Return_GST_Tax_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and SalesReturn_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If Insert_Entry = True Or New_Entry = False Then
                NewCode = Trim(Pk_Condition) & (Val(lbl_Company.Tag)) & "-" & Trim(lbl_ReturnNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        If itm_id <> 0 Then
                            ...
                            cmd.CommandText = "Insert into SalesReturn_Details ( SalesReturn_Code,             Company_IdNo         ,               SalesReturn_No      ,         for_OrderBy        , SalesReturn_Date,          Ledger_IdNo    ,        Sl_No         ,          Item_IdNo      ,          Unit_IdNo      ,                  Serial_No             ,                 Noof_Items               ,                      Rate                ,                      Amount             ,      Cash_Discount_Perc_For_All_Item    ,       Cash_Discount_Amount_For_All_Item  ,              Assessable_Value            ,                      HSN_Code                               ,                      Tax_Perc               ) " & _
            ...
            Amt = Val(CSng(lbl_NetAmount.Text)) - Val(lbl_CGstAmount.Text) - Val(lbl_SGstAmount.Text) - Val(lbl_IGstAmount.Text) - Val(txt_AddLess.Text) - Val(lbl_RoundOff.Text)
            '---GST
            vVouPos_IdNos = AcPos_ID & "|" & saleac_id & "|" & "25|26|27|17|24"

            vVouPos_Amts = Val(vNetAmt) & "|" & Str(-1 * Val(Amt)) & "|" & Str(-1 * Val(lbl_CGstAmount.Text)) & "|" & Str(-1 * Val(lbl_SGstAmount.Text)) & "|" & Str(-1 * Val(lbl_IGstAmount.Text)) & "|" & Str(-1 * Val(txt_AddLess.Text)) & "|" & Str(-1 * Val(lbl_RoundOff.Text))

            If Common_Procedures.Voucher_Updation(con, "Gst.Sales.Ret", Val(lbl_Company.Tag), Trim(NewCode), Trim(lbl_ReturnNo.Text), dtp_Date.Value.Date, Narr, vVouPos_IdNos, vVouPos_Amts, vVouPos_ErrMsg, tr) = False Then
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*,Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code from SalesReturn_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo LEFT OUTER JOIN State_Head Lsh ON b.State_Idno = Lsh.State_IdNo INNER JOIN Company_Head c ON a.Company_IdNo = c.Company_IdNo  LEFT OUTER JOIN State_Head Csh ON c.Company_State_IdNo = csh.State_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.SalesReturn_Code = '" & Trim(NewCode) & "'", con)
...
LOOP1:
    ...
    Private Sub Printing_Format1(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        EntryCode = Trim(Pk_Condition) & Trim(Val(lbl_Company.Tag)) & "-" & Trim(lbl_ReturnNo.Text) & "/" & Trim(Common_Procedures.FnYearCode)
    ...
    Private Sub Printing_Format1_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        ...
        Try
            ...
            If Trim(prn_HdDt.Rows(0).Item("Electronic_Reference_No").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "Electronic Ref.No", LMargin + Cen1 + 10, CurY + 15, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY + 15, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Electronic_Reference_No").ToString, LMargin + Cen1 + W1 + 30, CurY + 15, 0, 0, pFont)
            End If
            CurY = CurY + TxtHgt
            ...
            If Trim(prn_HdDt.Rows(0).Item("Date_Time_Of_Supply").ToString) <> "" Then
                Common_Procedures.Print_To_PrintDocument(e, "Date & Time of Issue", LMargin + Cen1 + 10, CurY + 15, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + Cen1 + W1 + 10, CurY + 15, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Date_Time_Of_Supply").ToString, LMargin + Cen1 + W1 + 30, CurY + 15, 0, 0, pFont)
            End If
            CurY = CurY + TxtHgt
    ...
    Private Sub cbo_OrderNo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_OrderNo.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_OrderNo, txt_BillNo, txt_DateTime_Of_Supply, "Sales_Order_Head", "Sales_Order_Selection_Code", "", "")
    End Sub
    ...
    Private Sub cbo_OrderNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_OrderNo.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_OrderNo, txt_DateTime_Of_Supply, "Sales_Order_Head", "Sales_Order_Selection_Code", "", "")
    End Sub
    ...
    Private Sub cbo_TransportMode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_TransportMode.KeyPress
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TransportMode, cbo_TaxType, "", "", "", "", False)
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Function get_GST_Noof_HSN_Codes_For_Printing(ByVal EntryCode As String) As Integer
        ...
        Da = New SqlClient.SqlDataAdapter("Select * from Sales_Return_GST_Tax_Details Where Sales_Return_Code = '" & Trim(EntryCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
        If Dt1.Rows.Count > 0 Then
