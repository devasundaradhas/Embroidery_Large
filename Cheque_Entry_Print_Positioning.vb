Public Class Cheque_Entry_Print_Positioning
    ...
    Private Sub clear()
        ...
        txt_AccountNo.Text = ""
        cbo_Partner.Text = ""
        Cbo_PaperOrientation.Text = "PORTRAIT"
        txt_LeftMargin.Text = ""
        txt_TopMargin.Text = ""
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        'If Val(Common_Procedures.User.IdNo) <> 1 And InStr(Common_Procedures.UR.ChequePrint_Positioning, "~L~") = 0 And InStr(Common_Procedures.UR.ChequePrint_Positioning, "~D~") = 0 Then MessageBox.Show("You have No Rights to Delete", "DOES NOT DELETE...", MessageBoxButtons.OK, MessageBoxIcon.Error) : Exit Sub
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        'If Common_Procedures.UserRight_Check(Common_Procedures.UR.ChequePrint_Positioning, New_Entry) = False Then Exit Sub
    ...
    Private Sub Cheque_Entry_Print_Positioning_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Cheque_Entry_Print_Positioning_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Cheque_Entry_Print_Positioning_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub Cheque_Entry_Print_Positioning_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
