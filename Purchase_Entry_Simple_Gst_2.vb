Public Class Purchase_Entry_Simple_Gst_2
            ...
            If dt1.Rows.Count > 0 Then
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(16).Value = Format(Val(dt2.Rows(i).Item("GST_Percentage").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(17).Value = Trim(dt2.Rows(i).Item("Item_Code").ToString)
                    Next i
    ...
    Private Sub Purchase_Entry_Simple_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        Try
            ...
            End If
            If Trim(UCase(Common_Procedures.Master_Return.Form_Name)) = Trim(UCase(Me.Name)) And Trim(UCase(Common_Procedures.Master_Return.Control_Name)) = Trim(UCase(cbo_ItemCode.Name)) And Trim(UCase(Common_Procedures.Master_Return.Master_Type)) = "ITEMCODE" And Trim(Common_Procedures.Master_Return.Return_Value) <> "" Then
                cbo_ItemCode.Text = Trim(Common_Procedures.Master_Return.Return_Value)
            End If
    ...
    Private Sub Purchase_Entry_Simple_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        da = New SqlClient.SqlDataAdapter("select Item_Code from item_head order by Item_Code", con)
        da.Fill(dt2)
        cbo_ItemCode.DataSource = dt2
        cbo_ItemCode.DisplayMember = "Item_Code"
        ...
        AddHandler cbo_ItemCode.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler cbo_ItemCode.LostFocus, AddressOf ControlLostFocus
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(17).Value = Trim(cbo_ItemCode.Text)
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(17).Value = Trim(cbo_ItemCode.Text)
    ...
    End Sub
    Private Sub cbo_ItemCode_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemCode.LostFocus
        If Trim(UCase(cbo_ItemCode.Tag)) <> Trim(UCase(cbo_ItemCode.Text)) Then
            get_Item_Unit_Rate_TaxPerc()
        End If
    ...
    Private Sub cbo_Ledger_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_Ledger.GotFocus
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1039" Or Trim(Common_Procedures.settings.CustomerCode) = "1167" Then
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        If ItmIdNo <> 0 Then
                            ...
                            .Rows(i).Cells(11).Value = Format(Val(.Rows(i).Cells(6).Value) - Val(.Rows(i).Cells(8).Value) + Val(.Rows(i).Cells(10).Value), "#########0.00")
                            ...
                            .Rows(i).Cells(14).Value = Format(Val(.Rows(i).Cells(6).Value) - Val(.Rows(i).Cells(13).Value), "#########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            TotTxAmt = TotTxAmt + Val(dgv_Details.Rows(i).Cells(10).Value)
            TotAmt = TotAmt + Val(dgv_Details.Rows(i).Cells(11).Value)
            TotFotDisAmt = TotFotDisAmt + Val(dgv_Details.Rows(i).Cells(13).Value)
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Format(Val(txt_Freight.Text) + Val(txt_SubTotal.Text) - Val(txt_CashDiscAmount.Text) + Val(txt_AddLessAmount.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text) + Val(txt_RoundOff.Text), "########0.00")
