Public Class JobWork_Creation
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        da = New SqlClient.SqlDataAdapter("select a.* from JobWork_Project_Head a where a.JobWork_IdNo = " & Str(Val(idno)), con)
        da.Fill(dt)

        If dt.Rows.Count > 0 Then
            lbl_IdNo.Text = dt.Rows(0).Item("JobWork_IdNo").ToString
            txt_Name.Text = dt.Rows(0).Item("JobWork_Name").ToString
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from JobWork_Project_Head where JobWork_IdNo = " & Str(Val(lbl_IdNo.Text))
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select JobWork_IdNo, JobWork_Name from JobWork_Project_Head where JobWork_IdNo <> 0 order by JobWork_IdNo", con)
        Dim dt As New DataTable
        ...
        With dgv_Filter
            ...
            .Columns(1).HeaderText = "FABRIC NAME"
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(JobWork_IdNo) from JobWork_Project_Head Where JobWork_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(JobWork_IdNo) from JobWork_Project_Head Where JobWork_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(JobWork_IdNo) from JobWork_Project_Head Where JobWork_IdNo > " & Str(Val(lbl_IdNo.Text)) & " and JobWork_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(JobWork_IdNo) from JobWork_Project_Head Where JobWork_IdNo < " & Str(Val(lbl_IdNo.Text)) & " and JobWork_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "JobWork_Project_Head", "JobWork_IdNo", "")
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        Dim da As New SqlClient.SqlDataAdapter("select JobWork_Name from JobWork_Project_Head order by JobWork_Name", con)
        Dim dt As New DataTable

        da.Fill(dt)

        cbo_Open.DataSource = dt
        cbo_Open.DisplayMember = "JobWork_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "JobWork_Project_Head", "JobWork_IdNo", "", trans)

                cmd.CommandText = "Insert into JobWork_Project_Head(JobWork_IdNo, JobWork_Name,Description, sur_name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(txt_Descriptio.Text) & "' ,'" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update JobWork_Project_Head set JobWork_Name = '" & Trim(txt_Name.Text) & "', Description = '" & Trim(txt_Descriptio.Text) & "', sur_name = '" & Trim(Sur) & "' where JobWork_IdNo = " & Str(Val(lbl_IdNo.Text)) & ""
                cmd.ExecuteNonQuery()
        ...
        Catch ex As Exception
            trans.Rollback()
            If InStr(1, Trim(LCase(ex.Message)), "ix_JobWork_Project_Head") > 0 Then
                MessageBox.Show("Duplicate JobWork Name", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btn_Open_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Open.Click
        ...
        da = New SqlClient.SqlDataAdapter("select JobWork_IdNo from JobWork_Project_Head where JobWork_Name = '" & Trim(cbo_Open.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub cbo_Open_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Open.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Open, Nothing, Nothing, "JobWork_Project_Head", "JobWork_Name", "", "(JobWork_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_Open_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Open.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Open, Nothing, "JobWork_Project_Head", "JobWork_Name", "", "(JobWork_IdNo = 0)")
    ...
    Private Sub txt_Descriptio_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_Descriptio.KeyDown
    ...
    Private Sub txt_Descriptio_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_Descriptio.KeyPress
        If Asc(e.KeyChar) = 13 Then
            If MessageBox.Show("Do you want to save?", "FOR SAVING...", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                save_record()
            End If
    ...
    Private Sub grp_Filter_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grp_Filter.Enter
