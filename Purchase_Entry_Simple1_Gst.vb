Public Class Purchase_Entry_Simple1_Gst
            ...
            If dt1.Rows.Count > 0 Then
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(15).Value = Trim(dt2.Rows(i).Item("HSN_Code").ToString)
                        dgv_Details.Rows(n).Cells(16).Value = Format(Val(dt2.Rows(i).Item("Cash_Discount_Perc_For_All_Item").ToString), "########0.00")
                        dgv_Details.Rows(n).Cells(17).Value = Format(Val(dt2.Rows(i).Item("Cash_Discount_Amount_For_All_Item").ToString), "########0.00")
                    Next i
                ...
                da1 = New SqlClient.SqlDataAdapter("Select a.* from Purchase_GST_Tax_Details a Where a.Purchase_Code = '" & Trim(NewCode) & "' ", con)
                dt4 = New DataTable
                da1.Fill(dt4)
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "Delete from Purchase_GST_Tax_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Purchase_Code = '" & Trim(NewCode) & "'"
            cmd.ExecuteNonQuery()
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Purchase_No from Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Purchase_Code like '" & Trim(Pk_Condition) & "%' and  Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "'  and Entry_GST_Tax_Type = 'GST' Order by for_Orderby, Purchase_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select Purchase_No from Purchase_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Purchase_Code like '" & Trim(Pk_Condition) & "%' and Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and  Entry_GST_Tax_Type = 'GST' Order by for_Orderby, Purchase_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Purchase_No from Purchase_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Purchase_Code like '" & Trim(Pk_Condition) & "%'and Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and  Entry_GST_Tax_Type = 'GST' Order by for_Orderby desc, Purchase_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select Purchase_No from Purchase_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Purchase_Code like '" & Trim(Pk_Condition) & "%' and Purchase_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and  Entry_GST_Tax_Type = 'GST' Order by for_Orderby desc, Purchase_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            vVouPos_Amts = Val((txt_NetAmount.Text)) & "|" & -1 * (Val(txt_NetAmount.Text) - Val(lbl_CGstAmount.Text) - Val(lbl_SGstAmount.Text) - Val(lbl_IGstAmount.Text)) & "|" & -1 * Val(lbl_CGstAmount.Text) & "|" & -1 * Val(lbl_SGstAmount.Text) & "|" & -1 * Val(lbl_IGstAmount.Text)
            If Common_Procedures.Voucher_Updation(con, "Gst.Purc", Val(lbl_Company.Tag), Trim(NewCode), Trim(lbl_PurchaseNo.Text), dtp_Date.Value.Date, "Bill No : " & Trim(txt_BillNo.Text), vVouPos_IdNos, vVouPos_Amts, vVouPos_ErrMsg, tr) = False Then
            ...
            '    cmd.CommandText = "Insert into Voucher_Details (                   Voucher_Code               , For_OrderByCode, Company_IdNo, Voucher_No, For_OrderBy, Voucher_Type, Voucher_Date, SL_No, Ledger_IdNo, Voucher_Amount, Narration, Year_For_Report, Entry_Identification ) " & _
            '                                " Values             ('" & Trim(NewCode) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_PurchaseNo.Text))) & ", " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_PurchaseNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_PurchaseNo.Text))) & ", 'Gst.Purch', @PurchaseDate, 5, " & Str(Val(L_id)) & ", " & Str(-1 * Val(Amt)) & ", 'Bill No . : " & Trim(txt_BillNo.Text) & "', " & Str(Val(Year(Common_Procedures.Company_FromDate))) & ", '" & Trim(NewCode) & "' )"
            '    cmd.ExecuteNonQuery()
            ...
            'Bill Posting
            VouBil = Common_Procedures.VoucherBill_Posting(con, Val(lbl_Company.Tag), dtp_Date.Text, led_id, Trim(txt_BillNo.Text), 0, Val(CSng(txt_NetAmount.Text)), "CR", Trim(NewCode), tr)
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(14).Value = Val(lbl_Grid_AssessableValue.Text)
                    .Rows(i).Cells(15).Value = Trim(lbl_Grid_HsnCode.Text)
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(14).Value = Val(lbl_Grid_AssessableValue.Text)
                .Rows(n).Cells(15).Value = Trim(lbl_Grid_HsnCode.Text)
    ...
    Private Sub cbo_ItemName_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemName.LostFocus
        ...
        If Trim(UCase(cmbItmNm)) <> Trim(UCase(cbo_ItemName.Text)) Then
            da = New SqlClient.SqlDataAdapter("select a.*, b.unit_name,c.* from item_head a, unit_head b ,ItemGroup_Head c  where a.item_name = '" & Trim(cbo_ItemName.Text) & "' and a.unit_idno = b.unit_idno and a.ItemGroup_IdNo =c.ItemGroup_IdNo", con)
            da.Fill(dt)
            If dt.Rows.Count > 0 Then
                ...
                txt_TaxPerc.Text = dt.Rows(0).Item("Item_GST_Percentage").ToString
                lbl_Grid_HsnCode.Text = dt.Rows(0).Item("Item_HSN_Code").ToString
    ...
    Private Sub txt_GrossAmount_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_GrossAmount.TextChanged
        If FrmLdSTS = False Then Exit Sub
        Amount_Calculation(False)
        NetAmount_Calculation()
    End Sub
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        lbl_Grid_AssessableValue.Text = Format(Val(.Rows(i).Cells(14).Value), "########0")
    ...
    Private Sub Amount_Calculation(ByVal GridAll_Row_STS As Boolean)
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        If ItmIdNo <> 0 Then
                            ...
                            'Discount amount
                            .Rows(i).Cells(9).Value = Format(Val(.Rows(i).Cells(6).Value) * Val(.Rows(i).Cells(8).Value) / 100, "#########0.00")


                         
                            'Cash Discount amount
                            .Rows(i).Cells(16).Value = Format(Val(txt_CashDiscPerc.Text), "#########0.00")
                            .Rows(i).Cells(17).Value = Format(Val(.Rows(i).Cells(6).Value) * Val(.Rows(i).Cells(16).Value) / 100, "#########0.00")

                            'Tax amount
                            .Rows(i).Cells(11).Value = Format((Val(.Rows(i).Cells(6).Value) - Val(.Rows(i).Cells(9).Value) - Val(.Rows(i).Cells(17).Value)) * Val(.Rows(i).Cells(10).Value) / 100, "#########0.00")

                            'net amount = amount - disc - cash disc + tax amt
                            .Rows(i).Cells(12).Value = Format((Val(.Rows(i).Cells(6).Value) - Val(.Rows(i).Cells(9).Value) - Val(.Rows(i).Cells(17).Value) + Val(.Rows(i).Cells(11).Value)), "#########0.00")
                            ' assable amt = amount - disc - cash disc 
                            .Rows(i).Cells(14).Value = Format((Val(.Rows(i).Cells(6).Value) - Val(.Rows(i).Cells(9).Value) - Val(.Rows(i).Cells(7).Value) - Val(.Rows(i).Cells(17).Value)), "#########0.00")
        ...
        Else
            ...
            txt_Amount.Text = Format(Val(txt_SubAmount.Text) - (Val(txt_DiscountAmount.Text) + Val(txt_DiscAmountItemwise.Text)) + Val(txt_TaxAmount.Text), "########0.00")
            ...
            lbl_Grid_AssessableValue.Text = Format(Val(txt_SubAmount.Text) - Val(lbl_Grid_DiscAmount.Text) - Val(txt_DiscAmountItemwise.Text), "#########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        Dim TotSubAmt As Decimal, TotTxAmt As Decimal, TotAmt As Decimal, TotDISAmt As Decimal
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            TotDiscAmt = TotDiscAmt + Val(dgv_Details.Rows(i).Cells(9).Value) + Val(dgv_Details.Rows(i).Cells(7).Value)
            TotTxAmt = TotTxAmt + Val(dgv_Details.Rows(i).Cells(11).Value)
            TotAmt = TotAmt + Val(dgv_Details.Rows(i).Cells(12).Value)
            TotFotDisAmt = TotFotDisAmt + Val(dgv_Details.Rows(i).Cells(17).Value)
        ...
        txt_GrossAmount.Text = Format(TotSubAmt, "########0.00")
    ...
    Private Sub GrossAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            dgv_Details.Rows(i).Cells(14).Value = Val(dgv_Details.Rows(i).Cells(6).Value) - Val(dgv_Details.Rows(i).Cells(7).Value) - Val(dgv_Details.Rows(i).Cells(9).Value)
            TotAssAmt = Val(TotAssAmt) + Val(dgv_Details.Rows(i).Cells(14).Value)
        Next
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(txt_GrossAmount.Text) - Val(txt_TotalDiscAmount.Text) - Val(txt_CashDiscAmount.Text) + Val(txt_AddLessAmount.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text)


        txt_RoundOff.Text = Format(Format(Val(NtAmt), "#########0") - Val(NtAmt), "#########0.00")

        txt_NetAmount.Text = Format(Val(txt_Freight.Text) + Val(txt_GrossAmount.Text) - Val(txt_TotalDiscAmount.Text) - Val(txt_CashDiscAmount.Text) + Val(txt_AddLessAmount.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text) + Val(txt_RoundOff.Text), "########0.00")
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
            ...
            lbl_Grid_AssessableValue.Text = Format(Val(dgv_Details.CurrentRow.Cells(14).Value), "########0")
    ...
    Private Sub cbo_Ledger_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Ledger.KeyDown
        ...
        If Trim(Common_Procedures.settings.CustomerCode) = "1039" Then
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, dtp_Date, txt_Electronic_RefNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
        Else
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Ledger, dtp_Date, txt_Electronic_RefNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
        End If
    ...
    Private Sub cbo_Ledger_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Ledger.KeyPress
        If Trim(Common_Procedures.settings.CustomerCode) = "1039" Then
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, txt_Electronic_RefNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
        Else
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Ledger, txt_Electronic_RefNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 10 or AccountsGroup_IdNo = 14 )", "(Ledger_IdNo = 0)")
        End If
    ...
    Private Sub cbo_PurchaseAc_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PurchaseAc.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PurchaseAc, cbo_PaymentMethod, txt_BillNo, "Ledger_AlaisHead", "Ledger_DisplayName", "(AccountsGroup_IdNo = 27)", "(Ledger_IdNo = 0)")
    End Sub
    ...
    Private Sub cbo_TaxType_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TaxType.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TaxType, txt_place_Supply, txt_SlNo, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_PaymentMethod_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_PaymentMethod.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_PaymentMethod, cbo_TransportMode, cbo_PurchaseAc, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_paymentMethod_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_PaymentMethod.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_PaymentMethod, cbo_PurchaseAc, "", "", "", "")
    End Sub
    ...
    Private Sub cbo_TransportMode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_TransportMode.KeyDown
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_TransportMode, txt_DateTime_Of_Supply, cbo_PaymentMethod, "", "", "", "")
        Catch ex As Exception
    ...
    Private Sub cbo_TransportMode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_TransportMode.KeyPress
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_TransportMode, cbo_PaymentMethod, "", "", "", "", False)
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OKCancel, MessageBoxIcon.Error)
        End Try
    End Sub
    Private Sub Get_HSN_CodeWise_GSTTax_Details()
        ...
        Try
            ...
            AssVal_Frgt_Othr_Charges = Val(txt_Freight.Text) + Val(txt_AddLessAmount.Text)
            ...
            With dgv_Details
                ...
                If .Rows.Count > 0 Then
                    For i = 0 To .Rows.Count - 1
                        ...
                        If Trim(.Rows(i).Cells(1).Value) <> "" And Trim(.Rows(i).Cells(15).Value) <> "" And Val(.Rows(i).Cells(10).Value) <> 0 Then

                            cmd.CommandText = "Insert into EntryTemp (                    Name1                ,                   Currency1            ,                       Currency2                                      ) " & _
                                              "            Values    ( '" & Trim(.Rows(i).Cells(15).Value) & "', " & (Val(.Rows(i).Cells(10).Value)) & ", " & Str(Val(.Rows(i).Cells(14).Value) + AssVal_Frgt_Othr_Charges) & " ) "
                            cmd.ExecuteNonQuery()
    ...
    Private Sub txt_DiscAmountItemwise_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_DiscAmountItemwise.TextChanged
        Amount_Calculation(True)
    End Sub
End Class