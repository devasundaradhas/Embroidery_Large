Public Class Area_Creation
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        Try
            ...
            If dr.HasRows Then
                If dr.Read() Then
                    txt_IdNo.Text = dr("Area_IdNo").ToString()
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            'da = New SqlClient.SqlDataAdapter("select count(*) from Sales_Details where Area_IdNo = " & Str(Val(txt_IdNo.Text)), con)
            'dt = New DataTable
            'da.Fill(dt)
            'If dt.Rows.Count > 0 Then
            '    If IsDBNull(dt.Rows(0)(0).ToString) = False Then
            ...
            cmd.Connection = con
            cmd.CommandText = "delete from Area_Head where Area_IdNo = " & Str(Val(txt_IdNo.Text))
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select min(Area_IdNo) from Area_Head where Area_IdNo > " & Str(Val(txt_IdNo.Text))
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Area_IdNo) from Area_Head where Area_IdNo < " & Str(Val(txt_IdNo.Text)) & " and Area_IdNo <> 0 ", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        txt_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Area_Head", "Area_IdNo", "")
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                txt_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Area_Head", "Area_IdNo", "", trans)

                cmd.CommandText = "Insert into Area_Head(Area_IdNo, Area_Name, sur_name) values (" & Str(Val(txt_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Area_Head set Area_Name = '" & Trim(txt_Name.Text) & "', sur_name = '" & Trim(Sur) & "' where Area_IdNo = " & Str(Val(txt_IdNo.Text))
                cmd.ExecuteNonQuery()
                ...
                If Asc(e.KeyChar) <> 27 Then
                    ...
                    Else
                        ...
                        If Trim(FindStr) <> "" Then
                            Condt = " Where Area_Name like '" & Trim(FindStr) & "%' or Area_Name like '% " & Trim(FindStr) & "%' "
                        End If
