Public Class Sales_Delivery7_Gst
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Insert into Sales_Delivery_Details ( Sales_Delivery_Code,            Company_IdNo          ,              Sales_Delivery_No             ,                                              for_OrderBy                   , Sales_Delivery_Date,          Ledger_IdNo    ,  Entry_Type                         ,          SL_No     ,          Item_IdNo      ,         Unit_IdNo      ,     Style_IdNo    ,           Size_IdNo       ,                        Quantity                 ,                 Rate                     ,                 Amount                   ,                     Assessable_Value                 ,            HSN_Code                    , Tax_Perc                             ,    Item_Description    ,No_Of_Rolls                         ,        Receipt_No       ,     Sales_Receipt_Code          ,      Sales_Receipt_Detail_Slno) " & _
                                                    " Values ('" & Trim(NewCode) & "'                      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @DcDate               , " & Str(Val(led_id)) & ", '" & Trim(cbo_EntType.Text) & "'," & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & "," & Val(Sty_id) & " , " & Str(Val(Sz_id)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(5).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & " , " & Str(Val(.Rows(i).Cells(7).Value)) & ",'" & Trim(.Rows(i).Cells(8).Value) & "', " & Str(Val(.Rows(i).Cells(9).Value)) & ", '" & Trim(.Rows(i).Cells(10).Value) & "' ," & Val(.Rows(i).Cells(11).Value) & ",'" & Trim(RecNo) & "','" & Trim(RecCd) & "' ," & Val(RecSlNo) & ")"
                        cmd.ExecuteNonQuery()
                        If Trim(UCase(cbo_EntType.Text)) = "RECEIPT" Then
                            nr = 0
                            cmd.CommandText = "Update Sales_Receipt_Details set Delivery_No_Of_Rolls = Delivery_No_Of_Rolls + " & Str(Val(.Rows(i).Cells(11).Value)) & ",Delivery_Quantity = Delivery_Quantity + " & Str(Val(.Rows(i).Cells(4).Value)) & " Where Sales_Receipt_Code = '" & Trim(RecCd) & "' and Ledger_IdNo = " & Val(led_id) & " and Sales_Receipt_Detail_SlNo = " & Str(Val(RecSlNo))
    ...
    Private Sub Receipt_Selection()
        ...
        For i = 0 To dgv_Selection.RowCount - 1
            ...
            If Val(dgv_Selection.Rows(i).Cells(10).Value) = 1 Then
                ...
                txt_Weight.Text = Trim(dgv_Selection.Rows(i).Cells(26).Value)
