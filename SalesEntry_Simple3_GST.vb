Public Class SalesEntry_Simple3_GST
    ...
    Private Pk_Condition As String = "GSSA3-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.* ,a.Item_code, b.Item_Name, c.Unit_Name, a.Serial_No, a.Noof_Items, a.Rate, a.Amount from Sales_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on a.unit_idno = c.unit_idno where a.Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                With dgv_Details
                    ...
                    If dt2.Rows.Count > 0 Then
                        ...
                        For i = 0 To dt2.Rows.Count - 1
                            ...
                            dgv_Details.Rows(n).Cells(4).Value = dt2.Rows(i).Item("Serial_No").ToString
                            ...
                            '***** GST START *****
                            dgv_Details.Rows(n).Cells(8).Value = Format(Val(dt2.Rows(i).Item("Cash_Discount_Perc_For_All_Item").ToString), "########0.00")
                            dgv_Details.Rows(n).Cells(9).Value = Format(Val(dt2.Rows(i).Item("Cash_Discount_Amount_For_All_Item").ToString), "########0.00")
                            dgv_Details.Rows(n).Cells(10).Value = Format(Val(dt2.Rows(i).Item("Assessable_Value").ToString), "########0.00")
    ...
    Private Sub SalesEntry_Simple3_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Trim(Common_Procedures.settings.CustomerCode)) = "1167" Then ' f fashion
            If Common_Procedures.SalesEntryType = "ESTIMATE" Then
                Pk_Condition = "GESTM-"
            Else
                Pk_Condition = "GSALE-"
            End If
                ...
                For i = 0 To .Rows.Count - 1
                    ...
                    If Val(.Rows(i).Cells(5).Value) <> 0 Then
                        ...
                        If itm_id <> 0 Then
                            ...
                            cmd.CommandText = "Insert into Sales_Details ( Sales_Code,             Company_IdNo         ,               Sales_No            ,           for_OrderBy      , Sales_Date,          Ledger_IdNo    ,        Sl_No         ,          Item_IdNo      ,   Item_code                             ,        Unit_IdNo      ,                  Serial_No             ,                 Noof_Items               ,                      Rate                ,                      Amount                ,    Cash_Discount_Perc_For_All_Item    ,       Cash_Discount_Amount_For_All_Item  ,              Assessable_Value            ,                      HSN_Code           ,                      Tax_Perc    ) " & _
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                ...
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    '***** GST START *****
                    .Rows(i).Cells(8).Value = Format(Val(lbl_Grid_DiscPerc.Text), "########0.00")
                    .Rows(i).Cells(9).Value = Format(Val(lbl_Grid_DiscAmount.Text), "########0.00")
                    .Rows(i).Cells(10).Value = Format(Val(lbl_Grid_AssessableValue.Text), "########0.00")
            ...
            If MtchSTS = False Then
                ...
                '***** GST START *****
                .Rows(n).Cells(8).Value = Format(Val(lbl_Grid_DiscPerc.Text), "########0.00")
                .Rows(n).Cells(9).Value = Format(Val(lbl_Grid_DiscAmount.Text), "########0.00")

                .Rows(n).Cells(10).Value = Format(Val(lbl_Grid_AssessableValue.Text), "########0.00")
    ...
    Private Sub txt_NoofItems_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_NoofItems.LostFocus
        Dim da As New SqlClient.SqlDataAdapter
        Dim dt As New DataTable
        Dim Itm_ID As Integer = 0
        ...
        Try
            ...
            'da = New SqlClient.SqlDataAdapter("select sum(Quantity) as Stock from Item_Processing_Details where company_idno = " & Str(Val(lbl_Company.Tag)) & " AND Item_IdNo =  " & Itm_ID, con)
            'da.Fill(dt)
            ...
            '            MessageBox.Show("Invalid Quantity" & vbCrLf & " Stock : " & Val(dt.Rows(0)(0).ToString), "FOR  MOVING...", MessageBoxButtons.OK, MessageBoxIcon.Error)
            '            txt_NoofItems.Focus()
            '        End If
            '    End If
            'End If
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
            ...
            '***** GST START *****
            lbl_Grid_DiscPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(8).Value), "########0.00")
            lbl_Grid_DiscAmount.Text = Format(Val(dgv_Details.CurrentRow.Cells(9).Value), "########0.00")

            lbl_Grid_AssessableValue.Text = Format(Val(dgv_Details.CurrentRow.Cells(10).Value), "########0.00")

            lbl_Grid_HsnCode.Text = dgv_Details.CurrentRow.Cells(11).Value
            lbl_Grid_GstPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(12).Value), "########0.00")
            '***** GST END *****
    ...
    Private Sub txt_PaymentTerms_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_PaymentTerms.KeyDown
        If e.KeyCode = 40 Then
            If Trim(Common_Procedures.settings.CustomerCode) = "1119" Then
                txt_Advance.Focus()
            Else
                btn_save.Focus()
            End If
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        If ItmIdNo <> 0 Then
                            ...
                            .Rows(i).Cells(8).Value = Format(Val(txt_CashDiscPerc.Text), "#########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(5).Value) <> 0 Then
                ...
                TotAssval = TotAssval + Val(dgv_Details.Rows(i).Cells(10).Value)
                '***** GST END *****
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(10).Value = Format(Val(TotAssval), "########0.00")
            '***** GST END *****
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(lbl_GrossAmount.Text) - Val(lbl_CashDiscAmount.Text) + Val(lbl_CGstAmount.Text) + Val(lbl_SGstAmount.Text) + Val(lbl_IGstAmount.Text) + Val(txt_Freight.Text) + Val(txt_AddLess.Text)
        ...
        lbl_Balance.Text = Format(Val(NtAmt) - Val(txt_Advance.Text), "############0.00")
        lbl_AmountInWords.Text = "Rupees :                                                                               "
            ...
            With dgv_Details
                ...
                If .Rows.Count > 0 Then
                    For i = 0 To .Rows.Count - 1
                        ...
                        If Trim(.Rows(i).Cells(1).Value) <> "" And Trim(.Rows(i).Cells(11).Value) <> "" And Val(.Rows(i).Cells(12).Value) <> 0 Then

                            cmd.CommandText = "Insert into EntryTemp (                    Name1                ,                   Currency1            ,                       Currency2                                      ) " & _
                                              "            Values    ( '" & Trim(.Rows(i).Cells(11).Value) & "', " & (Val(.Rows(i).Cells(12).Value)) & ", " & Str(Val(.Rows(i).Cells(10).Value) + AssVal_Frgt_Othr_Charges) & " ) "
                            cmd.ExecuteNonQuery()
    ...
    Public Sub print_record() Implements Interface_MDIActions.print_record
        ...
        ElseIf Trim(Common_Procedures.settings.CustomerCode) = "1167" Then
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            '***** GST START *****
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.*, c.*, Csh.State_Name as Company_State_Name, Csh.State_Code as Company_State_Code, Lsh.State_Name as Ledger_State_Name, Lsh.State_Code as Ledger_State_Code from Sales_Head a " & _
                                               ...
                                               "LEFT OUTER JOIN State_Head Csh ON c.Company_State_IdNo = csh.State_IdNo where a.Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Sales_Code = '" & Trim(Pk_Condition) & Trim(NewCode) & "'", con)
...
LOOP1:
    ...
    Private Sub cbo_ItemCode_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemCode.GotFocus
        With cbo_ItemCode
            Common_Procedures.ComboBox_ItemSelection_SetDataSource(sender, con, "item_head", "item_Code", "", "(item_idno = 0)")
            cbo_ItemCode.Tag = cbo_ItemCode.Text
        End With
    End Sub
    Private Sub cbo_ItemCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_ItemCode.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_ItemCode, txt_SlNo, Nothing, "Item_Head", "Item_Code", "", "(Item_IdNo = 0)")
        If (e.KeyValue = 40 And cbo_ItemCode.DroppedDown = False) Or (e.Control = True And e.KeyValue = 40) Then
            cbo_ItemName.Focus()
        End If
    End Sub
    Private Sub cbo_ItemCode_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_ItemCode.KeyPress
        Try
            Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_ItemCode, Nothing, "item_head", "item_Code", "", "(item_idno = 0)")
        Catch ex As Exception
            'MessageBox.Show(ex.Message, "DOES NOT SELECT...", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    End Sub
    Private Sub cbo_ItemCode_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemCode.TextChanged
        Dim ItemID As Integer = 0

        ItemID = Val(Common_Procedures.Item_CodeToIdNo(con, Trim(cbo_ItemCode.Text)))
        If ItemID = 0 Then Exit Sub

        cbo_ItemName.Text = Trim(Common_Procedures.get_FieldValue(con, "Item_Head", "Item_Name", "Item_IdNo = " & ItemID))
        txt_Rate.Text = Trim(Common_Procedures.get_FieldValue(con, "Item_Head", "Sales_Rate", "Item_IdNo = " & ItemID))
    End Sub

    Private Sub cbo_ItemName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemName.TextChanged
        Dim ItemID As Integer = 0

        ItemID = Val(Common_Procedures.Item_NameToIdNo(con, Trim(cbo_ItemName.Text)))
        If ItemID = 0 Then Exit Sub
        If cbo_ItemCode.Visible And cbo_ItemCode.Enabled Then
            cbo_ItemCode.Text = Trim(Common_Procedures.get_FieldValue(con, "Item_Head", "Item_code", "Item_IdNo = " & ItemID))
        ElseIf txt_code.Visible And txt_code.Enabled Then
            txt_code.Text = Trim(Common_Procedures.get_FieldValue(con, "Item_Head", "Item_code", "Item_IdNo = " & ItemID))
        End If

        txt_Rate.Text = Trim(Common_Procedures.get_FieldValue(con, "Item_Head", "Sales_Rate", "Item_IdNo = " & ItemID))
    End Sub
    Private Sub Printing_Format_GST3(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim EntryCode As String
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                Printing_Format_GST3_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                ...
                Try
                    ...
                    Printing_Format_GST3_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, Cmp_Name, NoofDets, True)
    ...
    Private Sub Printing_Format_GST3_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        ' Dim ptFont As Font
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_No").ToString, LMargin + W2 + 25, CurY, 0, 0, pFont)
            ...
            '  Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Date").ToString), "dd-MM-yyyy"), LMargin + Cen1 + W1 + 5, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Date").ToString), "dd-MM-yyyy") & " " & tim, LMargin + Cen1 + W1 - 8, CurY, 0, 0, pFont)
    ...
    Private Sub Printing_Format_GST3_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ' Dim p1Font As Font
        ' Dim I As Integer
        Dim w1 As Single = 0
        Dim w2 As Single = 0
        ...
        Try
            ...
            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "Qty : " & Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString), LMargin + 10, CurY, 0, 0, pFont)
            ' If is_LastPage = True Then
            Common_Procedures.Print_To_PrintDocument(e, "SubTotal  :   " & Format(Val(prn_HdDt.Rows(0).Item("SubTotal_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 1, 0, pFont)
            ' End If
            ...
            If Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString) <> 0 Then
                CurY = CurY + TxtHgt
                '  If is_LastPage = True Then
                Common_Procedures.Print_To_PrintDocument(e, "Cash Discount @ " & Trim(Val(prn_HdDt.Rows(0).Item("CashDiscount_Perc").ToString)) & "%", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 2, CurY, 1, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 1, 0, pFont)
                'End If
            End If

            If Val(prn_HdDt.Rows(0).Item("Tax_Amount").ToString) <> 0 Then
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Tax_Type").ToString) & " @ " & Trim(Val(prn_HdDt.Rows(0).Item("Tax_Perc").ToString)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 2, CurY, 1, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Tax_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 1, 0, pFont)
            End If

            If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) <> 0 Then
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, "Add/Less : ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) - 2, CurY, 1, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 1, 0, pFont)
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("Round_Off").ToString) <> 0 Then
                ...
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Round_Off").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 1, 0, pFont)
                'End If
            End If
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Net Amount : " & Common_Procedures.Currency_Format(Val(prn_HdDt.Rows(0).Item("Net_Amount").ToString)), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 1, 0, pFont)
    ...
    Private Sub Printing_Format_GST4(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        Dim EntryCode As String
        Dim NoofDets As Integer, NoofItems_PerPage As Integer
        Dim pFont As Font
        Dim LMargin As Single, RMargin As Single, TMargin As Single, BMargin As Single
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                If Common_Procedures.SalesEntryType = "ESTIMATE" Then
                    Printing_Format_GST4_PageHeader_Estimate(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                Else
                    Printing_Format_GST4_PageHeader(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, prn_PageNo, NoofItems_PerPage, CurY, LnAr, ClArr)
                End If
                ...
                Try
                    ...
                    If prn_DetMxIndx > 0 Then
                        ...
                        Do While DetIndx <= prn_DetMxIndx
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 8), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + 20, CurY, 1, 0, pFont)
                    ...
                    Printing_Format_GST4_PageFooter(e, EntryCode, TxtHgt, pFont, LMargin, RMargin, TMargin, BMargin, PageWidth, PrintWidth, NoofItems_PerPage, CurY, LnAr, ClArr, Cmp_Name, NoofDets, True)
    ...
    Private Sub Printing_Format_GST4_PageHeader(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        ' Dim ptFont As Font
        ...
        Cmp_Add1 = Trim(prn_HdDt.Rows(0).Item("Company_Address1").ToString) '& IIf(Trim(prn_HdDt_VAT.Rows(0).Item("Company_Address1").ToString) <> "" And Microsoft.VisualBasic.Right(Trim(prn_HdDt_VAT.Rows(0).Item("Company_Address1").ToString), 1) = ",", " ", ", ") & Trim(prn_HdDt_VAT.Rows(0).Item("Company_Address2").ToString)
        If Trim(Cmp_Add1) <> "" Then
            If Microsoft.VisualBasic.Right(Trim(Cmp_Add1), 1) = "," Then
                Cmp_Add1 = Trim(Cmp_Add1) & ", " & Trim(prn_HdDt.Rows(0).Item("Company_Address2").ToString)
            Else
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "AMOUNT", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) - 5, CurY, 2, ClAr(6), pFont)
    ...
    Private Sub Printing_Format_GST4_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        Dim p1Font As Font
        ' Dim I As Integer
        Dim w1 As Single = 0
        Dim w2 As Single = 0
        ...
        Try
            ...
            w1 = e.Graphics.MeasureString("SubTotal  : ", pFont).Width
            ...
            Common_Procedures.Print_To_PrintDocument(e, "Qty : " & Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString), LMargin + 10, CurY, 0, 0, pFont)
            ' If is_LastPage = True Then
            Common_Procedures.Print_To_PrintDocument(e, "SubTotal", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 10, CurY, 1, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Gross_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + 20, CurY, 1, 0, pFont)
            ' End If
            ...
            If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) <> 0 Then
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, "Add/Less", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 10, CurY, 1, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY, 0, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6), CurY, 1, 0, pFont)
            End If
            ...
            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "CGST", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 10, CurY, 1, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Ttl_CGst) <> 0, Common_Procedures.Currency_Format(Val(Ttl_CGst)), ""), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + 20, CurY, 1, 0, pFont)
            CurY = CurY + TxtHgt
            Common_Procedures.Print_To_PrintDocument(e, "SGST", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 10, CurY, 1, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, IIf(Val(Ttl_Sgst) <> 0, Common_Procedures.Currency_Format(Val(Ttl_Sgst)), ""), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + 20, CurY, 1, 0, pFont)
            ...
            p1Font = New Font("Calibri", 9, FontStyle.Bold)
            CurY = CurY + TxtHgt + 5
            Common_Procedures.Print_To_PrintDocument(e, "Grand Total", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 10, CurY, 1, 0, p1Font)
            Common_Procedures.Print_To_PrintDocument(e, ":", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + 20, CurY, 0, 0, pFont)
            Common_Procedures.Print_To_PrintDocument(e, Common_Procedures.Currency_Format(Val(prn_HdDt.Rows(0).Item("Net_Amount").ToString)), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + 20, CurY, 1, 0, p1Font)
            Common_Procedures.Print_To_PrintDocument(e, "* Inclusive Of All Taxes", LMargin + 10, CurY, 0, 0, pFont)
            ...
            CurY = CurY + TxtHgt
            p1Font = New Font("Calibri", 9, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "***THANK YOU***", LMargin, CurY + 3, 2, PrintWidth, p1Font)
    ...
    End Sub
    Private Sub Printing_Format_GST4_PageHeader_Estimate(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByRef PageNo As Integer, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single)
        Dim da2 As New SqlClient.SqlDataAdapter
        Dim dt2 As New DataTable
        Dim p1Font As Font
        ' Dim ptFont As Font
