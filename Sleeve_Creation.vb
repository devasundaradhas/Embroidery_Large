Public Class Sleeve_Creation
    ...
    Private Sub Sleeve_Creation_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Sleeve_Creation_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub Sleeve_Creation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Width = 510
        grp_Find.Left = 10
        grp_Find.Top = 250
        grp_Find.Visible = False
        ...
        If Trim(UCase(Common_Procedures.settings.CustomerCode)) = "1095" Then
            lbl_Header.Text = "PAPER CREATION"
        Else
            lbl_Header.Text = "SLEEVE CREATION"
        End If
    ...
    End Sub
        ...
        Public Sub delete_record() Implements Interface_MDIActions.delete_record
            ...
            Try
                ...
                cmd.Connection = con
            cmd.CommandText = "delete from Sleeve_Head where Sleeve_IdNo = " & Str(Val(lbl_IdNo.Text))
    ...
    Public Sub filter_record() Implements Interface_MDIActions.filter_record
        Dim da As New SqlClient.SqlDataAdapter("select Sleeve_IdNo, Sleeve_Name from Sleeve_Head where Sleeve_IdNo <> 0 order by Sleeve_IdNo", con)
        ...
        With dgv_filter
            ...
            .Columns(1).HeaderText = "SLEEVE NAME"
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        da = New SqlClient.SqlDataAdapter("select * from Sleeve_Head a where Sleeve_IdNo = " & Str(Val(idno)), con)
        da.Fill(dt)

        If dt.Rows.Count > 0 Then
            lbl_IdNo.Text = dt.Rows(0).Item("Sleeve_IdNo").ToString
            txt_Name.Text = dt.Rows(0).Item("Sleeve_Name").ToString
        End If
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Sleeve_IdNo) from Sleeve_Head Where Sleeve_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Sleeve_IdNo) from Sleeve_Head Where Sleeve_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select min(Sleeve_IdNo) from Sleeve_Head Where Sleeve_IdNo > " & Str(Val(lbl_IdNo.Text)) & " and Sleeve_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            da = New SqlClient.SqlDataAdapter("select max(Sleeve_IdNo) from Sleeve_Head Where Sleeve_IdNo < " & Str(Val(lbl_IdNo.Text)) & " and Sleeve_IdNo <> 0", con)
            da.Fill(dt)
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Sleeve_Head", "Sleeve_IdNo", "")
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        Dim da As New SqlClient.SqlDataAdapter("select Sleeve_Name from Sleeve_Head order by Sleeve_Name", con)
        Dim dt As New DataTable

        da.Fill(dt)

        cbo_Find.DataSource = dt
        cbo_Find.DisplayMember = "Sleeve_Name"
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If New_Entry = True Then
                ...
                lbl_IdNo.Text = Common_Procedures.get_MaxIdNo(con, "Sleeve_Head", "Sleeve_IdNo", "", trans)

                cmd.CommandText = "Insert into Sleeve_Head(Sleeve_IdNo, Sleeve_Name, Sur_Name) values (" & Str(Val(lbl_IdNo.Text)) & ", '" & Trim(txt_Name.Text) & "', '" & Trim(Sur) & "')"
                cmd.ExecuteNonQuery()

            Else
                cmd.CommandText = "update Sleeve_Head set Sleeve_Name = '" & Trim(txt_Name.Text) & "', Sur_Name = '" & Trim(Sur) & "' where Sleeve_IdNo = " & Str(Val(lbl_IdNo.Text))
                cmd.ExecuteNonQuery()
            ...
            Common_Procedures.Master_Return.Master_Type = "SLEEVE"
        ...
        Catch ex As Exception
            trans.Rollback()
            If InStr(1, Trim(LCase(ex.Message)), "ix_sleeve_head") > 0 Then
                MessageBox.Show("Duplicate Sleeve Name", "DOES NOT SAVE", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub btn_Open_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Open.Click
        ...
        da = New SqlClient.SqlDataAdapter("select Sleeve_IdNo from Sleeve_Head where Sleeve_Name = '" & Trim(cbo_Find.Text) & "'", con)
        da.Fill(dt)
    ...
    Private Sub cbo_Find_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Find.KeyDown
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, cbo_Find, Nothing, Nothing, "Sleeve_Head", "Sleeve_Name", "", "(Sleeve_IdNo = 0)")
    ...
    Private Sub cbo_Find_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cbo_Find.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, cbo_Find, Nothing, "Sleeve_Head", "Sleeve_Name", "", "(Sleeve_IdNo = 0)")
