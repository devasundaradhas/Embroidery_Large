Public Class Spinning_Invoice_Entry_VAT
    ...
    Private Pk_Condition As String = "SPINV-"
    ...
    Private Sub Spinning_Invoice_Entry_VAT_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Private Sub Spinning_Invoice_Entry_VAT_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub Spinning_Invoice_Entry_VAT_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
    End Sub

    Private Sub Spinning_Invoice_Entry_VAT_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select max(for_orderby) from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Entry_VAT_GST_Type <> 'GST' and  Sales_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' ", con)
            da.Fill(dt)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Sales_No from Sales_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Entry_VAT_GST_Type <> 'GST' and Sales_Code = '" & Trim(NewCode) & "'"
            dr = cmd.ExecuteReader
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            If itm_id <> 0 And Val(txt_Weight.Text) <> 0 Then
                ...
                cmd.CommandText = "Insert into Sales_Details(Sales_Code,              Company_IdNo        ,           Sales_No                ,                               for_OrderBy                                  , Sales_Date,           Ledger_IdNo   ,             SL_No    ,            Item_IdNo    ,           ItemGroup_IdNo    ,           Unit_IdNo     ,             Noof_Items           ,             Bags               ,             Weight_Bag               ,             Weight               ,              Rate_5Kg              ,             Rate                  ,  Tax_Rate,             Amount               , Discount_Perc, Discount_Amount, Tax_Perc, Tax_Amount,             Total_Amount         ,          Bag_Nos            ,Colour_Idno    ) " & _
                                    " Values (  '" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @SalesDate, " & Str(Val(led_id)) & ", " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(itmdesc_id)) & ", " & Str(Val(unt_id)) & ", " & Str(Val(txt_Weight.Text)) & ", " & Str(Val(txt_Bags.Text)) & ", " & Str(Val(txt_Weight_Bag.Text)) & ", " & Str(Val(txt_Weight.Text)) & ", " & Str(Val(txt_Rate_5Kg.Text)) & ", " & Str(Val(txt_Rate_Kg.Text)) & ",    0     , " & Str(Val(txt_Amount.Text)) & ",     0        ,          0     ,    0    ,      0    , " & Str(Val(txt_Amount.Text)) & ", '" & Trim(txt_BagNos.Text) & "'," & Val(Col_id) & "  )"
                cmd.ExecuteNonQuery()
                ...
                cmd.CommandText = "Insert into Item_Processing_Details (  Reference_Code  ,             Company_IdNo         ,          Reference_No             ,                               for_OrderBy                                  , Reference_Date,          Ledger_IdNo    ,           Party_Bill_No           ,            SL_No     ,           Item_IdNo    ,            Unit_IdNo     ,         Quantity                       ) " & _
                                    " Values ('" & Trim(Pk_Condition) & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ",    @SalesDate , " & Str(Val(led_id)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & ", " & Str(-1 * Val(txt_Weight.Text)) & " )"
                cmd.ExecuteNonQuery()
    ...
    Private Sub cbo_ItemName_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemName.LostFocus
        ...
        If Trim(UCase(cmbItmNm)) <> Trim(UCase(cbo_ItemName.Text)) Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                'txt_Weight_Bag.Text = dt.Rows(0)("Sale_TaxRate").ToString
                'txt_VatPerc.Text = dt.Rows(0).Item("Tax_Percentage").ToString
            End If
            dt.Dispose()
            da.Dispose()
        End If
    ...
    Private Sub NetAmount_Calculation()
        ...
        NtAmt = Val(txt_Amount.Text) - Val(txt_CashDiscAmount.Text) + Val(txt_VatAmount.Text) + Val(txt_Freight.Text) + Val(txt_AddLess.Text)
    ...
    Private Sub PrintDocument1_BeginPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles PrintDocument1.BeginPrint
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name, b.Ledger_MainName, b.Ledger_Address1, b.Ledger_Address2, b.Ledger_Address3, b.Ledger_Address4, b.Ledger_TinNo from Sales_Head a LEFT OUTER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Sales_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(prn_HdDt)

            If prn_HdDt.Rows.Count > 0 Then

                da2 = New SqlClient.SqlDataAdapter("select a.sl_no, b.Item_Name, c.Unit_Name, d.ItemGroup_Name, a.Noof_Items, a.Bags, a.Weight, a.Rate_5Kg, a.Rate, a.Tax_Rate, a.Amount, a.Discount_Perc, a.Discount_Amount, a.Tax_Perc, a.Tax_Amount, a.Total_Amount , g.Colour_Name from Sales_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on b.unit_idno = c.unit_idno LEFT OUTER JOIN ItemGroup_Head d ON a.ItemGroup_IdNo = d.ItemGroup_IdNo  LEFT OUTER JOIN Colour_Head g on a.Colour_idno = g.Colour_idno where a.Sales_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                da2.Fill(prn_DetDt)
    ...
    Private Sub Printing_Format2(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        Try
            ...
            If prn_HdDt.Rows.Count > 0 Then
                ...
                CurX = 565
                p1Font = New Font("Calibri", 14, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Sales_No").ToString, CurX, 190, 0, 0, p1Font)
                Common_Procedures.Print_To_PrintDocument(e, Format(Convert.ToDateTime(prn_HdDt.Rows(0).Item("Sales_Date").ToString), "dd-MM-yyyy"), CurX, 225, 0, 0, pFont)
                ...
                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Delivery_Address3").ToString, CurX, CurY, 0, 0, pFont)

                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Vehicle_No").ToString, 565, 290, 0, 0, pFont)

                CurX = 635 ' 680
                CurY = 320 ' 270
                Common_Procedures.Print_To_PrintDocument(e, prn_HdDt.Rows(0).Item("Removal_Date").ToString, CurX, CurY, 0, 0, pFont)
                ...
                Try
                    ...
                    If prn_DetDt.Rows.Count > 0 Then
                        ...
                        Do While DetIndx <= prn_DetDt.Rows.Count - 1
                            ...
                            ItmDesc1 = Trim(prn_DetDt.Rows(DetIndx).Item("ItemGroup_Name").ToString)
                            ItmDesc2 = ""
                            ...
                            Common_Procedures.Print_To_PrintDocument(e, Trim(prn_DetDt.Rows(DetIndx).Item("Colour_Name").ToString), 140, CurY + TxtHgt, 0, 0, pFont)

                            Common_Procedures.Print_To_PrintDocument(e, Val(prn_DetDt.Rows(DetIndx).Item("Bags").ToString), 420, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Weight").ToString), "########0.00"), 520, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Rate_5Kg").ToString), "########0.00"), 630, CurY, 1, 0, pFont)
                            Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_DetDt.Rows(DetIndx).Item("Amount").ToString), "########0.00"), 770, CurY, 1, 0, pFont)
                ...
                BgNo1 = Trim(prn_HdDt.Rows(0).Item("Bag_Nos").ToString)
                BgNo2 = ""
                ...
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("SubTotal_Amount").ToString), "########0.00"), CurX, CurY, 1, 0, pFont)

                CurY = CurY + TxtHgt
                Common_Procedures.Print_To_PrintDocument(e, BgNo2, 100, CurY, 0, 0, pFont)
                If Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Cash Discount @ " & Trim(Val(prn_HdDt.Rows(0).Item("CashDiscount_Perc").ToString)) & "%", 440, CurY, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("CashDiscount_Amount").ToString), "########0.00"), CurX, CurY, 1, 0, pFont)
                End If
                ...
                End If
                If Val(prn_HdDt.Rows(0).Item("Total_TaxAmount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, Trim(prn_HdDt.Rows(0).Item("Tax_Type").ToString) & " @ " & Trim(Val(prn_HdDt.Rows(0).Item("Tax_Perc").ToString)) & "%", 440, CurY, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Total_TaxAmount").ToString), "########0.00"), CurX, CurY, 1, 0, pFont)
                End If

                CurY = CurY + TxtHgt
                If Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Add/Less", 440, CurY, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("AddLess_Amount").ToString), "########0.00"), CurX, CurY, 1, 0, pFont)
                End If

                CurY = CurY + TxtHgt
                If Val(prn_HdDt.Rows(0).Item("Round_Off").ToString) <> 0 Then
                    Common_Procedures.Print_To_PrintDocument(e, "Round Off", 440, CurY, 0, 0, pFont)
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Round_Off").ToString), "########0.00"), CurX, CurY, 1, 0, pFont)
                End If

                p1Font = New Font("Calibri", 14, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Net_Amount").ToString), "########0.00"), CurX, 935, 1, 0, p1Font)
    ...
    Private Sub cbo_TaxType_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_TaxType.TextChanged
        ...
        If Trim(UCase(cbo_TaxType.Text)) = "CST" Then
