Public Class Simple_Receipt_GST
    ...
    Private Pk_Condition As String = "GRECS-"
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select a.*, b.Ledger_Name as LedgerName from Simple_Receipt_Head a INNER JOIN Ledger_Head b ON a.Ledger_IdNo = b.Ledger_IdNo where a.Simple_Receipt_Code = '" & Trim(NewCode) & "'", con)
            da1.Fill(dt1)

            If dt1.Rows.Count > 0 Then
                lbl_InvoiceNo.Text = dt1.Rows(0).Item("Simple_Receipt_No").ToString
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Unit_Name from Simple_Receipt_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Unit_Head c on a.Unit_idno = c.Unit_idno where a.Simple_Receipt_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(5).Value = dt2.Rows(i).Item("Simple_Receipt_Detail_SlNo").ToString
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Da = New SqlClient.SqlDataAdapter("select sum(Receipt_Quantity) from Simple_Receipt_Details Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code = '" & Trim(NewCode) & "'", con)
        Dt1 = New DataTable
        Da.Fill(Dt1)
    ...
    Public Sub movefirst_record() Implements Interface_MDIActions.movefirst_record
        ...
        Try
            cmd.Connection = con
            cmd.CommandText = "select Simple_Receipt_No from Simple_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST'  Order by for_Orderby, Simple_Receipt_No"
    ...
    Public Sub movenext_record() Implements Interface_MDIActions.movenext_record
        ...
        Try
            ...
            da = New SqlClient.SqlDataAdapter("select Simple_Receipt_No from Simple_Receipt_Head where for_orderby > " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby, Simple_Receipt_No", con)
            da.Fill(dt)
    ...
    Public Sub moveprevious_record() Implements Interface_MDIActions.moveprevious_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Simple_Receipt_No from Simple_Receipt_Head where for_orderby < " & Str(OrdByNo) & " and company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Simple_Receipt_No desc"
    ...
    Public Sub movelast_record() Implements Interface_MDIActions.movelast_record
        Dim da As New SqlClient.SqlDataAdapter("select Simple_Receipt_No from Simple_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code like '%/" & Trim(Common_Procedures.FnYearCode) & "' and Entry_VAT_GST_Type = 'GST' Order by for_Orderby desc, Simple_Receipt_No desc", con)
        Dim dt As New DataTable
        Dim movno As String
    ...
    Public Sub new_record() Implements Interface_MDIActions.new_record
        ...
        Try
            ...
            lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Simple_Receipt_Head", "Simple_Receipt_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode)
    ...
    Public Sub open_record() Implements Interface_MDIActions.open_record
        ...
        Try
            ...
            cmd.Connection = con
            cmd.CommandText = "select Simple_Receipt_No from Simple_Receipt_Head where company_idno = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code = '" & Trim(NewCode) & "' and Entry_VAT_GST_Type = 'GST'"
            dr = cmd.ExecuteReader
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Try
            ...
            Else
                ...
                lbl_InvoiceNo.Text = Common_Procedures.get_MaxCode(con, "Simple_Receipt_Head", "Simple_Receipt_Code", "For_OrderBy", "Entry_VAT_GST_Type = 'GST'", Val(lbl_Company.Tag), Common_Procedures.FnYearCode, tr)
            ...
            If New_Entry = True Then
                cmd.CommandText = "Insert into Simple_Receipt_Head( Entry_VAT_GST_Type ,        Simple_Receipt_Code ,             Company_IdNo         ,              Simple_Receipt_No             ,                               for_OrderBy      , Simple_Receipt_Date,           Ledger_IdNo   ,                 Order_No             ,                Order_Date         ,    Transport_IdNo         ,            Vehicle_No            ,              Remarks           ,              Total_Qty         ,   Entry_GST_Tax_Type ,                 CGst_Amount          ,                 SGst_Amount          ,               IGst_Amount                     , SubTotal_Amount ,        Round_Off             ,             Net_Amount                             ,  Assessable_Value ) " &
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Trim(dgv_Details.Rows(i).Cells(1).Value) <> "" Or Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        cmd.CommandText = "Update Simple_Receipt_Details set Simple_Receipt_Date = @DcDate,  Ledger_IdNo = " & Str(Val(led_id)) & ",  Sl_No = " & Str(Val(Sno)) & ", Item_Idno = " & Str(Val(itm_id)) & ", Item_Description = '" & Trim(.Rows(i).Cells(2).Value) & "', Unit_Idno = " & Val(unt_id) & ", Quantity = " & Str(Val(.Rows(i).Cells(4).Value)) & ",Rate =" & Str(Val(.Rows(i).Cells(7).Value)) & ",Amount = " & Str(Val(.Rows(i).Cells(8).Value)) & ",HSN_Code = '" & Trim(.Rows(i).Cells(9).Value) & "',Tax_Perc = " & Str(Val(.Rows(i).Cells(10).Value)) & "  where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code = '" & Trim(NewCode) & "' and Simple_Receipt_Detail_SlNo = " & Str(Val(.Rows(i).Cells(5).Value))
                        NR = cmd.ExecuteNonQuery()

                        If NR = 0 Then
                            cmd.CommandText = "Insert into Simple_Receipt_Details ( Simple_Receipt_Code,    Company_IdNo          ,      Simple_Receipt_No  ,                                              for_OrderBy                   , Simple_Receipt_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo           ,      Item_Description                    ,          Unit_IdNo         ,                         Quantity          ,   Receipt_Quantity ,     Rate                ,                      Amount                     ,                             HSN_Code           ,                      Tax_Perc        ) " &
        ...
        Catch ex As Exception
            tr.Rollback()
            If InStr(1, Err.Description, "CK_Simple_Receipt_Details_1") > 0 Then
            ...
            ElseIf InStr(1, Err.Description, "CK_Simple_Receipt_Details_2") > 0 Then
    ...
    Private Sub btn_Filter_Show_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Filter_Show.Click
        ...
        Try
            ...
            If Val(Itm_IdNo) <> 0 Then
                ...
                Condt = Condt & IIf(Trim(Condt) <> "", " and ", "") & " a.Simple_Receipt_Code IN (select z.Simple_Receipt_Code from Simple_Receipt_Details z where z.Item_IdNo = " & Str(Val(Itm_IdNo)) & ") "
            End If

            da = New SqlClient.SqlDataAdapter("select a.*,b.* from Simple_Receipt_Head a INNER JOIN Ledger_Head b on a.Ledger_IdNo = b.Ledger_IdNo   where a.company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and a.Simple_Receipt_Code LIKE '%/" & Trim(Common_Procedures.FnYearCode) & "' " & IIf(Trim(Condt) <> "", " and ", "") & Condt & " Order by a.for_orderby, a.Simple_Receipt_No", con)
            da.Fill(dt2)
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_Filter_Details.Rows(n).Cells(1).Value = dt2.Rows(i).Item("Simple_Receipt_No").ToString
                    dgv_Filter_Details.Rows(n).Cells(2).Value = Format(Convert.ToDateTime(dt2.Rows(i).Item("Simple_Receipt_Date").ToString), "dd-MM-yyyy")
    ...
    Public Sub print_Invoice()
        ...
        Try
            ...
            da1 = New SqlClient.SqlDataAdapter("select * from Simple_Receipt_head Where Company_IdNo = " & Str(Val(lbl_Company.Tag)) & " and Simple_Receipt_Code = '" & Trim(NewCode) & "' ", con)
            dt1 = New DataTable
            da1.Fill(dt1)
