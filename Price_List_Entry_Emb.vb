Public Class Price_List_Entry_Emb
        ...
        If dt.Rows.Count > 0 Then
            ...
            If dt2.Rows.Count > 0 Then
                ...
                For i = 0 To dt2.Rows.Count - 1
                    ...
                    dgv_PriceListdetails.Rows(n).Cells(2).Value = Format(Val(dt2.Rows(i).Item("Rate_Per_1000_stitches")), "#########0.000")
                    dgv_PriceListdetails.Rows(n).Cells(3).Value = Format(Val(dt2.Rows(i).Item("Minimum_Amount")), "#########0.000")
                    dgv_PriceListdetails.Rows(n).Cells(4).Value = Format(Val(dt2.Rows(i).Item("Minimum_Stitches")), "#########0")
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Val(Itm_id) <> 0 Then
                        ...
                        If Common_Procedures.settings.CustomerCode = "1117" Then
                            cmd.CommandText = "Insert into Price_List_Details(Price_List_IdNo, sl_no, Item_IdNo,Rate_Per_1000_Stitches,Minimum_Amount,Minimum_Stitches) values (" & Str(Val(lbl_IdNo.Text)) & ", " & Str(Val(SNo)) & ", " & Str(Val(Itm_id)) & ", " & Str(Val(.Rows(i).Cells(2).Value)) & ", " & Str(Val(.Rows(i).Cells(3).Value)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ")"
                        Else
    ...
    Private Sub Price_List_Entry_Emb_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        con.Close()
        con.Dispose()
    End Sub

    Private Sub Price_List_Entry_Emb_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If Asc(e.KeyChar) = 27 Then
    ...
    End Sub
    Private Sub Price_List_Entry_Emb_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        ...
        End If
    End Sub
    Private Sub Price_List_Entry_Emb_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub dgv_PriceListdetails_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_PriceListdetails.CellContentClick
