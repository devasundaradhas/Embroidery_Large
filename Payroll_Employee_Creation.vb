...
Public Class Payroll_Employee_Creation
    ...
    Private Sub clear()
        ...
        chk_ESI_for_OT_Status.Checked = False
        chk_PFCredit_STS.Checked = False
        txt_opAmt.Text = "0"
        txt_BankAcNo.Text = ""
        txt_Wages.Text = ""
        ...
        txt_Loan_Outstanding.Text = ""
        txt_Current_EMI.Text = ""
        txt_New_EMI.Text = ""
    ...
    Private Sub Grid_Cell_DeSelect()
        ...
        If Not IsNothing(dgv_SchemeSalarydetails.CurrentCell) Then dgv_SchemeSalarydetails.CurrentCell.Selected = False
        If Not IsNothing(dgv_Releavedetails.CurrentCell) Then dgv_Releavedetails.CurrentCell.Selected = False
    ...
    Public Sub move_record(ByVal idno As Integer)
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                txt_UANo.Text = dt.Rows(0).Item("UAN_No").ToString
                txt_PANo.Text = dt.Rows(0).Item("PAN_No").ToString
                ...
                chk_ESI_for_OT_Status.Checked = False
                If Val(dt.Rows(0).Item("Esi_For_OTSalary_Status").ToString) = 1 Then
                    chk_ESI_for_OT_Status.Checked = True
                End If

                chk_PFCredit_STS.Checked = False
                If Val(dt.Rows(0).Item("PF_Credit_Status").ToString) = 1 Then
                    chk_PFCredit_STS.Checked = True
                End If
    ...
    Private Sub Employee_Creation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        AddHandler chk_PFCredit_STS.GotFocus, AddressOf ControlGotFocus
        AddHandler chk_ESI_for_OT_Status.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler txt_PANo.GotFocus, AddressOf ControlGotFocus
        AddHandler txt_UANo.GotFocus, AddressOf ControlGotFocus
        ...
        AddHandler chk_ESI_for_OT_Status.LostFocus, AddressOf ControlLostFocus
        AddHandler chk_PFCredit_STS.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler txt_PANo.LostFocus, AddressOf ControlLostFocus
        AddHandler txt_UANo.LostFocus, AddressOf ControlLostFocus
        ...
        AddHandler chk_ESI_for_OT_Status.KeyDown, AddressOf TextBoxControlKeyDown
        AddHandler chk_PFCredit_STS.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler txt_PANo.KeyDown, AddressOf TextBoxControlKeyDown
        'AddHandler msk_ReleaveDate.KeyDown, AddressOf TextBoxControlKeyDown
        'AddHandler txt_UANo.KeyDown, AddressOf TextBoxControlKeyDown
        ...
        AddHandler chk_ESI_for_OT_Status.KeyPress, AddressOf TextBoxControlKeyPress
        AddHandler chk_PFCredit_STS.KeyPress, AddressOf TextBoxControlKeyPress
        ...
        AddHandler txt_PANo.KeyPress, AddressOf TextBoxControlKeyPress
        'AddHandler txt_UANo.KeyPress, AddressOf TextBoxControlKeyPress
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        Dim vEsiSTS As Integer = 0, vEsiSalry As Integer = 0, vEsiOT As Integer = 0
        Dim vPfSTS As Integer = 0, vPfSalry As Integer = 0, vPfOT As Integer = 0
        ...
        vEsiOT = 0
        If chk_ESI_for_OT_Status.Checked = True Then vEsiOT = 1
        vPfOT = 0
        If chk_PFCredit_STS.Checked = True Then vPfOT = 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        If IsDate(.Rows(i).Cells(1).Value) = True Then
                            ...
                            If Trim(.Rows(i).Cells(1).Value) <> "" Then
                                ...
                                cmd.CommandText = "Insert into PayRoll_Employee_Releave_Details (             Employee_IdNo      ,            sl_no     ,                    Join_Date           , Join_DateTime,                    Releave_date             ,                                                Releave_DateTime            ,                      Reason                  ) " &
    ...
    Private Sub cbo_Category_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Category.KeyUp
        ...
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            ...
            MDIParent1.Match_UserRights_WithForm("mnu_Master_PayrollCategoryCreation", "Payroll_Category_Creation")
    ...
    Private Sub cbo_Department_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cbo_Department.KeyUp
        ...
        If e.Control = False And e.KeyValue = 17 And vcbo_KeyDwnVal = e.KeyValue Then
            ...
            MDIParent1.Match_UserRights_WithForm("mnu_Master_PayrollDepartmentCreation", "Department_Creation")
    ...
    Private Sub Cbo_ESIPF_Group_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Cbo_ESIPF_Group.KeyDown
        vcbo_KeyDwnVal = e.KeyValue
        Common_Procedures.ComboBox_ItemSelection_KeyDown(sender, e, con, Cbo_ESIPF_Group, txt_PANo, txt_UANo, "ESI_PF_Head", "ESI_PF_Group_Name", "", "(ESI_PF_Group_IdNo = 0)")

        If (e.KeyValue = 38 And Cbo_ESIPF_Group.DroppedDown = False) Or (e.Control = True And e.KeyValue = 38) Then
            If msk_pfLeaveDate.Enabled = True Then
    ...
    Private Sub Cbo_ESIPF_Group_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Cbo_ESIPF_Group.KeyPress
        Common_Procedures.ComboBox_ItemSelection_KeyPress(sender, e, con, Cbo_ESIPF_Group, txt_UANo, "ESI_PF_Head", "ESI_PF_Group_Name", "", "(ESI_PF_Group_IdNo = 0)")
    ...
    Private Sub txt_UANo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txt_UANo.KeyDown
        If e.KeyCode = 38 Then
            Cbo_ESIPF_Group.Focus()
        End If
        If e.KeyCode = 40 Then
    ...
    Private Sub txt_UANo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txt_UANo.KeyPress
        If Asc(e.KeyChar) = 13 Then
            Tab_Main.SelectTab(2)
            msk_DateOfBirth.Focus()
        End If
    ...
    Private Sub Display_Loan_Status()
        ...
        txt_Loan_Outstanding.Text = "0.00"
        txt_Current_EMI.Text = "0.00"

        Dim vEmp_IdNo As Integer = Val(lbl_IdNo.Text).ToString
        ...
        If vEmp_IdNo > 0 Then
            ...
            If dt.Rows.Count > 0 Then
                If Not IsDBNull(dt.Rows(0).Item(0)) Then
                    txt_Loan_Outstanding.Text = FormatNumber(-1 * dt.Rows(0).Item(0), 2, True, TriState.True, False)
                End If
            End If
            ...
            If dt1.Rows.Count > 0 Then
                ...
                If Not IsDBNull(dt1.Rows(0).Item(1)) Then
                    txt_Current_EMI.Text = dt1.Rows(0).Item(1)
                    txt_New_EMI.Text = dt1.Rows(0).Item(1)
                End If
