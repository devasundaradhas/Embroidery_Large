Public Class Sales_Delivery6_Gst
    ...
    Private Sub move_record(ByVal no As String)
        ...
        Try
            ...
            If dt1.Rows.Count > 0 Then
                ...
                da2 = New SqlClient.SqlDataAdapter("select a.*, b.Item_Name, c.Size_Name from Sales_Delivery_Details a INNER JOIN Item_Head b on a.Item_IdNo = b.Item_IdNo LEFT OUTER JOIN Size_Head c on a.Size_idno = c.Size_idno where a.Sales_Delivery_Code = '" & Trim(NewCode) & "' Order by a.sl_no", con)
                dt2 = New DataTable
                da2.Fill(dt2)
                ...
                If dt2.Rows.Count > 0 Then
                    ...
                    For i = 0 To dt2.Rows.Count - 1
                        ...
                        dgv_Details.Rows(n).Cells(5).Value = Common_Procedures.Unit_IdNoToName(con, Val(dt2.Rows(i).Item("Unit_IdNo").ToString))
                        ...
                        '***** GST END *****
                        dgv_Details.Rows(n).Cells(11).Value = dt2.Rows(i).Item("Item_Description").ToString
                        dgv_Details.Rows(n).Cells(12).Value = dt2.Rows(i).Item("No_Of_Rolls").ToString
    ...
    Private Sub Invoice_Garments_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        If Trim(Common_Procedures.settings.CustomerCode) = "1142" Then       'SLP
            lbl_Style.Text = "Unit"
            cbo_Unit.Visible = True
            txt_NoOFRolls.Visible = False
            cbo_Style.Visible = False
            dgv_Details.Columns(2).Visible = False
    ...
    Public Sub delete_record() Implements Interface_MDIActions.delete_record
        ...
        Try
            ...
            cmd.CommandText = "Update Sales_Order_Details Set Sales_Items = a.Sales_Items - b.Noof_Items from Sales_Order_Details a, Sales_Delivery_Details b where b.Sales_Delivery_Code = '" & Trim(NewCode) & "' and b.Entry_Type = 'ORDER' and a.Sales_Order_Code = b.Sales_Order_Code and a.Sales_Order_Detail_SlNo = b.Sales_Order_Detail_SlNo"
            cmd.ExecuteNonQuery()
    ...
    Public Sub save_record() Implements Interface_MDIActions.save_record
        ...
        If dgv_Details_Total.RowCount > 0 Then
            ...
            VTot_Amt = Val(dgv_Details_Total.Rows(0).Cells(7).Value())
        End If
            ...
            With dgv_Details
                ...
                For i = 0 To dgv_Details.RowCount - 1
                    ...
                    If Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                        ...
                        unt_id = Common_Procedures.get_FieldValue(con, "Item_Head", "Unit_IdNo", "(Item_IdNo = " & Str(Val(itm_id)) & ")", 0, tr)
                        ...
                        cmd.CommandText = "Insert into Sales_Delivery_Details ( Sales_Delivery_Code,            Company_IdNo          ,              Sales_Delivery_No             ,                                              for_OrderBy                   , Sales_Delivery_Date,          Ledger_IdNo    ,            SL_No     ,          Item_IdNo      ,         Unit_IdNo      ,     Style_IdNo    ,           Size_IdNo       ,                        Quantity                 ,                 Rate                     ,                 Amount                   ,                     Assessable_Value                 ,            HSN_Code                    , Tax_Perc                             ,    Item_Description    ,No_Of_Rolls     ) " & _
                                                " Values ('" & Trim(NewCode) & "'                      , " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ", @DcDate               , " & Str(Val(led_id)) & ", " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & "," & Val(Sty_id) & " , " & Str(Val(Sz_id)) & ", " & Str(Val(.Rows(i).Cells(4).Value)) & ", " & Str(Val(.Rows(i).Cells(6).Value)) & ", " & Str(Val(.Rows(i).Cells(7).Value)) & " , " & Str(Val(.Rows(i).Cells(8).Value)) & ",'" & Trim(.Rows(i).Cells(9).Value) & "', " & Str(Val(.Rows(i).Cells(10).Value)) & ", '" & Trim(.Rows(i).Cells(11).Value) & "' ," & Val(.Rows(i).Cells(12).Value) & ")"
                        cmd.ExecuteNonQuery()
                        ...
                        cmd.CommandText = "Insert into Item_Processing_Details (  Reference_Code      ,               Company_IdNo       ,            Reference_No           ,                                 for_OrderBy                                , Reference_Date,        Ledger_IdNo     ,            Party_Bill_No          ,           SL_No      ,           Item_IdNo     ,            Unit_IdNo    ,                    Quantity                               ,          Size_IdNo ) " & _
                                                " Values ('" & Trim(NewCode) & "', " & Str(Val(lbl_Company.Tag)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Common_Procedures.OrderBy_CodeToValue(lbl_InvoiceNo.Text))) & ",    @DcDate, " & Str(Val(led_id)) & ", '" & Trim(lbl_InvoiceNo.Text) & "', " & Str(Val(Sno)) & ", " & Str(Val(itm_id)) & ", " & Str(Val(unt_id)) & ", " & Str(-1 * Val(dgv_Details.Rows(i).Cells(4).Value)) & " ,   " & Str(Val(Sz_id)) & "  )"
                        cmd.ExecuteNonQuery()
        ...
        With dgv_Details
            ...
            For i = 0 To .Rows.Count - 1
                If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                    ...
                    .Rows(i).Cells(5).Value = cbo_Unit.Text
                    ...
                    .Rows(i).Cells(11).Value = Trim(txt_Description.Text)
                    .Rows(i).Cells(12).Value = Val(txt_NoOFRolls.Text)
            ...
            If MtchSTS = False Then
                ...
                .Rows(n).Cells(5).Value = cbo_Unit.Text
                ...
                .Rows(n).Cells(11).Value = Trim(txt_Description.Text)
                .Rows(n).Cells(12).Value = Trim(txt_NoOFRolls.Text)
        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            If Trim(cbo_ItemName.Text) <> "" Then
                If cbo_Style.Visible And cbo_Style.Enabled Then
                    cbo_Style.Focus()
                ElseIf cbo_Unit.Visible And cbo_Style.Enabled Then
                    cbo_Unit.Focus()
                Else
                    txt_NoOFRolls.Focus()
                End If
            ...
            With dgv_Details
                ...
                For i = 0 To .Rows.Count - 1
                    If Val(dgv_Details.Rows(i).Cells(0).Value) = Val(txt_SlNo.Text) Then
                        ...
                        cbo_Unit.Text = dgv_Details.CurrentRow.Cells(5).Value
                        ...
                        lbl_Grid_HsnCode.Text = .Rows(i).Cells(9).Value
                        lbl_Grid_GstPerc.Text = Format(Val(.Rows(i).Cells(10).Value), "########0.00")
                        txt_Description.Text = Trim(.Rows(i).Cells(11).Value)
                        txt_NoOFRolls.Text = Trim(.Rows(i).Cells(12).Value)
    ...
    Private Sub dgv_Details_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgv_Details.DoubleClick
        ...
        If Panel2.Enabled = True And txt_SlNo.Enabled = True Then
            ...
            If Trim(dgv_Details.CurrentRow.Cells(1).Value) <> "" Then
                ...
                cbo_Size.Text = Trim(dgv_Details.CurrentRow.Cells(3).Value)
                txt_NoofPcs.Text = Val(dgv_Details.CurrentRow.Cells(4).Value)
                cbo_Unit.Text = Trim(dgv_Details.CurrentRow.Cells(5).Value)
                txt_Rate.Text = Format(Val(dgv_Details.CurrentRow.Cells(6).Value), "########0.00")
                lbl_Amount.Text = Format(Val(dgv_Details.CurrentRow.Cells(7).Value), "########0.00")
                lbl_Grid_AssessableValue.Text = Format(Val(dgv_Details.CurrentRow.Cells(8).Value), "########0.00")
                lbl_Grid_HsnCode.Text = dgv_Details.CurrentRow.Cells(9).Value
                lbl_Grid_GstPerc.Text = Format(Val(dgv_Details.CurrentRow.Cells(10).Value), "########0.00")
                txt_Description.Text = Trim(dgv_Details.CurrentRow.Cells(11).Value)
                txt_NoOFRolls.Text = Trim(dgv_Details.CurrentRow.Cells(12).Value)
                ...
                For i = 0 To .RowCount - 1
                    ...
                    If Trim(.Rows(i).Cells(1).Value) <> "" Then
                        ...
                        If ItmIdNo <> 0 Then
                            ...
                            .Rows(i).Cells(8).Value = Format(Val(.Rows(i).Cells(7).Value), "#########0.00")
    ...
    Private Sub TotalAmount_Calculation()
        ...
        For i = 0 To dgv_Details.RowCount - 1
            ...
            If Val(dgv_Details.Rows(i).Cells(4).Value) <> 0 Then
                ...
                TotNoOfRolls = TotNoOfRolls + Val(dgv_Details.Rows(i).Cells(12).Value)
        ...
        With dgv_Details_Total
            ...
            .Rows(0).Cells(12).Value = Format(Val(TotNoOfRolls), "########0.00")
        End With
        ...
        If prn_HdDt.Rows.Count > 0 Then
            ...
            If prn_DetDt.Rows.Count > 0 Then
                ...
                For I = 0 To prn_DetDt.Rows.Count - 1
                    ...
                    If Trim(Common_Procedures.settings.CustomerCode) = "1142" Then  'SLP FOR QUANTITY IN WEIGHT FORMAT
                        prn_DetAr(prn_DetMxIndx, 5) = Format(Val(prn_DetDt.Rows(I).Item("qUANTITY").ToString), "#######.000")
                    Else
                        prn_DetAr(prn_DetMxIndx, 5) = Val(prn_DetDt.Rows(I).Item("qUANTITY").ToString)
                    End If

                    prn_DetAr(prn_DetMxIndx, 6) = Common_Procedures.Unit_IdNoToName(con, Val(prn_DetDt.Rows(I).Item("Unit_IdNo").ToString))
                    prn_DetAr(prn_DetMxIndx, 7) = Trim(prn_DetDt.Rows(I).Item("Style_Name").ToString)
                    prn_DetAr(prn_DetMxIndx, 8) = prn_DetDt.Rows(I).Item("Size_Name").ToString
                    ...
                    prn_DetAr(prn_DetMxIndx, 11) = Val(prn_DetDt.Rows(I).Item("No_Of_Rolls").ToString)
                    prn_DetAr(prn_DetMxIndx, 12) = ""
                    '***** GST END *****
                    ...
                    If Trim(ItmNm2) <> "" Then
                        ...
                        prn_DetAr(prn_DetMxIndx, 12) = "ITEM_2ND_LINE"
...
LOOP1:
                        ...
                        For K = 1 To m1
                            ...
                            prn_DetAr(prn_DetMxIndx, 10) = ""
                            prn_DetAr(prn_DetMxIndx, 11) = ""
                            prn_DetAr(prn_DetMxIndx, 12) = "DESCRIPTION"
                            '***** GST END *****
                        Next K
    ...
    Private Sub Printing_Format3(ByRef e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        ClArr(8) = 40   'UNIT
        ClArr(9) = 75   'RATE
        ClArr(10) = PageWidth - (LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9)) 'AMOUNT
                    ...
                    If prn_DetMxIndx > 0 Then
                        ...
                        Do While DetIndx <= prn_DetMxIndx
                            ...
                            Else
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 1), LMargin + 15, CurY, 0, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 2), LMargin + ClArr(1) + 10, CurY, 0, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 3), LMargin + ClArr(1) + ClArr(2), CurY, 0, ClArr(3), pFont)
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 8), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + 10, CurY, 0, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 5), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) - 5, CurY, 1, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 6), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) - 5, CurY, 1, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 9), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9) - 1, CurY, 1, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 10), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9) + ClArr(10) - 5, CurY, 1, 0, pFont)
                                '***** GST END *****
                            End If
        ...
        Try
            ...
            If Val(prn_HdDt.Rows(0).Item("CGst_Amount").ToString) <> 0 Or Val(prn_HdDt.Rows(0).Item("SGst_Amount").ToString) <> 0 Or Val(prn_HdDt.Rows(0).Item("IGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    ...
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Assessable_Value").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10) - 10, CurY, 1, 0, p1Font)
                End If
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("CGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    If vTaxPerc <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "CGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) - 10, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "CGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) - 10, CurY, 1, 0, pFont)
                    End If
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("CGst_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10) - 10, CurY, 1, 0, pFont)
                End If
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("SGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    If vTaxPerc <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "SGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) - 10, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "SGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) - 10, CurY, 1, 0, pFont)
                    End If
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("SGst_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10) - 10, CurY, 1, 0, pFont)
                End If
            End If
            ...
            If Val(prn_HdDt.Rows(0).Item("IGst_Amount").ToString) <> 0 Then
                ...
                If is_LastPage = True Then
                    If vTaxPerc <> 0 Then
                        Common_Procedures.Print_To_PrintDocument(e, "IGST @ " & Trim(Val(vTaxPerc)) & " %", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) - 10, CurY, 1, 0, pFont)
                    Else
                        Common_Procedures.Print_To_PrintDocument(e, "IGST ", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) - 10, CurY, 1, 0, pFont)
                    End If
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("IGst_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10) - 10, CurY, 1, 0, pFont)
                End If
            End If
            '***** GST END *****
            ...
            If Val(prn_HdDt.Rows(0).Item("Round_Off").ToString) <> 0 Then
                If is_LastPage = True Then
                    ...
                    Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Round_Off").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10) - 10, CurY, 1, 0, pFont)
                End If
            End If
            ...
            p1Font = New Font("Calibri", 15, FontStyle.Bold)
            Common_Procedures.Print_To_PrintDocument(e, "Net Amount", LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 30, CurY, 2, 0, p1Font)
            If is_LastPage = True Then
                p1Font = New Font("Calibri", 12, FontStyle.Bold)
                Common_Procedures.Print_To_PrintDocument(e, Common_Procedures.Currency_Format(Val(prn_HdDt.Rows(0).Item("Net_Amount").ToString)), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10) - 10, CurY, 1, 0, p1Font)
            End If
                    ...
                    If prn_DetMxIndx > 0 Then
                        ...
                        Do While DetIndx <= prn_DetMxIndx
                            ...
                            Else
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 8), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 10, CurY, 0, 0, pFont)

                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 11), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + 10, CurY, 0, 0, pFont)
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 9), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) - 5, CurY, 1, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 10), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9) - 5, CurY, 1, 0, pFont)
                                '***** GST END *****
                            End If
                    ...
                    If prn_DetMxIndx > 0 Then
                        ...
                        Do While DetIndx <= prn_DetMxIndx
                            ...
                            Else
                                ...
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 8), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + 5, CurY, 0, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 5), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) - 10, CurY, 1, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 9), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) - 5, CurY, 1, 0, pFont)
                                Common_Procedures.Print_To_PrintDocument(e, prn_DetAr(DetIndx, 10), LMargin + ClArr(1) + ClArr(2) + ClArr(3) + ClArr(4) + ClArr(5) + ClArr(6) + ClArr(7) + ClArr(8) + ClArr(9) - 5, CurY, 1, 0, pFont)
                                '***** GST END *****
...
1:
    ...
    Private Sub cbo_ItemName_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbo_ItemName.TextChanged
        Dim unit_id As Integer = 0
        unit_id = Val(Common_Procedures.get_FieldValue(con, "Item_Head", "Unit_IdNo", "Item_Name='" & Trim(cbo_ItemName.Text) & "'"))

        cbo_Unit.Text = Common_Procedures.Unit_IdNoToName(con, unit_id)
    End Sub
...
1:
    ...
    Private Sub Printing_Format6_PageFooter(ByRef e As System.Drawing.Printing.PrintPageEventArgs, ByVal EntryCode As String, ByVal TxtHgt As Single, ByVal pFont As Font, ByVal LMargin As Single, ByVal RMargin As Single, ByVal TMargin As Single, ByVal BMargin As Single, ByVal PageWidth As Single, ByVal PrintWidth As Single, ByVal NoofItems_PerPage As Integer, ByRef CurY As Single, ByRef LnAr() As Single, ByRef ClAr() As Single, ByVal Cmp_Name As String, ByVal NoofDets As Integer, ByVal is_LastPage As Boolean)
        ...
        Try
            ...
            Common_Procedures.Print_To_PrintDocument(e, "TOTAL", LMargin + ClAr(1) + 15, CurY, 0, 0, pFont)
            If is_LastPage = True Then
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("Total_Qty").ToString), "#######0.000"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) - 10, CurY, 1, 0, pFont)
                Common_Procedures.Print_To_PrintDocument(e, Format(Val(prn_HdDt.Rows(0).Item("SubTotal_Amount").ToString), "########0.00"), LMargin + ClAr(1) + ClAr(2) + ClAr(3) + ClAr(4) + ClAr(5) + ClAr(6) + ClAr(7) + ClAr(8) + ClAr(9) + ClAr(10) - 10, CurY, 1, 0, pFont)
            End If
